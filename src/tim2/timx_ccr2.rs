#[doc = "Reader of register TIMx_CCR2"]
pub type R = crate::R<u32, super::TIMX_CCR2>;
#[doc = "Writer for register TIMx_CCR2"]
pub type W = crate::W<u32, super::TIMX_CCR2>;
#[doc = "Register TIMx_CCR2 `reset()`'s with value 0"]
impl crate::ResetValue for super::TIMX_CCR2 {
    type Type = u32;
    #[inline(always)]
