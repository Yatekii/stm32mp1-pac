...
pub enum FDTRMSL_A {
    #[doc = "0: Nominal delay"]
    B_0X0 = 0,
    #[doc = "1: Nominal delay less 10"]
    B_0X1 = 1,
    #[doc = "2: Nominal delay more 10"]
    B_0X2 = 2,
    #[doc = "3: Nominal delay more 20"]
    B_0X3 = 3,
}
impl From<FDTRMSL_A> for u8 {
    #[inline(always)]
    fn from(variant: FDTRMSL_A) -> Self {
        variant as _
    }
}
#[doc = "Reader of field `FDTRMSL`"]
pub type FDTRMSL_R = crate::R<u8, FDTRMSL_A>;
impl FDTRMSL_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> FDTRMSL_A {
        match self.bits {
            0 => FDTRMSL_A::B_0X0,
            1 => FDTRMSL_A::B_0X1,
            2 => FDTRMSL_A::B_0X2,
    ...
    pub fn is_b_0x0(&self) -> bool {
        *self == FDTRMSL_A::B_0X0
    }
    #[doc = "Checks if the value of the field is `B_0X1`"]
    #[inline(always)]
    pub fn is_b_0x1(&self) -> bool {
        *self == FDTRMSL_A::B_0X1
    }
    #[doc = "Checks if the value of the field is `B_0X2`"]
    #[inline(always)]
    pub fn is_b_0x2(&self) -> bool {
        *self == FDTRMSL_A::B_0X2
    }
    #[doc = "Checks if the value of the field is `B_0X3`"]
    #[inline(always)]
    pub fn is_b_0x3(&self) -> bool {
        *self == FDTRMSL_A::B_0X3
    }
}
...
impl<'a> FDTRMSL_W<'a> {
    ...
    #[inline(always)]
    pub fn variant(self, variant: FDTRMSL_A) -> &'a mut W {
        {
    ...
    pub fn b_0x0(self) -> &'a mut W {
        self.variant(FDTRMSL_A::B_0X0)
    }
    #[doc = "Nominal delay less 10"]
    #[inline(always)]
    pub fn b_0x1(self) -> &'a mut W {
        self.variant(FDTRMSL_A::B_0X1)
    }
    #[doc = "Nominal delay more 10"]
    #[inline(always)]
    pub fn b_0x2(self) -> &'a mut W {
        self.variant(FDTRMSL_A::B_0X2)
    }
    #[doc = "Nominal delay more 20"]
    #[inline(always)]
    pub fn b_0x3(self) -> &'a mut W {
        self.variant(FDTRMSL_A::B_0X3)
    }
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
