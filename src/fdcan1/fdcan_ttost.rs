...
#[doc = "Writer for register FDCAN_TTOST"]
pub type W = crate::W<u32, super::FDCAN_TTOST>;
#[doc = "Register FDCAN_TTOST `reset()`'s with value 0"]
impl crate::ResetValue for super::FDCAN_TTOST {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `GTP`"]
pub type GTP_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `GTP`"]
pub struct GTP_W<'a> {
    w: &'a mut W,
}
impl<'a> GTP_W<'a> {
