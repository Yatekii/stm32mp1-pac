#[doc = "Reader of register FDCAN_TURCF"]
pub type R = crate::R<u32, super::FDCAN_TURCF>;
#[doc = "Writer for register FDCAN_TURCF"]
pub type W = crate::W<u32, super::FDCAN_TURCF>;
#[doc = "Register FDCAN_TURCF `reset()`'s with value 0"]
impl crate::ResetValue for super::FDCAN_TURCF {
    type Type = u32;
    #[inline(always)]
...
impl R {
    ...
    #[inline(always)]
    pub fn dc(&self) -> DC_R {
        DC_R::new(((self.bits >> 16) & 0x7fff) as u16)
    }
    #[doc = "Bit 31 - ELT"]
    #[inline(always)]
