#[doc = "Reader of register ABPR"]
pub type R = crate::R<u32, super::ABPR>;
#[doc = "Writer for register ABPR"]
pub type W = crate::W<u32, super::ABPR>;
#[doc = "Register ABPR `reset()`'s with value 0x03"]
impl crate::ResetValue for super::ABPR {
    type Type = u32;
    #[inline(always)]
