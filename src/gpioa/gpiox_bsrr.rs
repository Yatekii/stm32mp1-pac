#[doc = "Writer for register GPIOx_BSRR"]
pub type W = crate::W<u32, super::GPIOX_BSRR>;
#[doc = "Register GPIOx_BSRR `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIOX_BSRR {
    type Type = u32;
    #[inline(always)]
