#[doc = "Reader of register SYSCFG_IOCTRLR"]
pub type R = crate::R<u32, super::SYSCFG_IOCTRLR>;
#[doc = "Writer for register SYSCFG_IOCTRLR"]
pub type W = crate::W<u32, super::SYSCFG_IOCTRLR>;
#[doc = "Register SYSCFG_IOCTRLR `reset()`'s with value 0"]
impl crate::ResetValue for super::SYSCFG_IOCTRLR {
    type Type = u32;
    #[inline(always)]
