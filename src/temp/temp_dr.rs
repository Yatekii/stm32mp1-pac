#[doc = "Reader of register TEMP_DR"]
pub type R = crate::R<u32, super::TEMP_DR>;
#[doc = "Writer for register TEMP_DR"]
pub type W = crate::W<u32, super::TEMP_DR>;
#[doc = "Register TEMP_DR `reset()`'s with value 0"]
impl crate::ResetValue for super::TEMP_DR {
    type Type = u32;
    #[inline(always)]
