...
pub type NOR_BASE_R = crate::R<bool, bool>;
#[doc = "Reader of field `SDRAM_RBASE`"]
pub type SDRAM_RBASE_R = crate::R<bool, bool>;
...
impl R {
    ...
    pub fn nor_base(&self) -> NOR_BASE_R {
        NOR_BASE_R::new(((self.bits >> 4) & 0x01) != 0)
    }
    #[doc = "Bit 8 - SDRAM_RBASE"]
    #[inline(always)]
    pub fn sdram_rbase(&self) -> SDRAM_RBASE_R {
        SDRAM_RBASE_R::new(((self.bits >> 8) & 0x01) != 0)
    }
