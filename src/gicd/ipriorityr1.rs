#[doc = "Reader of register IPRIORITYR1"]
pub type R = crate::R<u32, super::IPRIORITYR1>;
#[doc = "Writer for register IPRIORITYR1"]
pub type W = crate::W<u32, super::IPRIORITYR1>;
#[doc = "Register IPRIORITYR1 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR1 {
    type Type = u32;
    #[inline(always)]
