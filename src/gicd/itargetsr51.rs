#[doc = "Reader of register ITARGETSR51"]
pub type R = crate::R<u32, super::ITARGETSR51>;
#[doc = "Writer for register ITARGETSR51"]
pub type W = crate::W<u32, super::ITARGETSR51>;
#[doc = "Register ITARGETSR51 `reset()`'s with value 0"]
impl crate::ResetValue for super::ITARGETSR51 {
    type Type = u32;
    #[inline(always)]
