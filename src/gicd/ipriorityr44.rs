#[doc = "Reader of register IPRIORITYR44"]
pub type R = crate::R<u32, super::IPRIORITYR44>;
#[doc = "Writer for register IPRIORITYR44"]
pub type W = crate::W<u32, super::IPRIORITYR44>;
#[doc = "Register IPRIORITYR44 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR44 {
    type Type = u32;
    #[inline(always)]
