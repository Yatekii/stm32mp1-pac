#[doc = "Reader of register ITARGETSR60"]
pub type R = crate::R<u32, super::ITARGETSR60>;
#[doc = "Writer for register ITARGETSR60"]
pub type W = crate::W<u32, super::ITARGETSR60>;
#[doc = "Register ITARGETSR60 `reset()`'s with value 0"]
impl crate::ResetValue for super::ITARGETSR60 {
    type Type = u32;
    #[inline(always)]
