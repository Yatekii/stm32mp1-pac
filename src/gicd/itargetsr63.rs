#[doc = "Reader of register ITARGETSR63"]
pub type R = crate::R<u32, super::ITARGETSR63>;
#[doc = "Writer for register ITARGETSR63"]
pub type W = crate::W<u32, super::ITARGETSR63>;
#[doc = "Register ITARGETSR63 `reset()`'s with value 0"]
impl crate::ResetValue for super::ITARGETSR63 {
    type Type = u32;
    #[inline(always)]
