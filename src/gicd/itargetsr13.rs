#[doc = "Reader of register ITARGETSR13"]
pub type R = crate::R<u32, super::ITARGETSR13>;
#[doc = "Writer for register ITARGETSR13"]
pub type W = crate::W<u32, super::ITARGETSR13>;
#[doc = "Register ITARGETSR13 `reset()`'s with value 0"]
impl crate::ResetValue for super::ITARGETSR13 {
    type Type = u32;
    #[inline(always)]
