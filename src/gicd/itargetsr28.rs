#[doc = "Reader of register ITARGETSR28"]
pub type R = crate::R<u32, super::ITARGETSR28>;
#[doc = "Writer for register ITARGETSR28"]
pub type W = crate::W<u32, super::ITARGETSR28>;
#[doc = "Register ITARGETSR28 `reset()`'s with value 0"]
impl crate::ResetValue for super::ITARGETSR28 {
    type Type = u32;
    #[inline(always)]
