#[doc = "Reader of register IPRIORITYR33"]
pub type R = crate::R<u32, super::IPRIORITYR33>;
#[doc = "Writer for register IPRIORITYR33"]
pub type W = crate::W<u32, super::IPRIORITYR33>;
#[doc = "Register IPRIORITYR33 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR33 {
    type Type = u32;
    #[inline(always)]
