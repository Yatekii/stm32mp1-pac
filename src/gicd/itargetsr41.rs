#[doc = "Reader of register ITARGETSR41"]
pub type R = crate::R<u32, super::ITARGETSR41>;
#[doc = "Writer for register ITARGETSR41"]
pub type W = crate::W<u32, super::ITARGETSR41>;
#[doc = "Register ITARGETSR41 `reset()`'s with value 0"]
impl crate::ResetValue for super::ITARGETSR41 {
    type Type = u32;
    #[inline(always)]
