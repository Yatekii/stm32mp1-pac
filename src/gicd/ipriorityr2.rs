#[doc = "Reader of register IPRIORITYR2"]
pub type R = crate::R<u32, super::IPRIORITYR2>;
#[doc = "Writer for register IPRIORITYR2"]
pub type W = crate::W<u32, super::IPRIORITYR2>;
#[doc = "Register IPRIORITYR2 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR2 {
    type Type = u32;
    #[inline(always)]
