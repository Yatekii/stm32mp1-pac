#[doc = "Reader of register ITARGETSR61"]
pub type R = crate::R<u32, super::ITARGETSR61>;
#[doc = "Writer for register ITARGETSR61"]
pub type W = crate::W<u32, super::ITARGETSR61>;
#[doc = "Register ITARGETSR61 `reset()`'s with value 0"]
impl crate::ResetValue for super::ITARGETSR61 {
    type Type = u32;
    #[inline(always)]
