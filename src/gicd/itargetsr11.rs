#[doc = "Reader of register ITARGETSR11"]
pub type R = crate::R<u32, super::ITARGETSR11>;
#[doc = "Writer for register ITARGETSR11"]
pub type W = crate::W<u32, super::ITARGETSR11>;
#[doc = "Register ITARGETSR11 `reset()`'s with value 0"]
impl crate::ResetValue for super::ITARGETSR11 {
    type Type = u32;
    #[inline(always)]
