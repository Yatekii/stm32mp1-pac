#[doc = "Reader of register ITARGETSR52"]
pub type R = crate::R<u32, super::ITARGETSR52>;
#[doc = "Writer for register ITARGETSR52"]
pub type W = crate::W<u32, super::ITARGETSR52>;
#[doc = "Register ITARGETSR52 `reset()`'s with value 0"]
impl crate::ResetValue for super::ITARGETSR52 {
    type Type = u32;
    #[inline(always)]
