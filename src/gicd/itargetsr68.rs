#[doc = "Reader of register ITARGETSR68"]
pub type R = crate::R<u32, super::ITARGETSR68>;
#[doc = "Writer for register ITARGETSR68"]
pub type W = crate::W<u32, super::ITARGETSR68>;
#[doc = "Register ITARGETSR68 `reset()`'s with value 0"]
impl crate::ResetValue for super::ITARGETSR68 {
    type Type = u32;
    #[inline(always)]
