#[doc = "Reader of register IPRIORITYR34"]
pub type R = crate::R<u32, super::IPRIORITYR34>;
#[doc = "Writer for register IPRIORITYR34"]
pub type W = crate::W<u32, super::IPRIORITYR34>;
#[doc = "Register IPRIORITYR34 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR34 {
    type Type = u32;
    #[inline(always)]
