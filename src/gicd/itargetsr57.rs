#[doc = "Reader of register ITARGETSR57"]
pub type R = crate::R<u32, super::ITARGETSR57>;
#[doc = "Writer for register ITARGETSR57"]
pub type W = crate::W<u32, super::ITARGETSR57>;
#[doc = "Register ITARGETSR57 `reset()`'s with value 0"]
impl crate::ResetValue for super::ITARGETSR57 {
    type Type = u32;
    #[inline(always)]
