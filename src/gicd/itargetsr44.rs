#[doc = "Reader of register ITARGETSR44"]
pub type R = crate::R<u32, super::ITARGETSR44>;
#[doc = "Writer for register ITARGETSR44"]
pub type W = crate::W<u32, super::ITARGETSR44>;
#[doc = "Register ITARGETSR44 `reset()`'s with value 0"]
impl crate::ResetValue for super::ITARGETSR44 {
    type Type = u32;
    #[inline(always)]
