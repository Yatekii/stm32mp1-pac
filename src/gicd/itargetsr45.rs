#[doc = "Reader of register ITARGETSR45"]
pub type R = crate::R<u32, super::ITARGETSR45>;
#[doc = "Writer for register ITARGETSR45"]
pub type W = crate::W<u32, super::ITARGETSR45>;
#[doc = "Register ITARGETSR45 `reset()`'s with value 0"]
impl crate::ResetValue for super::ITARGETSR45 {
    type Type = u32;
    #[inline(always)]
