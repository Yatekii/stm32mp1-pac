#[doc = "Reader of register IPRIORITYR5"]
pub type R = crate::R<u32, super::IPRIORITYR5>;
#[doc = "Writer for register IPRIORITYR5"]
pub type W = crate::W<u32, super::IPRIORITYR5>;
#[doc = "Register IPRIORITYR5 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR5 {
    type Type = u32;
    #[inline(always)]
