#[doc = "Reader of register IPRIORITYR16"]
pub type R = crate::R<u32, super::IPRIORITYR16>;
#[doc = "Writer for register IPRIORITYR16"]
pub type W = crate::W<u32, super::IPRIORITYR16>;
#[doc = "Register IPRIORITYR16 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR16 {
    type Type = u32;
    #[inline(always)]
