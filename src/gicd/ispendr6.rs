#[doc = "Reader of register ISPENDR6"]
pub type R = crate::R<u32, super::ISPENDR6>;
#[doc = "Writer for register ISPENDR6"]
pub type W = crate::W<u32, super::ISPENDR6>;
#[doc = "Register ISPENDR6 `reset()`'s with value 0"]
impl crate::ResetValue for super::ISPENDR6 {
    type Type = u32;
    #[inline(always)]
