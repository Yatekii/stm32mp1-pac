#[doc = "Reader of register IPRIORITYR53"]
pub type R = crate::R<u32, super::IPRIORITYR53>;
#[doc = "Writer for register IPRIORITYR53"]
pub type W = crate::W<u32, super::IPRIORITYR53>;
#[doc = "Register IPRIORITYR53 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR53 {
    type Type = u32;
    #[inline(always)]
