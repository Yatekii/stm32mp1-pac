#[doc = "Reader of register ITARGETSR21"]
pub type R = crate::R<u32, super::ITARGETSR21>;
#[doc = "Writer for register ITARGETSR21"]
pub type W = crate::W<u32, super::ITARGETSR21>;
#[doc = "Register ITARGETSR21 `reset()`'s with value 0"]
impl crate::ResetValue for super::ITARGETSR21 {
    type Type = u32;
    #[inline(always)]
