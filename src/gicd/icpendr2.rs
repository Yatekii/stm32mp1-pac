#[doc = "Reader of register ICPENDR2"]
pub type R = crate::R<u32, super::ICPENDR2>;
#[doc = "Writer for register ICPENDR2"]
pub type W = crate::W<u32, super::ICPENDR2>;
#[doc = "Register ICPENDR2 `reset()`'s with value 0"]
impl crate::ResetValue for super::ICPENDR2 {
    type Type = u32;
    #[inline(always)]
