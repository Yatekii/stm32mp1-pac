#[doc = "Reader of register ITARGETSR39"]
pub type R = crate::R<u32, super::ITARGETSR39>;
#[doc = "Writer for register ITARGETSR39"]
pub type W = crate::W<u32, super::ITARGETSR39>;
#[doc = "Register ITARGETSR39 `reset()`'s with value 0"]
impl crate::ResetValue for super::ITARGETSR39 {
    type Type = u32;
    #[inline(always)]
