#[doc = "Reader of register ITARGETSR49"]
pub type R = crate::R<u32, super::ITARGETSR49>;
#[doc = "Writer for register ITARGETSR49"]
pub type W = crate::W<u32, super::ITARGETSR49>;
#[doc = "Register ITARGETSR49 `reset()`'s with value 0"]
impl crate::ResetValue for super::ITARGETSR49 {
    type Type = u32;
    #[inline(always)]
