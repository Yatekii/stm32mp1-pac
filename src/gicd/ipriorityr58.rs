#[doc = "Reader of register IPRIORITYR58"]
pub type R = crate::R<u32, super::IPRIORITYR58>;
#[doc = "Writer for register IPRIORITYR58"]
pub type W = crate::W<u32, super::IPRIORITYR58>;
#[doc = "Register IPRIORITYR58 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR58 {
    type Type = u32;
    #[inline(always)]
