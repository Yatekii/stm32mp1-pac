#[doc = "Reader of register ICPENDR0"]
pub type R = crate::R<u32, super::ICPENDR0>;
#[doc = "Writer for register ICPENDR0"]
pub type W = crate::W<u32, super::ICPENDR0>;
#[doc = "Register ICPENDR0 `reset()`'s with value 0"]
impl crate::ResetValue for super::ICPENDR0 {
    type Type = u32;
    #[inline(always)]
