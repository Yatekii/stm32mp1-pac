#[doc = "Reader of register ITARGETSR65"]
pub type R = crate::R<u32, super::ITARGETSR65>;
#[doc = "Writer for register ITARGETSR65"]
pub type W = crate::W<u32, super::ITARGETSR65>;
#[doc = "Register ITARGETSR65 `reset()`'s with value 0"]
impl crate::ResetValue for super::ITARGETSR65 {
    type Type = u32;
    #[inline(always)]
