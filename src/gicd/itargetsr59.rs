#[doc = "Reader of register ITARGETSR59"]
pub type R = crate::R<u32, super::ITARGETSR59>;
#[doc = "Writer for register ITARGETSR59"]
pub type W = crate::W<u32, super::ITARGETSR59>;
#[doc = "Register ITARGETSR59 `reset()`'s with value 0"]
impl crate::ResetValue for super::ITARGETSR59 {
    type Type = u32;
    #[inline(always)]
