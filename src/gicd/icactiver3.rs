#[doc = "Reader of register ICACTIVER3"]
pub type R = crate::R<u32, super::ICACTIVER3>;
#[doc = "Writer for register ICACTIVER3"]
pub type W = crate::W<u32, super::ICACTIVER3>;
#[doc = "Register ICACTIVER3 `reset()`'s with value 0"]
impl crate::ResetValue for super::ICACTIVER3 {
    type Type = u32;
    #[inline(always)]
