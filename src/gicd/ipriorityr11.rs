#[doc = "Reader of register IPRIORITYR11"]
pub type R = crate::R<u32, super::IPRIORITYR11>;
#[doc = "Writer for register IPRIORITYR11"]
pub type W = crate::W<u32, super::IPRIORITYR11>;
#[doc = "Register IPRIORITYR11 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR11 {
    type Type = u32;
    #[inline(always)]
