#[doc = "Reader of register IPRIORITYR32"]
pub type R = crate::R<u32, super::IPRIORITYR32>;
#[doc = "Writer for register IPRIORITYR32"]
pub type W = crate::W<u32, super::IPRIORITYR32>;
#[doc = "Register IPRIORITYR32 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR32 {
    type Type = u32;
    #[inline(always)]
