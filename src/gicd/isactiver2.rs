#[doc = "Reader of register ISACTIVER2"]
pub type R = crate::R<u32, super::ISACTIVER2>;
#[doc = "Writer for register ISACTIVER2"]
pub type W = crate::W<u32, super::ISACTIVER2>;
#[doc = "Register ISACTIVER2 `reset()`'s with value 0"]
impl crate::ResetValue for super::ISACTIVER2 {
    type Type = u32;
    #[inline(always)]
