#[doc = "Reader of register ICACTIVER6"]
pub type R = crate::R<u32, super::ICACTIVER6>;
#[doc = "Writer for register ICACTIVER6"]
pub type W = crate::W<u32, super::ICACTIVER6>;
#[doc = "Register ICACTIVER6 `reset()`'s with value 0"]
impl crate::ResetValue for super::ICACTIVER6 {
    type Type = u32;
    #[inline(always)]
