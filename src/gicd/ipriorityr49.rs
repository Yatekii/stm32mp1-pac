#[doc = "Reader of register IPRIORITYR49"]
pub type R = crate::R<u32, super::IPRIORITYR49>;
#[doc = "Writer for register IPRIORITYR49"]
pub type W = crate::W<u32, super::IPRIORITYR49>;
#[doc = "Register IPRIORITYR49 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR49 {
    type Type = u32;
    #[inline(always)]
