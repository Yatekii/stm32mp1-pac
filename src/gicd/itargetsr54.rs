#[doc = "Reader of register ITARGETSR54"]
pub type R = crate::R<u32, super::ITARGETSR54>;
#[doc = "Writer for register ITARGETSR54"]
pub type W = crate::W<u32, super::ITARGETSR54>;
#[doc = "Register ITARGETSR54 `reset()`'s with value 0"]
impl crate::ResetValue for super::ITARGETSR54 {
    type Type = u32;
    #[inline(always)]
