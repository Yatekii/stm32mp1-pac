#[doc = "Reader of register ICACTIVER4"]
pub type R = crate::R<u32, super::ICACTIVER4>;
#[doc = "Writer for register ICACTIVER4"]
pub type W = crate::W<u32, super::ICACTIVER4>;
#[doc = "Register ICACTIVER4 `reset()`'s with value 0"]
impl crate::ResetValue for super::ICACTIVER4 {
    type Type = u32;
    #[inline(always)]
