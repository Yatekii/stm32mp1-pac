#[doc = "Reader of register IPRIORITYR68"]
pub type R = crate::R<u32, super::IPRIORITYR68>;
#[doc = "Writer for register IPRIORITYR68"]
pub type W = crate::W<u32, super::IPRIORITYR68>;
#[doc = "Register IPRIORITYR68 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR68 {
    type Type = u32;
    #[inline(always)]
