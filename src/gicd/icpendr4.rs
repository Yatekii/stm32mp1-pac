#[doc = "Reader of register ICPENDR4"]
pub type R = crate::R<u32, super::ICPENDR4>;
#[doc = "Writer for register ICPENDR4"]
pub type W = crate::W<u32, super::ICPENDR4>;
#[doc = "Register ICPENDR4 `reset()`'s with value 0"]
impl crate::ResetValue for super::ICPENDR4 {
    type Type = u32;
    #[inline(always)]
