#[doc = "Reader of register ITARGETSR27"]
pub type R = crate::R<u32, super::ITARGETSR27>;
#[doc = "Writer for register ITARGETSR27"]
pub type W = crate::W<u32, super::ITARGETSR27>;
#[doc = "Register ITARGETSR27 `reset()`'s with value 0"]
impl crate::ResetValue for super::ITARGETSR27 {
    type Type = u32;
    #[inline(always)]
