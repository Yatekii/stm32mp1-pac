#[doc = "Reader of register ISENABLER4"]
pub type R = crate::R<u32, super::ISENABLER4>;
#[doc = "Writer for register ISENABLER4"]
pub type W = crate::W<u32, super::ISENABLER4>;
#[doc = "Register ISENABLER4 `reset()`'s with value 0"]
impl crate::ResetValue for super::ISENABLER4 {
    type Type = u32;
    #[inline(always)]
