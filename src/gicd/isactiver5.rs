#[doc = "Reader of register ISACTIVER5"]
pub type R = crate::R<u32, super::ISACTIVER5>;
#[doc = "Writer for register ISACTIVER5"]
pub type W = crate::W<u32, super::ISACTIVER5>;
#[doc = "Register ISACTIVER5 `reset()`'s with value 0"]
impl crate::ResetValue for super::ISACTIVER5 {
    type Type = u32;
    #[inline(always)]
