#[doc = "Reader of register IPRIORITYR9"]
pub type R = crate::R<u32, super::IPRIORITYR9>;
#[doc = "Writer for register IPRIORITYR9"]
pub type W = crate::W<u32, super::IPRIORITYR9>;
#[doc = "Register IPRIORITYR9 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR9 {
    type Type = u32;
    #[inline(always)]
