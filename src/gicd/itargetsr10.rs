#[doc = "Reader of register ITARGETSR10"]
pub type R = crate::R<u32, super::ITARGETSR10>;
#[doc = "Writer for register ITARGETSR10"]
pub type W = crate::W<u32, super::ITARGETSR10>;
#[doc = "Register ITARGETSR10 `reset()`'s with value 0"]
impl crate::ResetValue for super::ITARGETSR10 {
    type Type = u32;
    #[inline(always)]
