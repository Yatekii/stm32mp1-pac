#[doc = "Reader of register IPRIORITYR37"]
pub type R = crate::R<u32, super::IPRIORITYR37>;
#[doc = "Writer for register IPRIORITYR37"]
pub type W = crate::W<u32, super::IPRIORITYR37>;
#[doc = "Register IPRIORITYR37 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR37 {
    type Type = u32;
    #[inline(always)]
