#[doc = "Reader of register IPRIORITYR21"]
pub type R = crate::R<u32, super::IPRIORITYR21>;
#[doc = "Writer for register IPRIORITYR21"]
pub type W = crate::W<u32, super::IPRIORITYR21>;
#[doc = "Register IPRIORITYR21 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR21 {
    type Type = u32;
    #[inline(always)]
