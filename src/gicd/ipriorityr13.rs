#[doc = "Reader of register IPRIORITYR13"]
pub type R = crate::R<u32, super::IPRIORITYR13>;
#[doc = "Writer for register IPRIORITYR13"]
pub type W = crate::W<u32, super::IPRIORITYR13>;
#[doc = "Register IPRIORITYR13 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR13 {
    type Type = u32;
    #[inline(always)]
