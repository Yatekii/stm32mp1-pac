#[doc = "Reader of register ITARGETSR35"]
pub type R = crate::R<u32, super::ITARGETSR35>;
#[doc = "Writer for register ITARGETSR35"]
pub type W = crate::W<u32, super::ITARGETSR35>;
#[doc = "Register ITARGETSR35 `reset()`'s with value 0"]
impl crate::ResetValue for super::ITARGETSR35 {
    type Type = u32;
    #[inline(always)]
