#[doc = "Reader of register IPRIORITYR55"]
pub type R = crate::R<u32, super::IPRIORITYR55>;
#[doc = "Writer for register IPRIORITYR55"]
pub type W = crate::W<u32, super::IPRIORITYR55>;
#[doc = "Register IPRIORITYR55 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR55 {
    type Type = u32;
    #[inline(always)]
