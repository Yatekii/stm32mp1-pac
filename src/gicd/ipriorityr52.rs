#[doc = "Reader of register IPRIORITYR52"]
pub type R = crate::R<u32, super::IPRIORITYR52>;
#[doc = "Writer for register IPRIORITYR52"]
pub type W = crate::W<u32, super::IPRIORITYR52>;
#[doc = "Register IPRIORITYR52 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR52 {
    type Type = u32;
    #[inline(always)]
