#[doc = "Reader of register ITARGETSR66"]
pub type R = crate::R<u32, super::ITARGETSR66>;
#[doc = "Writer for register ITARGETSR66"]
pub type W = crate::W<u32, super::ITARGETSR66>;
#[doc = "Register ITARGETSR66 `reset()`'s with value 0"]
impl crate::ResetValue for super::ITARGETSR66 {
    type Type = u32;
    #[inline(always)]
