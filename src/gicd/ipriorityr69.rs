#[doc = "Reader of register IPRIORITYR69"]
pub type R = crate::R<u32, super::IPRIORITYR69>;
#[doc = "Writer for register IPRIORITYR69"]
pub type W = crate::W<u32, super::IPRIORITYR69>;
#[doc = "Register IPRIORITYR69 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR69 {
    type Type = u32;
    #[inline(always)]
