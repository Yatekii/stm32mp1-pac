#[doc = "Reader of register ITARGETSR47"]
pub type R = crate::R<u32, super::ITARGETSR47>;
#[doc = "Writer for register ITARGETSR47"]
pub type W = crate::W<u32, super::ITARGETSR47>;
#[doc = "Register ITARGETSR47 `reset()`'s with value 0"]
impl crate::ResetValue for super::ITARGETSR47 {
    type Type = u32;
    #[inline(always)]
