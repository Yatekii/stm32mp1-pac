#[doc = "Reader of register IPRIORITYR60"]
pub type R = crate::R<u32, super::IPRIORITYR60>;
#[doc = "Writer for register IPRIORITYR60"]
pub type W = crate::W<u32, super::IPRIORITYR60>;
#[doc = "Register IPRIORITYR60 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR60 {
    type Type = u32;
    #[inline(always)]
