#[doc = "Reader of register ISENABLER6"]
pub type R = crate::R<u32, super::ISENABLER6>;
#[doc = "Writer for register ISENABLER6"]
pub type W = crate::W<u32, super::ISENABLER6>;
#[doc = "Register ISENABLER6 `reset()`'s with value 0"]
impl crate::ResetValue for super::ISENABLER6 {
    type Type = u32;
    #[inline(always)]
