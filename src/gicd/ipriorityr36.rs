#[doc = "Reader of register IPRIORITYR36"]
pub type R = crate::R<u32, super::IPRIORITYR36>;
#[doc = "Writer for register IPRIORITYR36"]
pub type W = crate::W<u32, super::IPRIORITYR36>;
#[doc = "Register IPRIORITYR36 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR36 {
    type Type = u32;
    #[inline(always)]
