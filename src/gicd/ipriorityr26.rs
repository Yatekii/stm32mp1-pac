#[doc = "Reader of register IPRIORITYR26"]
pub type R = crate::R<u32, super::IPRIORITYR26>;
#[doc = "Writer for register IPRIORITYR26"]
pub type W = crate::W<u32, super::IPRIORITYR26>;
#[doc = "Register IPRIORITYR26 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR26 {
    type Type = u32;
    #[inline(always)]
