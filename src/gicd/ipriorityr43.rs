#[doc = "Reader of register IPRIORITYR43"]
pub type R = crate::R<u32, super::IPRIORITYR43>;
#[doc = "Writer for register IPRIORITYR43"]
pub type W = crate::W<u32, super::IPRIORITYR43>;
#[doc = "Register IPRIORITYR43 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR43 {
    type Type = u32;
    #[inline(always)]
