#[doc = "Reader of register ISACTIVER4"]
pub type R = crate::R<u32, super::ISACTIVER4>;
#[doc = "Writer for register ISACTIVER4"]
pub type W = crate::W<u32, super::ISACTIVER4>;
#[doc = "Register ISACTIVER4 `reset()`'s with value 0"]
impl crate::ResetValue for super::ISACTIVER4 {
    type Type = u32;
    #[inline(always)]
