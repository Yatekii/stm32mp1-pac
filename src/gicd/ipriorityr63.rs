#[doc = "Reader of register IPRIORITYR63"]
pub type R = crate::R<u32, super::IPRIORITYR63>;
#[doc = "Writer for register IPRIORITYR63"]
pub type W = crate::W<u32, super::IPRIORITYR63>;
#[doc = "Register IPRIORITYR63 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR63 {
    type Type = u32;
    #[inline(always)]
