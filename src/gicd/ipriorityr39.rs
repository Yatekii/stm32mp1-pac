#[doc = "Reader of register IPRIORITYR39"]
pub type R = crate::R<u32, super::IPRIORITYR39>;
#[doc = "Writer for register IPRIORITYR39"]
pub type W = crate::W<u32, super::IPRIORITYR39>;
#[doc = "Register IPRIORITYR39 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR39 {
    type Type = u32;
    #[inline(always)]
