#[doc = "Reader of register IPRIORITYR38"]
pub type R = crate::R<u32, super::IPRIORITYR38>;
#[doc = "Writer for register IPRIORITYR38"]
pub type W = crate::W<u32, super::IPRIORITYR38>;
#[doc = "Register IPRIORITYR38 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR38 {
    type Type = u32;
    #[inline(always)]
