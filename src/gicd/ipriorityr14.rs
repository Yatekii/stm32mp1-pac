#[doc = "Reader of register IPRIORITYR14"]
pub type R = crate::R<u32, super::IPRIORITYR14>;
#[doc = "Writer for register IPRIORITYR14"]
pub type W = crate::W<u32, super::IPRIORITYR14>;
#[doc = "Register IPRIORITYR14 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR14 {
    type Type = u32;
    #[inline(always)]
