#[doc = "Reader of register ITARGETSR55"]
pub type R = crate::R<u32, super::ITARGETSR55>;
#[doc = "Writer for register ITARGETSR55"]
pub type W = crate::W<u32, super::ITARGETSR55>;
#[doc = "Register ITARGETSR55 `reset()`'s with value 0"]
impl crate::ResetValue for super::ITARGETSR55 {
    type Type = u32;
    #[inline(always)]
