#[doc = "Reader of register ICACTIVER0"]
pub type R = crate::R<u32, super::ICACTIVER0>;
#[doc = "Writer for register ICACTIVER0"]
pub type W = crate::W<u32, super::ICACTIVER0>;
#[doc = "Register ICACTIVER0 `reset()`'s with value 0"]
impl crate::ResetValue for super::ICACTIVER0 {
    type Type = u32;
    #[inline(always)]
