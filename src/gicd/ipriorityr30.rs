#[doc = "Reader of register IPRIORITYR30"]
pub type R = crate::R<u32, super::IPRIORITYR30>;
#[doc = "Writer for register IPRIORITYR30"]
pub type W = crate::W<u32, super::IPRIORITYR30>;
#[doc = "Register IPRIORITYR30 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR30 {
    type Type = u32;
    #[inline(always)]
