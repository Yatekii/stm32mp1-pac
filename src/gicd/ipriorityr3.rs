#[doc = "Reader of register IPRIORITYR3"]
pub type R = crate::R<u32, super::IPRIORITYR3>;
#[doc = "Writer for register IPRIORITYR3"]
pub type W = crate::W<u32, super::IPRIORITYR3>;
#[doc = "Register IPRIORITYR3 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR3 {
    type Type = u32;
    #[inline(always)]
