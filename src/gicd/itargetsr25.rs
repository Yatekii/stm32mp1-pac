#[doc = "Reader of register ITARGETSR25"]
pub type R = crate::R<u32, super::ITARGETSR25>;
#[doc = "Writer for register ITARGETSR25"]
pub type W = crate::W<u32, super::ITARGETSR25>;
#[doc = "Register ITARGETSR25 `reset()`'s with value 0"]
impl crate::ResetValue for super::ITARGETSR25 {
    type Type = u32;
    #[inline(always)]
