#[doc = "Reader of register IPRIORITYR47"]
pub type R = crate::R<u32, super::IPRIORITYR47>;
#[doc = "Writer for register IPRIORITYR47"]
pub type W = crate::W<u32, super::IPRIORITYR47>;
#[doc = "Register IPRIORITYR47 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR47 {
    type Type = u32;
    #[inline(always)]
