#[doc = "Reader of register ITARGETSR23"]
pub type R = crate::R<u32, super::ITARGETSR23>;
#[doc = "Writer for register ITARGETSR23"]
pub type W = crate::W<u32, super::ITARGETSR23>;
#[doc = "Register ITARGETSR23 `reset()`'s with value 0"]
impl crate::ResetValue for super::ITARGETSR23 {
    type Type = u32;
    #[inline(always)]
