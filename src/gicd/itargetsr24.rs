#[doc = "Reader of register ITARGETSR24"]
pub type R = crate::R<u32, super::ITARGETSR24>;
#[doc = "Writer for register ITARGETSR24"]
pub type W = crate::W<u32, super::ITARGETSR24>;
#[doc = "Register ITARGETSR24 `reset()`'s with value 0"]
impl crate::ResetValue for super::ITARGETSR24 {
    type Type = u32;
    #[inline(always)]
