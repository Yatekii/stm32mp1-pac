#[doc = "Reader of register ITARGETSR42"]
pub type R = crate::R<u32, super::ITARGETSR42>;
#[doc = "Writer for register ITARGETSR42"]
pub type W = crate::W<u32, super::ITARGETSR42>;
#[doc = "Register ITARGETSR42 `reset()`'s with value 0"]
impl crate::ResetValue for super::ITARGETSR42 {
    type Type = u32;
    #[inline(always)]
