#[doc = "Reader of register IPRIORITYR61"]
pub type R = crate::R<u32, super::IPRIORITYR61>;
#[doc = "Writer for register IPRIORITYR61"]
pub type W = crate::W<u32, super::IPRIORITYR61>;
#[doc = "Register IPRIORITYR61 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR61 {
    type Type = u32;
    #[inline(always)]
