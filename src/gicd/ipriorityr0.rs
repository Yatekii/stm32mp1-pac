#[doc = "Reader of register IPRIORITYR0"]
pub type R = crate::R<u32, super::IPRIORITYR0>;
#[doc = "Writer for register IPRIORITYR0"]
pub type W = crate::W<u32, super::IPRIORITYR0>;
#[doc = "Register IPRIORITYR0 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR0 {
    type Type = u32;
    #[inline(always)]
