#[doc = "Reader of register ISPENDR0"]
pub type R = crate::R<u32, super::ISPENDR0>;
#[doc = "Writer for register ISPENDR0"]
pub type W = crate::W<u32, super::ISPENDR0>;
#[doc = "Register ISPENDR0 `reset()`'s with value 0"]
impl crate::ResetValue for super::ISPENDR0 {
    type Type = u32;
    #[inline(always)]
