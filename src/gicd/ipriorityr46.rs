#[doc = "Reader of register IPRIORITYR46"]
pub type R = crate::R<u32, super::IPRIORITYR46>;
#[doc = "Writer for register IPRIORITYR46"]
pub type W = crate::W<u32, super::IPRIORITYR46>;
#[doc = "Register IPRIORITYR46 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR46 {
    type Type = u32;
    #[inline(always)]
