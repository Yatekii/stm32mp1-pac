#[doc = "Reader of register IPRIORITYR15"]
pub type R = crate::R<u32, super::IPRIORITYR15>;
#[doc = "Writer for register IPRIORITYR15"]
pub type W = crate::W<u32, super::IPRIORITYR15>;
#[doc = "Register IPRIORITYR15 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR15 {
    type Type = u32;
    #[inline(always)]
