#[doc = "Reader of register ITARGETSR34"]
pub type R = crate::R<u32, super::ITARGETSR34>;
#[doc = "Writer for register ITARGETSR34"]
pub type W = crate::W<u32, super::ITARGETSR34>;
#[doc = "Register ITARGETSR34 `reset()`'s with value 0"]
impl crate::ResetValue for super::ITARGETSR34 {
    type Type = u32;
    #[inline(always)]
