#[doc = "Reader of register ITARGETSR43"]
pub type R = crate::R<u32, super::ITARGETSR43>;
#[doc = "Writer for register ITARGETSR43"]
pub type W = crate::W<u32, super::ITARGETSR43>;
#[doc = "Register ITARGETSR43 `reset()`'s with value 0"]
impl crate::ResetValue for super::ITARGETSR43 {
    type Type = u32;
    #[inline(always)]
