#[doc = "Reader of register IPRIORITYR71"]
pub type R = crate::R<u32, super::IPRIORITYR71>;
#[doc = "Writer for register IPRIORITYR71"]
pub type W = crate::W<u32, super::IPRIORITYR71>;
#[doc = "Register IPRIORITYR71 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR71 {
    type Type = u32;
    #[inline(always)]
