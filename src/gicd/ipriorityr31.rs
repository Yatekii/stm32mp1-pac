#[doc = "Reader of register IPRIORITYR31"]
pub type R = crate::R<u32, super::IPRIORITYR31>;
#[doc = "Writer for register IPRIORITYR31"]
pub type W = crate::W<u32, super::IPRIORITYR31>;
#[doc = "Register IPRIORITYR31 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR31 {
    type Type = u32;
    #[inline(always)]
