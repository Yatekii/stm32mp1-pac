#[doc = "Reader of register ITARGETSR37"]
pub type R = crate::R<u32, super::ITARGETSR37>;
#[doc = "Writer for register ITARGETSR37"]
pub type W = crate::W<u32, super::ITARGETSR37>;
#[doc = "Register ITARGETSR37 `reset()`'s with value 0"]
impl crate::ResetValue for super::ITARGETSR37 {
    type Type = u32;
    #[inline(always)]
