#[doc = "Reader of register ISPENDR7"]
pub type R = crate::R<u32, super::ISPENDR7>;
#[doc = "Writer for register ISPENDR7"]
pub type W = crate::W<u32, super::ISPENDR7>;
#[doc = "Register ISPENDR7 `reset()`'s with value 0"]
impl crate::ResetValue for super::ISPENDR7 {
    type Type = u32;
    #[inline(always)]
