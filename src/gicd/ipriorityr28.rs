#[doc = "Reader of register IPRIORITYR28"]
pub type R = crate::R<u32, super::IPRIORITYR28>;
#[doc = "Writer for register IPRIORITYR28"]
pub type W = crate::W<u32, super::IPRIORITYR28>;
#[doc = "Register IPRIORITYR28 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR28 {
    type Type = u32;
    #[inline(always)]
