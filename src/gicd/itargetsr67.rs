#[doc = "Reader of register ITARGETSR67"]
pub type R = crate::R<u32, super::ITARGETSR67>;
#[doc = "Writer for register ITARGETSR67"]
pub type W = crate::W<u32, super::ITARGETSR67>;
#[doc = "Register ITARGETSR67 `reset()`'s with value 0"]
impl crate::ResetValue for super::ITARGETSR67 {
    type Type = u32;
    #[inline(always)]
