#[doc = "Reader of register IPRIORITYR8"]
pub type R = crate::R<u32, super::IPRIORITYR8>;
#[doc = "Writer for register IPRIORITYR8"]
pub type W = crate::W<u32, super::IPRIORITYR8>;
#[doc = "Register IPRIORITYR8 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR8 {
    type Type = u32;
    #[inline(always)]
