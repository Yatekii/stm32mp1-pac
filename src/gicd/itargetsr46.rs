#[doc = "Reader of register ITARGETSR46"]
pub type R = crate::R<u32, super::ITARGETSR46>;
#[doc = "Writer for register ITARGETSR46"]
pub type W = crate::W<u32, super::ITARGETSR46>;
#[doc = "Register ITARGETSR46 `reset()`'s with value 0"]
impl crate::ResetValue for super::ITARGETSR46 {
    type Type = u32;
    #[inline(always)]
