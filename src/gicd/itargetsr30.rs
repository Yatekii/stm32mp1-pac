#[doc = "Reader of register ITARGETSR30"]
pub type R = crate::R<u32, super::ITARGETSR30>;
#[doc = "Writer for register ITARGETSR30"]
pub type W = crate::W<u32, super::ITARGETSR30>;
#[doc = "Register ITARGETSR30 `reset()`'s with value 0"]
impl crate::ResetValue for super::ITARGETSR30 {
    type Type = u32;
    #[inline(always)]
