#[doc = "Reader of register IPRIORITYR70"]
pub type R = crate::R<u32, super::IPRIORITYR70>;
#[doc = "Writer for register IPRIORITYR70"]
pub type W = crate::W<u32, super::IPRIORITYR70>;
#[doc = "Register IPRIORITYR70 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR70 {
    type Type = u32;
    #[inline(always)]
