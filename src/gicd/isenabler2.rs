#[doc = "Reader of register ISENABLER2"]
pub type R = crate::R<u32, super::ISENABLER2>;
#[doc = "Writer for register ISENABLER2"]
pub type W = crate::W<u32, super::ISENABLER2>;
#[doc = "Register ISENABLER2 `reset()`'s with value 0"]
impl crate::ResetValue for super::ISENABLER2 {
    type Type = u32;
    #[inline(always)]
