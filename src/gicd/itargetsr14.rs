#[doc = "Reader of register ITARGETSR14"]
pub type R = crate::R<u32, super::ITARGETSR14>;
#[doc = "Writer for register ITARGETSR14"]
pub type W = crate::W<u32, super::ITARGETSR14>;
#[doc = "Register ITARGETSR14 `reset()`'s with value 0"]
impl crate::ResetValue for super::ITARGETSR14 {
    type Type = u32;
    #[inline(always)]
