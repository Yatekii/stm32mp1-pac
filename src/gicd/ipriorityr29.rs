#[doc = "Reader of register IPRIORITYR29"]
pub type R = crate::R<u32, super::IPRIORITYR29>;
#[doc = "Writer for register IPRIORITYR29"]
pub type W = crate::W<u32, super::IPRIORITYR29>;
#[doc = "Register IPRIORITYR29 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR29 {
    type Type = u32;
    #[inline(always)]
