#[doc = "Reader of register ITARGETSR33"]
pub type R = crate::R<u32, super::ITARGETSR33>;
#[doc = "Writer for register ITARGETSR33"]
pub type W = crate::W<u32, super::ITARGETSR33>;
#[doc = "Register ITARGETSR33 `reset()`'s with value 0"]
impl crate::ResetValue for super::ITARGETSR33 {
    type Type = u32;
    #[inline(always)]
