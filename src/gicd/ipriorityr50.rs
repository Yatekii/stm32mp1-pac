#[doc = "Reader of register IPRIORITYR50"]
pub type R = crate::R<u32, super::IPRIORITYR50>;
#[doc = "Writer for register IPRIORITYR50"]
pub type W = crate::W<u32, super::IPRIORITYR50>;
#[doc = "Register IPRIORITYR50 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR50 {
    type Type = u32;
    #[inline(always)]
