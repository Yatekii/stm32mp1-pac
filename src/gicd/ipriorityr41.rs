#[doc = "Reader of register IPRIORITYR41"]
pub type R = crate::R<u32, super::IPRIORITYR41>;
#[doc = "Writer for register IPRIORITYR41"]
pub type W = crate::W<u32, super::IPRIORITYR41>;
#[doc = "Register IPRIORITYR41 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR41 {
    type Type = u32;
    #[inline(always)]
