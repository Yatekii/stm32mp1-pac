#[doc = "Reader of register IPRIORITYR57"]
pub type R = crate::R<u32, super::IPRIORITYR57>;
#[doc = "Writer for register IPRIORITYR57"]
pub type W = crate::W<u32, super::IPRIORITYR57>;
#[doc = "Register IPRIORITYR57 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR57 {
    type Type = u32;
    #[inline(always)]
