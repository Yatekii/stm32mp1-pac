#[doc = "Reader of register IPRIORITYR40"]
pub type R = crate::R<u32, super::IPRIORITYR40>;
#[doc = "Writer for register IPRIORITYR40"]
pub type W = crate::W<u32, super::IPRIORITYR40>;
#[doc = "Register IPRIORITYR40 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR40 {
    type Type = u32;
    #[inline(always)]
