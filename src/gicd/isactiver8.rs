#[doc = "Reader of register ISACTIVER8"]
pub type R = crate::R<u32, super::ISACTIVER8>;
#[doc = "Writer for register ISACTIVER8"]
pub type W = crate::W<u32, super::ISACTIVER8>;
#[doc = "Register ISACTIVER8 `reset()`'s with value 0"]
impl crate::ResetValue for super::ISACTIVER8 {
    type Type = u32;
    #[inline(always)]
