#[doc = "Reader of register IPRIORITYR64"]
pub type R = crate::R<u32, super::IPRIORITYR64>;
#[doc = "Writer for register IPRIORITYR64"]
pub type W = crate::W<u32, super::IPRIORITYR64>;
#[doc = "Register IPRIORITYR64 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR64 {
    type Type = u32;
    #[inline(always)]
