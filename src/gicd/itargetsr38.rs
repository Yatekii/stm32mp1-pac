#[doc = "Reader of register ITARGETSR38"]
pub type R = crate::R<u32, super::ITARGETSR38>;
#[doc = "Writer for register ITARGETSR38"]
pub type W = crate::W<u32, super::ITARGETSR38>;
#[doc = "Register ITARGETSR38 `reset()`'s with value 0"]
impl crate::ResetValue for super::ITARGETSR38 {
    type Type = u32;
    #[inline(always)]
