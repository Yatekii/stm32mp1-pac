#[doc = "Reader of register IPRIORITYR67"]
pub type R = crate::R<u32, super::IPRIORITYR67>;
#[doc = "Writer for register IPRIORITYR67"]
pub type W = crate::W<u32, super::IPRIORITYR67>;
#[doc = "Register IPRIORITYR67 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR67 {
    type Type = u32;
    #[inline(always)]
