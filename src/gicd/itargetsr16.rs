#[doc = "Reader of register ITARGETSR16"]
pub type R = crate::R<u32, super::ITARGETSR16>;
#[doc = "Writer for register ITARGETSR16"]
pub type W = crate::W<u32, super::ITARGETSR16>;
#[doc = "Register ITARGETSR16 `reset()`'s with value 0"]
impl crate::ResetValue for super::ITARGETSR16 {
    type Type = u32;
    #[inline(always)]
