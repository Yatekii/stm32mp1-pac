#[doc = "Reader of register IPRIORITYR42"]
pub type R = crate::R<u32, super::IPRIORITYR42>;
#[doc = "Writer for register IPRIORITYR42"]
pub type W = crate::W<u32, super::IPRIORITYR42>;
#[doc = "Register IPRIORITYR42 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR42 {
    type Type = u32;
    #[inline(always)]
