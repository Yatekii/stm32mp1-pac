#[doc = "Reader of register IPRIORITYR6"]
pub type R = crate::R<u32, super::IPRIORITYR6>;
#[doc = "Writer for register IPRIORITYR6"]
pub type W = crate::W<u32, super::IPRIORITYR6>;
#[doc = "Register IPRIORITYR6 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR6 {
    type Type = u32;
    #[inline(always)]
