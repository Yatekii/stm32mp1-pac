#[doc = "Reader of register ICACTIVER2"]
pub type R = crate::R<u32, super::ICACTIVER2>;
#[doc = "Writer for register ICACTIVER2"]
pub type W = crate::W<u32, super::ICACTIVER2>;
#[doc = "Register ICACTIVER2 `reset()`'s with value 0"]
impl crate::ResetValue for super::ICACTIVER2 {
    type Type = u32;
    #[inline(always)]
