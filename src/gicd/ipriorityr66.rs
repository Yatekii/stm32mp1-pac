#[doc = "Reader of register IPRIORITYR66"]
pub type R = crate::R<u32, super::IPRIORITYR66>;
#[doc = "Writer for register IPRIORITYR66"]
pub type W = crate::W<u32, super::IPRIORITYR66>;
#[doc = "Register IPRIORITYR66 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR66 {
    type Type = u32;
    #[inline(always)]
