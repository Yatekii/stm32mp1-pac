#[doc = "Reader of register IPRIORITYR59"]
pub type R = crate::R<u32, super::IPRIORITYR59>;
#[doc = "Writer for register IPRIORITYR59"]
pub type W = crate::W<u32, super::IPRIORITYR59>;
#[doc = "Register IPRIORITYR59 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR59 {
    type Type = u32;
    #[inline(always)]
