#[doc = "Reader of register IPRIORITYR23"]
pub type R = crate::R<u32, super::IPRIORITYR23>;
#[doc = "Writer for register IPRIORITYR23"]
pub type W = crate::W<u32, super::IPRIORITYR23>;
#[doc = "Register IPRIORITYR23 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR23 {
    type Type = u32;
    #[inline(always)]
