#[doc = "Reader of register ITARGETSR22"]
pub type R = crate::R<u32, super::ITARGETSR22>;
#[doc = "Writer for register ITARGETSR22"]
pub type W = crate::W<u32, super::ITARGETSR22>;
#[doc = "Register ITARGETSR22 `reset()`'s with value 0"]
impl crate::ResetValue for super::ITARGETSR22 {
    type Type = u32;
    #[inline(always)]
