#[doc = "Reader of register ITARGETSR70"]
pub type R = crate::R<u32, super::ITARGETSR70>;
#[doc = "Writer for register ITARGETSR70"]
pub type W = crate::W<u32, super::ITARGETSR70>;
#[doc = "Register ITARGETSR70 `reset()`'s with value 0"]
impl crate::ResetValue for super::ITARGETSR70 {
    type Type = u32;
    #[inline(always)]
