#[doc = "Reader of register ITARGETSR62"]
pub type R = crate::R<u32, super::ITARGETSR62>;
#[doc = "Writer for register ITARGETSR62"]
pub type W = crate::W<u32, super::ITARGETSR62>;
#[doc = "Register ITARGETSR62 `reset()`'s with value 0"]
impl crate::ResetValue for super::ITARGETSR62 {
    type Type = u32;
    #[inline(always)]
