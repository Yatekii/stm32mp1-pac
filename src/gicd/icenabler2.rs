...
#[doc = "Reader of field `ICENABLER2`"]
pub type ICENABLER2_R = crate::R<u32, u32>;
#[doc = "Write proxy for field `ICENABLER2`"]
pub struct ICENABLER2_W<'a> {
    w: &'a mut W,
}
impl<'a> ICENABLER2_W<'a> {
...
impl R {
    ...
    pub fn icenabler2(&self) -> ICENABLER2_R {
        ICENABLER2_R::new((self.bits & 0xffff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:31 - interrupt clear-enable 0"]
    #[inline(always)]
    pub fn icenabler2(&mut self) -> ICENABLER2_W {
        ICENABLER2_W { w: self }
    }
}
