#[doc = "Reader of register IPRIORITYR10"]
pub type R = crate::R<u32, super::IPRIORITYR10>;
#[doc = "Writer for register IPRIORITYR10"]
pub type W = crate::W<u32, super::IPRIORITYR10>;
#[doc = "Register IPRIORITYR10 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR10 {
    type Type = u32;
    #[inline(always)]
