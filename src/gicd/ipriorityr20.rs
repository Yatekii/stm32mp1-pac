#[doc = "Reader of register IPRIORITYR20"]
pub type R = crate::R<u32, super::IPRIORITYR20>;
#[doc = "Writer for register IPRIORITYR20"]
pub type W = crate::W<u32, super::IPRIORITYR20>;
#[doc = "Register IPRIORITYR20 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR20 {
    type Type = u32;
    #[inline(always)]
