#[doc = "Reader of register ITARGETSR31"]
pub type R = crate::R<u32, super::ITARGETSR31>;
#[doc = "Writer for register ITARGETSR31"]
pub type W = crate::W<u32, super::ITARGETSR31>;
#[doc = "Register ITARGETSR31 `reset()`'s with value 0"]
impl crate::ResetValue for super::ITARGETSR31 {
    type Type = u32;
    #[inline(always)]
