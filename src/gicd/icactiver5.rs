#[doc = "Reader of register ICACTIVER5"]
pub type R = crate::R<u32, super::ICACTIVER5>;
#[doc = "Writer for register ICACTIVER5"]
pub type W = crate::W<u32, super::ICACTIVER5>;
#[doc = "Register ICACTIVER5 `reset()`'s with value 0"]
impl crate::ResetValue for super::ICACTIVER5 {
    type Type = u32;
    #[inline(always)]
