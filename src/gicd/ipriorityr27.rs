#[doc = "Reader of register IPRIORITYR27"]
pub type R = crate::R<u32, super::IPRIORITYR27>;
#[doc = "Writer for register IPRIORITYR27"]
pub type W = crate::W<u32, super::IPRIORITYR27>;
#[doc = "Register IPRIORITYR27 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR27 {
    type Type = u32;
    #[inline(always)]
