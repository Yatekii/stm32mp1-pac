#[doc = "Reader of register IPRIORITYR56"]
pub type R = crate::R<u32, super::IPRIORITYR56>;
#[doc = "Writer for register IPRIORITYR56"]
pub type W = crate::W<u32, super::IPRIORITYR56>;
#[doc = "Register IPRIORITYR56 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR56 {
    type Type = u32;
    #[inline(always)]
