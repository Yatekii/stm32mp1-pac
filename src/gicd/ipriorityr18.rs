#[doc = "Reader of register IPRIORITYR18"]
pub type R = crate::R<u32, super::IPRIORITYR18>;
#[doc = "Writer for register IPRIORITYR18"]
pub type W = crate::W<u32, super::IPRIORITYR18>;
#[doc = "Register IPRIORITYR18 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR18 {
    type Type = u32;
    #[inline(always)]
