#[doc = "Reader of register ITARGETSR40"]
pub type R = crate::R<u32, super::ITARGETSR40>;
#[doc = "Writer for register ITARGETSR40"]
pub type W = crate::W<u32, super::ITARGETSR40>;
#[doc = "Register ITARGETSR40 `reset()`'s with value 0"]
impl crate::ResetValue for super::ITARGETSR40 {
    type Type = u32;
    #[inline(always)]
