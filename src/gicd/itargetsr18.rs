#[doc = "Reader of register ITARGETSR18"]
pub type R = crate::R<u32, super::ITARGETSR18>;
#[doc = "Writer for register ITARGETSR18"]
pub type W = crate::W<u32, super::ITARGETSR18>;
#[doc = "Register ITARGETSR18 `reset()`'s with value 0"]
impl crate::ResetValue for super::ITARGETSR18 {
    type Type = u32;
    #[inline(always)]
