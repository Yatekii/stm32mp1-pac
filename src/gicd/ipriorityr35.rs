#[doc = "Reader of register IPRIORITYR35"]
pub type R = crate::R<u32, super::IPRIORITYR35>;
#[doc = "Writer for register IPRIORITYR35"]
pub type W = crate::W<u32, super::IPRIORITYR35>;
#[doc = "Register IPRIORITYR35 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR35 {
    type Type = u32;
    #[inline(always)]
