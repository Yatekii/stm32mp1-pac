#[doc = "Reader of register ITARGETSR29"]
pub type R = crate::R<u32, super::ITARGETSR29>;
#[doc = "Writer for register ITARGETSR29"]
pub type W = crate::W<u32, super::ITARGETSR29>;
#[doc = "Register ITARGETSR29 `reset()`'s with value 0"]
impl crate::ResetValue for super::ITARGETSR29 {
    type Type = u32;
    #[inline(always)]
