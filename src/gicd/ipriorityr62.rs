#[doc = "Reader of register IPRIORITYR62"]
pub type R = crate::R<u32, super::IPRIORITYR62>;
#[doc = "Writer for register IPRIORITYR62"]
pub type W = crate::W<u32, super::IPRIORITYR62>;
#[doc = "Register IPRIORITYR62 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR62 {
    type Type = u32;
    #[inline(always)]
