#[doc = "Reader of register IPRIORITYR25"]
pub type R = crate::R<u32, super::IPRIORITYR25>;
#[doc = "Writer for register IPRIORITYR25"]
pub type W = crate::W<u32, super::IPRIORITYR25>;
#[doc = "Register IPRIORITYR25 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR25 {
    type Type = u32;
    #[inline(always)]
