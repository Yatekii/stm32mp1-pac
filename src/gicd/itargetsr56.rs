#[doc = "Reader of register ITARGETSR56"]
pub type R = crate::R<u32, super::ITARGETSR56>;
#[doc = "Writer for register ITARGETSR56"]
pub type W = crate::W<u32, super::ITARGETSR56>;
#[doc = "Register ITARGETSR56 `reset()`'s with value 0"]
impl crate::ResetValue for super::ITARGETSR56 {
    type Type = u32;
    #[inline(always)]
