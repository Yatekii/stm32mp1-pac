#[doc = "Reader of register IPRIORITYR12"]
pub type R = crate::R<u32, super::IPRIORITYR12>;
#[doc = "Writer for register IPRIORITYR12"]
pub type W = crate::W<u32, super::IPRIORITYR12>;
#[doc = "Register IPRIORITYR12 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR12 {
    type Type = u32;
    #[inline(always)]
