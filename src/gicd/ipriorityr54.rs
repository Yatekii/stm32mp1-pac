#[doc = "Reader of register IPRIORITYR54"]
pub type R = crate::R<u32, super::IPRIORITYR54>;
#[doc = "Writer for register IPRIORITYR54"]
pub type W = crate::W<u32, super::IPRIORITYR54>;
#[doc = "Register IPRIORITYR54 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR54 {
    type Type = u32;
    #[inline(always)]
