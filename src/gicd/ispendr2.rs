#[doc = "Reader of register ISPENDR2"]
pub type R = crate::R<u32, super::ISPENDR2>;
#[doc = "Writer for register ISPENDR2"]
pub type W = crate::W<u32, super::ISPENDR2>;
#[doc = "Register ISPENDR2 `reset()`'s with value 0"]
impl crate::ResetValue for super::ISPENDR2 {
    type Type = u32;
    #[inline(always)]
