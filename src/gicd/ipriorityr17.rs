#[doc = "Reader of register IPRIORITYR17"]
pub type R = crate::R<u32, super::IPRIORITYR17>;
#[doc = "Writer for register IPRIORITYR17"]
pub type W = crate::W<u32, super::IPRIORITYR17>;
#[doc = "Register IPRIORITYR17 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR17 {
    type Type = u32;
    #[inline(always)]
