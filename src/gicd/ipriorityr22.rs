#[doc = "Reader of register IPRIORITYR22"]
pub type R = crate::R<u32, super::IPRIORITYR22>;
#[doc = "Writer for register IPRIORITYR22"]
pub type W = crate::W<u32, super::IPRIORITYR22>;
#[doc = "Register IPRIORITYR22 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR22 {
    type Type = u32;
    #[inline(always)]
