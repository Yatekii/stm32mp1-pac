#[doc = "Reader of register ICACTIVER7"]
pub type R = crate::R<u32, super::ICACTIVER7>;
#[doc = "Writer for register ICACTIVER7"]
pub type W = crate::W<u32, super::ICACTIVER7>;
#[doc = "Register ICACTIVER7 `reset()`'s with value 0"]
impl crate::ResetValue for super::ICACTIVER7 {
    type Type = u32;
    #[inline(always)]
