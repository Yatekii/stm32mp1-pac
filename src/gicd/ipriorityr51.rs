#[doc = "Reader of register IPRIORITYR51"]
pub type R = crate::R<u32, super::IPRIORITYR51>;
#[doc = "Writer for register IPRIORITYR51"]
pub type W = crate::W<u32, super::IPRIORITYR51>;
#[doc = "Register IPRIORITYR51 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR51 {
    type Type = u32;
    #[inline(always)]
