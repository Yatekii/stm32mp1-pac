#[doc = "Reader of register ISPENDR1"]
pub type R = crate::R<u32, super::ISPENDR1>;
#[doc = "Writer for register ISPENDR1"]
pub type W = crate::W<u32, super::ISPENDR1>;
#[doc = "Register ISPENDR1 `reset()`'s with value 0"]
impl crate::ResetValue for super::ISPENDR1 {
    type Type = u32;
    #[inline(always)]
