#[doc = "Reader of register ITARGETSR12"]
pub type R = crate::R<u32, super::ITARGETSR12>;
#[doc = "Writer for register ITARGETSR12"]
pub type W = crate::W<u32, super::ITARGETSR12>;
#[doc = "Register ITARGETSR12 `reset()`'s with value 0"]
impl crate::ResetValue for super::ITARGETSR12 {
    type Type = u32;
    #[inline(always)]
