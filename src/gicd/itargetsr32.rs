#[doc = "Reader of register ITARGETSR32"]
pub type R = crate::R<u32, super::ITARGETSR32>;
#[doc = "Writer for register ITARGETSR32"]
pub type W = crate::W<u32, super::ITARGETSR32>;
#[doc = "Register ITARGETSR32 `reset()`'s with value 0"]
impl crate::ResetValue for super::ITARGETSR32 {
    type Type = u32;
    #[inline(always)]
