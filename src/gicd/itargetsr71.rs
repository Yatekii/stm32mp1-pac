#[doc = "Reader of register ITARGETSR71"]
pub type R = crate::R<u32, super::ITARGETSR71>;
#[doc = "Writer for register ITARGETSR71"]
pub type W = crate::W<u32, super::ITARGETSR71>;
#[doc = "Register ITARGETSR71 `reset()`'s with value 0"]
impl crate::ResetValue for super::ITARGETSR71 {
    type Type = u32;
    #[inline(always)]
