#[doc = "Reader of register IPRIORITYR4"]
pub type R = crate::R<u32, super::IPRIORITYR4>;
#[doc = "Writer for register IPRIORITYR4"]
pub type W = crate::W<u32, super::IPRIORITYR4>;
#[doc = "Register IPRIORITYR4 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR4 {
    type Type = u32;
    #[inline(always)]
