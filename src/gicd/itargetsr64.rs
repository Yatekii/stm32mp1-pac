#[doc = "Reader of register ITARGETSR64"]
pub type R = crate::R<u32, super::ITARGETSR64>;
#[doc = "Writer for register ITARGETSR64"]
pub type W = crate::W<u32, super::ITARGETSR64>;
#[doc = "Register ITARGETSR64 `reset()`'s with value 0"]
impl crate::ResetValue for super::ITARGETSR64 {
    type Type = u32;
    #[inline(always)]
