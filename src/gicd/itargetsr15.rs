#[doc = "Reader of register ITARGETSR15"]
pub type R = crate::R<u32, super::ITARGETSR15>;
#[doc = "Writer for register ITARGETSR15"]
pub type W = crate::W<u32, super::ITARGETSR15>;
#[doc = "Register ITARGETSR15 `reset()`'s with value 0"]
impl crate::ResetValue for super::ITARGETSR15 {
    type Type = u32;
    #[inline(always)]
