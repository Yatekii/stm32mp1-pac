#[doc = "Reader of register IPRIORITYR48"]
pub type R = crate::R<u32, super::IPRIORITYR48>;
#[doc = "Writer for register IPRIORITYR48"]
pub type W = crate::W<u32, super::IPRIORITYR48>;
#[doc = "Register IPRIORITYR48 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR48 {
    type Type = u32;
    #[inline(always)]
