#[doc = "Reader of register ITARGETSR53"]
pub type R = crate::R<u32, super::ITARGETSR53>;
#[doc = "Writer for register ITARGETSR53"]
pub type W = crate::W<u32, super::ITARGETSR53>;
#[doc = "Register ITARGETSR53 `reset()`'s with value 0"]
impl crate::ResetValue for super::ITARGETSR53 {
    type Type = u32;
    #[inline(always)]
