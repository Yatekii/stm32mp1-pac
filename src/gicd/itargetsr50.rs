#[doc = "Reader of register ITARGETSR50"]
pub type R = crate::R<u32, super::ITARGETSR50>;
#[doc = "Writer for register ITARGETSR50"]
pub type W = crate::W<u32, super::ITARGETSR50>;
#[doc = "Register ITARGETSR50 `reset()`'s with value 0"]
impl crate::ResetValue for super::ITARGETSR50 {
    type Type = u32;
    #[inline(always)]
