#[doc = "Reader of register ITARGETSR20"]
pub type R = crate::R<u32, super::ITARGETSR20>;
#[doc = "Writer for register ITARGETSR20"]
pub type W = crate::W<u32, super::ITARGETSR20>;
#[doc = "Register ITARGETSR20 `reset()`'s with value 0"]
impl crate::ResetValue for super::ITARGETSR20 {
    type Type = u32;
    #[inline(always)]
