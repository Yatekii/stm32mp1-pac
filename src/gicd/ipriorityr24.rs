#[doc = "Reader of register IPRIORITYR24"]
pub type R = crate::R<u32, super::IPRIORITYR24>;
#[doc = "Writer for register IPRIORITYR24"]
pub type W = crate::W<u32, super::IPRIORITYR24>;
#[doc = "Register IPRIORITYR24 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR24 {
    type Type = u32;
    #[inline(always)]
