#[doc = "Reader of register ISACTIVER6"]
pub type R = crate::R<u32, super::ISACTIVER6>;
#[doc = "Writer for register ISACTIVER6"]
pub type W = crate::W<u32, super::ISACTIVER6>;
#[doc = "Register ISACTIVER6 `reset()`'s with value 0"]
impl crate::ResetValue for super::ISACTIVER6 {
    type Type = u32;
    #[inline(always)]
