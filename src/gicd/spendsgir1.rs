#[doc = "Reader of register SPENDSGIR1"]
pub type R = crate::R<u32, super::SPENDSGIR1>;
#[doc = "Writer for register SPENDSGIR1"]
pub type W = crate::W<u32, super::SPENDSGIR1>;
#[doc = "Register SPENDSGIR1 `reset()`'s with value 0"]
impl crate::ResetValue for super::SPENDSGIR1 {
    type Type = u32;
    #[inline(always)]
