#[doc = "Reader of register IPRIORITYR45"]
pub type R = crate::R<u32, super::IPRIORITYR45>;
#[doc = "Writer for register IPRIORITYR45"]
pub type W = crate::W<u32, super::IPRIORITYR45>;
#[doc = "Register IPRIORITYR45 `reset()`'s with value 0"]
impl crate::ResetValue for super::IPRIORITYR45 {
    type Type = u32;
    #[inline(always)]
