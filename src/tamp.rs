...
pub struct RegisterBlock {
    #[doc = "0x00 - This register can be protected against non-secure access. Refer to Section24.3.3: TAMP secure protection modes."]
    pub tamp_cr1: TAMP_CR1,
    #[doc = "0x04 - This register can be protected against non-secure access. Refer to Section24.3.3: TAMP secure protection modes."]
    pub tamp_cr2: TAMP_CR2,
    _reserved2: [u8; 4usize],
    #[doc = "0x0c - This register can be protected against non-secure access. Refer to Section24.3.3: TAMP secure protection modes."]
    pub tamp_fltcr: TAMP_FLTCR,
    #[doc = "0x10 - This register can be protected against non-secure access. Refer to Section24.3.3: TAMP secure protection modes."]
    pub tamp_atcr1: TAMP_ATCR1,
    #[doc = "0x14 - This register can be protected against non-secure access. Refer to Section24.3.3: TAMP secure protection modes."]
    pub tamp_atseedr: TAMP_ATSEEDR,
    #[doc = "0x18 - This register can be protected against non-secure access. Refer to Section24.3.3: TAMP secure protection modes."]
    ...
    #[doc = "0x2c - This register can be protected against non-secure access. Refer to Section24.3.3: TAMP secure protection modes."]
    pub tamp_ier: TAMP_IER,
    #[doc = "0x30 - This register can be protected against non-secure access. Refer to Section24.3.3: TAMP secure protection modes."]
    pub tamp_sr: TAMP_SR,
...
#[doc = "`read()` method returns [tamp_scr::R](tamp_scr::R) reader structure"]
impl crate::Readable for TAMP_SCR {}
