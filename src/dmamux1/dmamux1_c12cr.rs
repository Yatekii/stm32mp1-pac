#[doc = "Reader of register DMAMUX1_C12CR"]
pub type R = crate::R<u32, super::DMAMUX1_C12CR>;
#[doc = "Writer for register DMAMUX1_C12CR"]
pub type W = crate::W<u32, super::DMAMUX1_C12CR>;
#[doc = "Register DMAMUX1_C12CR `reset()`'s with value 0"]
impl crate::ResetValue for super::DMAMUX1_C12CR {
    type Type = u32;
    #[inline(always)]
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum SE_A {
    #[doc = "0: synchronization\r\n                  disabled"]
    B_0X0 = 0,
    #[doc = "1: synchronization\r\n                  enabled"]
    B_0X1 = 1,
}
...
#[repr(u8)]
pub enum SPOL_A {
    #[doc = "0: no event. I.e. None synchronization\r\n                  nor detection."]
    B_0X0 = 0,
    #[doc = "1: rising edge"]
    B_0X1 = 1,
    #[doc = "2: falling edge"]
...
impl<'a> SPOL_W<'a> {
    ...
    #[doc = "no event. I.e. None synchronization nor detection."]
    #[inline(always)]
    pub fn b_0x0(self) -> &'a mut W {
