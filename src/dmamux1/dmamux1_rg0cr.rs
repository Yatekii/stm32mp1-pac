#[doc = "Reader of register DMAMUX1_RG0CR"]
pub type R = crate::R<u32, super::DMAMUX1_RG0CR>;
#[doc = "Writer for register DMAMUX1_RG0CR"]
pub type W = crate::W<u32, super::DMAMUX1_RG0CR>;
#[doc = "Register DMAMUX1_RG0CR `reset()`'s with value 0"]
impl crate::ResetValue for super::DMAMUX1_RG0CR {
    type Type = u32;
    #[inline(always)]
...
pub enum OIE_A {
    #[doc = "0: interrupt on a trigger overrun event\r\n                  occurrence is disabled"]
    B_0X0 = 0,
    #[doc = "1: interrupt on a trigger overrun event\r\n                  occurrence is enabled"]
    B_0X1 = 1,
}
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum GE_A {
    #[doc = "0: DMA request generator channel x\r\n                  disabled"]
    B_0X0 = 0,
    #[doc = "1: DMA request generator channel x\r\n                  enabled"]
    B_0X1 = 1,
}
...
#[repr(u8)]
pub enum GPOL_A {
    #[doc = "0: no event. I.e. none trigger\r\n                  detection nor generation."]
    B_0X0 = 0,
    #[doc = "1: rising edge"]
    B_0X1 = 1,
    #[doc = "2: falling edge"]
    B_0X2 = 2,
    #[doc = "3: rising and falling\r\n                  edge"]
    B_0X3 = 3,
}
