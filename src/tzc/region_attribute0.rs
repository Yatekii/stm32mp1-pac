#[doc = "Reader of register REGION_ATTRIBUTE0"]
pub type R = crate::R<u32, super::REGION_ATTRIBUTE0>;
#[doc = "Writer for register REGION_ATTRIBUTE0"]
pub type W = crate::W<u32, super::REGION_ATTRIBUTE0>;
#[doc = "Register REGION_ATTRIBUTE0 `reset()`'s with value 0x03"]
impl crate::ResetValue for super::REGION_ATTRIBUTE0 {
    type Type = u32;
    #[inline(always)]
