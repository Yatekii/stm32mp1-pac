#[doc = "Reader of register REGION_TOP_LOW4"]
pub type R = crate::R<u32, super::REGION_TOP_LOW4>;
#[doc = "Writer for register REGION_TOP_LOW4"]
pub type W = crate::W<u32, super::REGION_TOP_LOW4>;
#[doc = "Register REGION_TOP_LOW4 `reset()`'s with value 0"]
impl crate::ResetValue for super::REGION_TOP_LOW4 {
    type Type = u32;
    #[inline(always)]
