#[doc = "Reader of register REGION_ID_ACCESS6"]
pub type R = crate::R<u32, super::REGION_ID_ACCESS6>;
#[doc = "Writer for register REGION_ID_ACCESS6"]
pub type W = crate::W<u32, super::REGION_ID_ACCESS6>;
#[doc = "Register REGION_ID_ACCESS6 `reset()`'s with value 0"]
impl crate::ResetValue for super::REGION_ID_ACCESS6 {
    type Type = u32;
    #[inline(always)]
