#[doc = "Reader of register REGION_ID_ACCESS4"]
pub type R = crate::R<u32, super::REGION_ID_ACCESS4>;
#[doc = "Writer for register REGION_ID_ACCESS4"]
pub type W = crate::W<u32, super::REGION_ID_ACCESS4>;
#[doc = "Register REGION_ID_ACCESS4 `reset()`'s with value 0"]
impl crate::ResetValue for super::REGION_ID_ACCESS4 {
    type Type = u32;
    #[inline(always)]
