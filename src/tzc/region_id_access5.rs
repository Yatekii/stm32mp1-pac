#[doc = "Reader of register REGION_ID_ACCESS5"]
pub type R = crate::R<u32, super::REGION_ID_ACCESS5>;
#[doc = "Writer for register REGION_ID_ACCESS5"]
pub type W = crate::W<u32, super::REGION_ID_ACCESS5>;
#[doc = "Register REGION_ID_ACCESS5 `reset()`'s with value 0"]
impl crate::ResetValue for super::REGION_ID_ACCESS5 {
    type Type = u32;
    #[inline(always)]
