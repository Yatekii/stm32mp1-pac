#[doc = "Reader of register REGION_BASE_LOW2"]
pub type R = crate::R<u32, super::REGION_BASE_LOW2>;
#[doc = "Writer for register REGION_BASE_LOW2"]
pub type W = crate::W<u32, super::REGION_BASE_LOW2>;
#[doc = "Register REGION_BASE_LOW2 `reset()`'s with value 0"]
impl crate::ResetValue for super::REGION_BASE_LOW2 {
    type Type = u32;
    #[inline(always)]
