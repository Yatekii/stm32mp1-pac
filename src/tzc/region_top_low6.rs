#[doc = "Reader of register REGION_TOP_LOW6"]
pub type R = crate::R<u32, super::REGION_TOP_LOW6>;
#[doc = "Writer for register REGION_TOP_LOW6"]
pub type W = crate::W<u32, super::REGION_TOP_LOW6>;
#[doc = "Register REGION_TOP_LOW6 `reset()`'s with value 0"]
impl crate::ResetValue for super::REGION_TOP_LOW6 {
    type Type = u32;
    #[inline(always)]
