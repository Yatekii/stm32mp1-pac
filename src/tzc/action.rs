#[doc = "Reader of register ACTION"]
pub type R = crate::R<u32, super::ACTION>;
#[doc = "Writer for register ACTION"]
pub type W = crate::W<u32, super::ACTION>;
#[doc = "Register ACTION `reset()`'s with value 0"]
impl crate::ResetValue for super::ACTION {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bits 0:1 - Permission failure reaction"]
    #[inline(always)]
