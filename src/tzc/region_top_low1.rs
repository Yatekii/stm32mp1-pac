#[doc = "Reader of register REGION_TOP_LOW1"]
pub type R = crate::R<u32, super::REGION_TOP_LOW1>;
#[doc = "Writer for register REGION_TOP_LOW1"]
pub type W = crate::W<u32, super::REGION_TOP_LOW1>;
#[doc = "Register REGION_TOP_LOW1 `reset()`'s with value 0"]
impl crate::ResetValue for super::REGION_TOP_LOW1 {
    type Type = u32;
    #[inline(always)]
