#[doc = "Reader of register REGION_TOP_LOW5"]
pub type R = crate::R<u32, super::REGION_TOP_LOW5>;
#[doc = "Writer for register REGION_TOP_LOW5"]
pub type W = crate::W<u32, super::REGION_TOP_LOW5>;
#[doc = "Register REGION_TOP_LOW5 `reset()`'s with value 0"]
impl crate::ResetValue for super::REGION_TOP_LOW5 {
    type Type = u32;
    #[inline(always)]
