#[doc = "Reader of register REGION_ATTRIBUTE4"]
pub type R = crate::R<u32, super::REGION_ATTRIBUTE4>;
#[doc = "Writer for register REGION_ATTRIBUTE4"]
pub type W = crate::W<u32, super::REGION_ATTRIBUTE4>;
#[doc = "Register REGION_ATTRIBUTE4 `reset()`'s with value 0"]
impl crate::ResetValue for super::REGION_ATTRIBUTE4 {
    type Type = u32;
    #[inline(always)]
