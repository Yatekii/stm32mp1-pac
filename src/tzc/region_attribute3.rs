#[doc = "Reader of register REGION_ATTRIBUTE3"]
pub type R = crate::R<u32, super::REGION_ATTRIBUTE3>;
#[doc = "Writer for register REGION_ATTRIBUTE3"]
pub type W = crate::W<u32, super::REGION_ATTRIBUTE3>;
#[doc = "Register REGION_ATTRIBUTE3 `reset()`'s with value 0"]
impl crate::ResetValue for super::REGION_ATTRIBUTE3 {
    type Type = u32;
    #[inline(always)]
