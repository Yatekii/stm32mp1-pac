#[doc = "Reader of register REGION_ATTRIBUTE7"]
pub type R = crate::R<u32, super::REGION_ATTRIBUTE7>;
#[doc = "Writer for register REGION_ATTRIBUTE7"]
pub type W = crate::W<u32, super::REGION_ATTRIBUTE7>;
#[doc = "Register REGION_ATTRIBUTE7 `reset()`'s with value 0"]
impl crate::ResetValue for super::REGION_ATTRIBUTE7 {
    type Type = u32;
    #[inline(always)]
