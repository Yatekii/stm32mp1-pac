#[doc = "Reader of register REGION_ATTRIBUTE5"]
pub type R = crate::R<u32, super::REGION_ATTRIBUTE5>;
#[doc = "Writer for register REGION_ATTRIBUTE5"]
pub type W = crate::W<u32, super::REGION_ATTRIBUTE5>;
#[doc = "Register REGION_ATTRIBUTE5 `reset()`'s with value 0"]
impl crate::ResetValue for super::REGION_ATTRIBUTE5 {
    type Type = u32;
    #[inline(always)]
