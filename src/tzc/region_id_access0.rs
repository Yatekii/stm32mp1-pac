#[doc = "Reader of register REGION_ID_ACCESS0"]
pub type R = crate::R<u32, super::REGION_ID_ACCESS0>;
#[doc = "Writer for register REGION_ID_ACCESS0"]
pub type W = crate::W<u32, super::REGION_ID_ACCESS0>;
#[doc = "Register REGION_ID_ACCESS0 `reset()`'s with value 0"]
impl crate::ResetValue for super::REGION_ID_ACCESS0 {
    type Type = u32;
    #[inline(always)]
