...
pub struct RegisterBlock {
    ...
    pub cdr: CDR,
    #[doc = "0x10 - ADC common regular data register for dual and triple modes"]
    pub cdr2: CDR2,
}
...
#[doc = "ADC common regular data register for dual and triple modes"]
pub mod cdr;
#[doc = "ADC common regular data register for dual and triple modes\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cdr2](cdr2) module"]
pub type CDR2 = crate::Reg<u32, _CDR2>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _CDR2;
#[doc = "`read()` method returns [cdr2::R](cdr2::R) reader structure"]
impl crate::Readable for CDR2 {}
#[doc = "ADC common regular data register for dual and triple modes"]
pub mod cdr2;
