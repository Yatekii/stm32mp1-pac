#[doc = "Reader of register RCC_MC_MLAHBENCLRR"]
pub type R = crate::R<u32, super::RCC_MC_MLAHBENCLRR>;
#[doc = "Writer for register RCC_MC_MLAHBENCLRR"]
pub type W = crate::W<u32, super::RCC_MC_MLAHBENCLRR>;
#[doc = "Register RCC_MC_MLAHBENCLRR `reset()`'s with value 0x10"]
impl crate::ResetValue for super::RCC_MC_MLAHBENCLRR {
    type Type = u32;
    #[inline(always)]
