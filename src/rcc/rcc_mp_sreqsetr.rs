#[doc = "Reader of register RCC_MP_SREQSETR"]
pub type R = crate::R<u32, super::RCC_MP_SREQSETR>;
#[doc = "Writer for register RCC_MP_SREQSETR"]
pub type W = crate::W<u32, super::RCC_MP_SREQSETR>;
#[doc = "Register RCC_MP_SREQSETR `reset()`'s with value 0"]
impl crate::ResetValue for super::RCC_MP_SREQSETR {
    type Type = u32;
    #[inline(always)]
...
impl<'a> STPREQ_P1_W<'a> {
    ...
    #[doc = "Writing sets the STPREQ_P1 bit, reading means that the MPU processor number 1 allows the MPU domain to go to CSTOP"]
    #[inline(always)]
    pub fn b_0x1(self) -> &'a mut W {
