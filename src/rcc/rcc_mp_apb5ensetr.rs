#[doc = "Reader of register RCC_MP_APB5ENSETR"]
pub type R = crate::R<u32, super::RCC_MP_APB5ENSETR>;
#[doc = "Writer for register RCC_MP_APB5ENSETR"]
pub type W = crate::W<u32, super::RCC_MP_APB5ENSETR>;
#[doc = "Register RCC_MP_APB5ENSETR `reset()`'s with value 0"]
impl crate::ResetValue for super::RCC_MP_APB5ENSETR {
    type Type = u32;
    #[inline(always)]
...
pub enum TZC1EN_A {
    ...
    B_0X0 = 0,
    #[doc = "1: Writing enables the pclk5 and\r\n                  aclk_tzc1 clocks, reading means that the clocks\r\n                  are enabled for AXI port 1"]
    B_0X1 = 1,
}
...
impl<'a> TZC1EN_W<'a> {
    ...
    #[doc = "Writing enables the pclk5 and aclk_tzc1 clocks, reading means that the clocks are enabled for AXI port 1"]
    #[inline(always)]
    pub fn b_0x1(self) -> &'a mut W {
...
pub enum TZC2EN_A {
    #[doc = "0: Writing has no effect, reading means\r\n                  that the clocks are disabled for AXI port\r\n                  2"]
    B_0X0 = 0,
    #[doc = "1: Writing enables the pclk5 and\r\n                  aclk_tzc2 clocks, reading means that the clocks\r\n                  are enabled for AXI port 2"]
    B_0X1 = 1,
}
...
impl<'a> TZC2EN_W<'a> {
    ...
    #[doc = "Writing enables the pclk5 and aclk_tzc2 clocks, reading means that the clocks are enabled for AXI port 2"]
    #[inline(always)]
    pub fn b_0x1(self) -> &'a mut W {
