#[doc = "Reader of register RCC_MP_AXIMLPENCLRR"]
pub type R = crate::R<u32, super::RCC_MP_AXIMLPENCLRR>;
#[doc = "Writer for register RCC_MP_AXIMLPENCLRR"]
pub type W = crate::W<u32, super::RCC_MP_AXIMLPENCLRR>;
#[doc = "Register RCC_MP_AXIMLPENCLRR `reset()`'s with value 0x01"]
impl crate::ResetValue for super::RCC_MP_AXIMLPENCLRR {
    type Type = u32;
    #[inline(always)]
