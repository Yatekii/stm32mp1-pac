#[doc = "Reader of register RCC_MP_MLAHBENSETR"]
pub type R = crate::R<u32, super::RCC_MP_MLAHBENSETR>;
#[doc = "Writer for register RCC_MP_MLAHBENSETR"]
pub type W = crate::W<u32, super::RCC_MP_MLAHBENSETR>;
#[doc = "Register RCC_MP_MLAHBENSETR `reset()`'s with value 0x10"]
impl crate::ResetValue for super::RCC_MP_MLAHBENSETR {
    type Type = u32;
    #[inline(always)]
...
pub enum RETRAMEN_A {
    ...
    B_0X0 = 0,
    #[doc = "1: Writing allocates the memory to the\r\n                  MPU, reading means that the memory is allocated\r\n                  to the MPU."]
    B_0X1 = 1,
}
...
impl<'a> RETRAMEN_W<'a> {
    ...
    #[doc = "Writing allocates the memory to the MPU, reading means that the memory is allocated to the MPU."]
    #[inline(always)]
