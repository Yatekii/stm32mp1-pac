#[doc = "Reader of register RCC_MP_AXIMLPENSETR"]
pub type R = crate::R<u32, super::RCC_MP_AXIMLPENSETR>;
#[doc = "Writer for register RCC_MP_AXIMLPENSETR"]
pub type W = crate::W<u32, super::RCC_MP_AXIMLPENSETR>;
#[doc = "Register RCC_MP_AXIMLPENSETR `reset()`'s with value 0x01"]
impl crate::ResetValue for super::RCC_MP_AXIMLPENSETR {
    type Type = u32;
    #[inline(always)]
...
impl<'a> SYSRAMLPEN_W<'a> {
    ...
    #[doc = "Writing enables the memory interface clock in CSLEEP, reading means that the memory interface clock is enabled in CSLEEP"]
    #[inline(always)]
