#[doc = "Reader of register RCC_PLL3CR"]
pub type R = crate::R<u32, super::RCC_PLL3CR>;
#[doc = "Writer for register RCC_PLL3CR"]
pub type W = crate::W<u32, super::RCC_PLL3CR>;
#[doc = "Register RCC_PLL3CR `reset()`'s with value 0"]
impl crate::ResetValue for super::RCC_PLL3CR {
    type Type = u32;
    #[inline(always)]
...
pub enum PLLON_A {
    #[doc = "0: PLL3 OFF (default after\r\n                  reset)"]
    B_0X0 = 0,
    #[doc = "1: PLL3 ON, and ref3_ck is provided to\r\n                  the PLL3"]
    B_0X1 = 1,
}
...
impl<'a> PLLON_W<'a> {
    ...
    #[doc = "PLL3 OFF (default after reset)"]
    #[inline(always)]
    pub fn b_0x0(self) -> &'a mut W {
        self.variant(PLLON_A::B_0X0)
    }
    #[doc = "PLL3 ON, and ref3_ck is provided to the PLL3"]
    #[inline(always)]
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum PLL3RDY_A {
    #[doc = "0: PLL3 unlocked (default after\r\n                  reset)"]
    B_0X0 = 0,
    #[doc = "1: PLL3 locked"]
    B_0X1 = 1,
}
impl From<PLL3RDY_A> for bool {
    #[inline(always)]
    fn from(variant: PLL3RDY_A) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Reader of field `PLL3RDY`"]
pub type PLL3RDY_R = crate::R<bool, PLL3RDY_A>;
impl PLL3RDY_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> PLL3RDY_A {
        match self.bits {
            false => PLL3RDY_A::B_0X0,
            true => PLL3RDY_A::B_0X1,
        }
    }
    #[doc = "Checks if the value of the field is `B_0X0`"]
    #[inline(always)]
    pub fn is_b_0x0(&self) -> bool {
        *self == PLL3RDY_A::B_0X0
    }
    #[doc = "Checks if the value of the field is `B_0X1`"]
    #[inline(always)]
    pub fn is_b_0x1(&self) -> bool {
        *self == PLL3RDY_A::B_0X1
    }
}
#[doc = "SSCG_CTRL\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum DIVPEN_A {
    #[doc = "0: pll3_p_ck output is disabled\r\n                  (default after reset)"]
    B_0X0 = 0,
    #[doc = "1: pll3_p_ck output is\r\n                  enabled"]
    B_0X1 = 1,
}
...
impl<'a> DIVPEN_W<'a> {
    ...
    #[doc = "pll3_p_ck output is disabled (default after reset)"]
    #[inline(always)]
    pub fn b_0x0(self) -> &'a mut W {
        self.variant(DIVPEN_A::B_0X0)
    }
    #[doc = "pll3_p_ck output is enabled"]
    #[inline(always)]
    pub fn b_0x1(self) -> &'a mut W {
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum DIVQEN_A {
    #[doc = "0: pll3_q_ck output is disabled\r\n                  (default after reset)"]
    B_0X0 = 0,
    #[doc = "1: pll3_q_ck output is\r\n                  enabled"]
    B_0X1 = 1,
}
...
impl<'a> DIVQEN_W<'a> {
    ...
    #[doc = "pll3_q_ck output is disabled (default after reset)"]
    #[inline(always)]
    pub fn b_0x0(self) -> &'a mut W {
        self.variant(DIVQEN_A::B_0X0)
    }
    #[doc = "pll3_q_ck output is enabled"]
    #[inline(always)]
    pub fn b_0x1(self) -> &'a mut W {
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum DIVREN_A {
    #[doc = "0: pll3_r_ck output is disabled\r\n                  (default after reset)"]
    B_0X0 = 0,
    #[doc = "1: pll3_r_ck output is\r\n                  enabled"]
    B_0X1 = 1,
}
...
impl<'a> DIVREN_W<'a> {
    ...
    #[doc = "pll3_r_ck output is disabled (default after reset)"]
    #[inline(always)]
    pub fn b_0x0(self) -> &'a mut W {
        self.variant(DIVREN_A::B_0X0)
    }
    #[doc = "pll3_r_ck output is enabled"]
    #[inline(always)]
    pub fn b_0x1(self) -> &'a mut W {
...
impl R {
    ...
    pub fn pll3rdy(&self) -> PLL3RDY_R {
        PLL3RDY_R::new(((self.bits >> 1) & 0x01) != 0)
    }
    #[doc = "Bit 2 - SSCG_CTRL"]
    #[inline(always)]
