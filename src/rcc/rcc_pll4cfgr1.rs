...
impl From<DIVM4_A> for u8 {
    #[inline(always)]
    fn from(variant: DIVM4_A) -> Self {
        variant as _
    }
}
#[doc = "Reader of field `DIVM4`"]
pub type DIVM4_R = crate::R<u8, DIVM4_A>;
impl DIVM4_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> crate::Variant<u8, DIVM4_A> {
        use crate::Variant::*;
        match self.bits {
            0 => Val(DIVM4_A::B_0X0),
            1 => Val(DIVM4_A::B_0X1),
            2 => Val(DIVM4_A::B_0X2),
            63 => Val(DIVM4_A::B_0X3F),
            i => Res(i),
        }
    }
...
impl<'a> DIVM4_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: DIVM4_A) -> &'a mut W {
        unsafe { self.bits(variant.into()) }
    }
    #[doc = "bypass"]
    #[inline(always)]
    pub fn b_0x0(self) -> &'a mut W {
        self.variant(DIVM4_A::B_0X0)
    }
    #[doc = "division by 2 (default after reset)"]
    #[inline(always)]
    pub fn b_0x1(self) -> &'a mut W {
        self.variant(DIVM4_A::B_0X1)
    }
    #[doc = "division by 3"]
    #[inline(always)]
    pub fn b_0x2(self) -> &'a mut W {
        self.variant(DIVM4_A::B_0X2)
    }
    #[doc = "division by 64"]
    #[inline(always)]
    pub fn b_0x3f(self) -> &'a mut W {
        self.variant(DIVM4_A::B_0X3F)
    }
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
