#[doc = "Reader of register RCC_MP_APB5LPENSETR"]
pub type R = crate::R<u32, super::RCC_MP_APB5LPENSETR>;
#[doc = "Writer for register RCC_MP_APB5LPENSETR"]
pub type W = crate::W<u32, super::RCC_MP_APB5LPENSETR>;
#[doc = "Register RCC_MP_APB5LPENSETR `reset()`'s with value 0x0011_391d"]
impl crate::ResetValue for super::RCC_MP_APB5LPENSETR {
    type Type = u32;
    #[inline(always)]
...
pub enum TZC1LPEN_A {
    ...
    B_0X0 = 0,
    #[doc = "1: Writing enables the pclk5 and\r\n                  aclk_tzc1 clocks in CSLEEP, reading means that\r\n                  the clocks are enabled for AXI port 1 in\r\n                  CSLEEP"]
    B_0X1 = 1,
}
...
impl<'a> TZC1LPEN_W<'a> {
    ...
    #[doc = "Writing enables the pclk5 and aclk_tzc1 clocks in CSLEEP, reading means that the clocks are enabled for AXI port 1 in CSLEEP"]
    #[inline(always)]
    pub fn b_0x1(self) -> &'a mut W {
...
pub enum TZC2LPEN_A {
    ...
    B_0X0 = 0,
    #[doc = "1: Writing enables the pclk5 and\r\n                  aclk_tzc2 clocks in CSLEEP, reading means that\r\n                  the clocks are enabled for AXI port 2 in\r\n                  CSLEEP"]
    B_0X1 = 1,
}
...
impl<'a> TZC2LPEN_W<'a> {
    ...
    #[doc = "Writing enables the pclk5 and aclk_tzc2 clocks in CSLEEP, reading means that the clocks are enabled for AXI port 2 in CSLEEP"]
    #[inline(always)]
    pub fn b_0x1(self) -> &'a mut W {
