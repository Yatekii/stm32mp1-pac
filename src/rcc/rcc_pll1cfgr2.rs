#[doc = "Reader of register RCC_PLL1CFGR2"]
pub type R = crate::R<u32, super::RCC_PLL1CFGR2>;
#[doc = "Writer for register RCC_PLL1CFGR2"]
pub type W = crate::W<u32, super::RCC_PLL1CFGR2>;
#[doc = "Register RCC_PLL1CFGR2 `reset()`'s with value 0x0001_0100"]
impl crate::ResetValue for super::RCC_PLL1CFGR2 {
    type Type = u32;
    #[inline(always)]
...
#[repr(u8)]
pub enum DIVP_A {
    #[doc = "0: pll1_p_ck = fout1_ck (default after\r\n                  reset)"]
    B_0X0 = 0,
    #[doc = "1: pll1_p_ck = fout1_ck /\r\n                  2"]
    B_0X1 = 1,
    #[doc = "2: pll1_p_ck = fout1_ck /\r\n                  3"]
    B_0X2 = 2,
    #[doc = "127: pll1_p_ck = fout1_ck /\r\n                  128"]
    B_0X7F = 127,
}
...
impl<'a> DIVP_W<'a> {
    ...
    #[doc = "pll1_p_ck = fout1_ck (default after reset)"]
    #[inline(always)]
    pub fn b_0x0(self) -> &'a mut W {
        self.variant(DIVP_A::B_0X0)
    }
    #[doc = "pll1_p_ck = fout1_ck / 2"]
    #[inline(always)]
    pub fn b_0x1(self) -> &'a mut W {
        self.variant(DIVP_A::B_0X1)
    }
    #[doc = "pll1_p_ck = fout1_ck / 3"]
    #[inline(always)]
    pub fn b_0x2(self) -> &'a mut W {
        self.variant(DIVP_A::B_0X2)
    }
    #[doc = "pll1_p_ck = fout1_ck / 128"]
    #[inline(always)]
...
#[repr(u8)]
pub enum DIVQ_A {
    #[doc = "0: pll1_q_ck = fout1_ck"]
    B_0X0 = 0,
    #[doc = "1: pll1_q_ck = fout1_ck / 2 (default\r\n                  after reset)"]
    B_0X1 = 1,
    #[doc = "2: pll1_q_ck = fout1_ck /\r\n                  3"]
    B_0X2 = 2,
    #[doc = "127: pll1_q_ck = fout1_ck /\r\n                  128"]
    B_0X7F = 127,
}
...
impl<'a> DIVQ_W<'a> {
    ...
    #[doc = "pll1_q_ck = fout1_ck"]
    #[inline(always)]
    pub fn b_0x0(self) -> &'a mut W {
        self.variant(DIVQ_A::B_0X0)
    }
    #[doc = "pll1_q_ck = fout1_ck / 2 (default after reset)"]
    #[inline(always)]
    pub fn b_0x1(self) -> &'a mut W {
        self.variant(DIVQ_A::B_0X1)
    }
    #[doc = "pll1_q_ck = fout1_ck / 3"]
    #[inline(always)]
    pub fn b_0x2(self) -> &'a mut W {
        self.variant(DIVQ_A::B_0X2)
    }
    #[doc = "pll1_q_ck = fout1_ck / 128"]
    #[inline(always)]
    pub fn b_0x7f(self) -> &'a mut W {
...
#[repr(u8)]
pub enum DIVR_A {
    #[doc = "0: pll1_r_ck = fout1_ck"]
    B_0X0 = 0,
    #[doc = "1: pll1_r_ck = fout1_ck / 2 (default\r\n                  after reset)"]
    B_0X1 = 1,
    #[doc = "2: pll1_r_ck = fout1_ck /\r\n                  3"]
    B_0X2 = 2,
    #[doc = "127: pll1_r_ck = fout1_ck /\r\n                  128"]
    B_0X7F = 127,
}
...
impl<'a> DIVR_W<'a> {
    ...
    #[doc = "pll1_r_ck = fout1_ck"]
    #[inline(always)]
    pub fn b_0x0(self) -> &'a mut W {
        self.variant(DIVR_A::B_0X0)
    }
    #[doc = "pll1_r_ck = fout1_ck / 2 (default after reset)"]
    #[inline(always)]
    pub fn b_0x1(self) -> &'a mut W {
        self.variant(DIVR_A::B_0X1)
    }
    #[doc = "pll1_r_ck = fout1_ck / 3"]
    #[inline(always)]
    pub fn b_0x2(self) -> &'a mut W {
        self.variant(DIVR_A::B_0X2)
    }
    #[doc = "pll1_r_ck = fout1_ck / 128"]
    #[inline(always)]
    pub fn b_0x7f(self) -> &'a mut W {
