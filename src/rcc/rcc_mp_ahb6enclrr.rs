#[doc = "Reader of register RCC_MP_AHB6ENCLRR"]
pub type R = crate::R<u32, super::RCC_MP_AHB6ENCLRR>;
#[doc = "Writer for register RCC_MP_AHB6ENCLRR"]
pub type W = crate::W<u32, super::RCC_MP_AHB6ENCLRR>;
#[doc = "Register RCC_MP_AHB6ENCLRR `reset()`'s with value 0"]
impl crate::ResetValue for super::RCC_MP_AHB6ENCLRR {
    type Type = u32;
    #[inline(always)]
...
impl<'a> ETHCKEN_W<'a> {
    ...
    #[doc = "Writing disables the eth_ker_ck clock, reading means that the eth_ker_ck clock is enabled"]
    #[inline(always)]
    pub fn b_0x1(self) -> &'a mut W {
...
impl<'a> ETHTXEN_W<'a> {
    ...
    #[doc = "Writing disables the transmission clock, reading means that the transmission clock is enabled"]
    #[inline(always)]
    pub fn b_0x1(self) -> &'a mut W {
...
pub enum ETHRXEN_A {
    ...
    B_0X0 = 0,
    #[doc = "1: Writing disables the reception\r\n                  clock, reading means that the reception clock is\r\n                  enabled"]
    B_0X1 = 1,
}
...
impl<'a> ETHRXEN_W<'a> {
    ...
    #[doc = "Writing disables the reception clock, reading means that the reception clock is enabled"]
    #[inline(always)]
    pub fn b_0x1(self) -> &'a mut W {
...
impl<'a> ETHMACEN_W<'a> {
    ...
    #[doc = "Writing disables the bus interface clock, reading means that the bus interface clock is enabled"]
    #[inline(always)]
    pub fn b_0x1(self) -> &'a mut W {
