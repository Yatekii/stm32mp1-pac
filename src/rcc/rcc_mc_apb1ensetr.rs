#[doc = "Reader of register RCC_MC_APB1ENSETR"]
pub type R = crate::R<u32, super::RCC_MC_APB1ENSETR>;
#[doc = "Writer for register RCC_MC_APB1ENSETR"]
pub type W = crate::W<u32, super::RCC_MC_APB1ENSETR>;
#[doc = "Register RCC_MC_APB1ENSETR `reset()`'s with value 0"]
impl crate::ResetValue for super::RCC_MC_APB1ENSETR {
    type Type = u32;
    #[inline(always)]
...
impl From<WWDG1EN_A> for bool {
    #[inline(always)]
    fn from(variant: WWDG1EN_A) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Reader of field `WWDG1EN`"]
pub type WWDG1EN_R = crate::R<bool, WWDG1EN_A>;
impl WWDG1EN_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> WWDG1EN_A {
        match self.bits {
            false => WWDG1EN_A::B_0X0,
            true => WWDG1EN_A::B_0X1,
        }
    }
    #[doc = "Checks if the value of the field is `B_0X0`"]
    #[inline(always)]
    pub fn is_b_0x0(&self) -> bool {
        *self == WWDG1EN_A::B_0X0
    }
    #[doc = "Checks if the value of the field is `B_0X1`"]
    #[inline(always)]
    pub fn is_b_0x1(&self) -> bool {
        *self == WWDG1EN_A::B_0X1
    }
}
...
impl<'a> WWDG1EN_W<'a> {
    ...
    #[inline(always)]
    pub fn b_0x0(self) -> &'a mut W {
        self.variant(WWDG1EN_A::B_0X0)
    }
    #[doc = "Writing enables the peripheral clocks, reading means that the peripheral clocks are enabled"]
    #[inline(always)]
    pub fn b_0x1(self) -> &'a mut W {
        self.variant(WWDG1EN_A::B_0X1)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
impl R {
    ...
    pub fn wwdg1en(&self) -> WWDG1EN_R {
        WWDG1EN_R::new(((self.bits >> 28) & 0x01) != 0)
    }
    #[doc = "Bit 29 - DAC12EN"]
    #[inline(always)]
