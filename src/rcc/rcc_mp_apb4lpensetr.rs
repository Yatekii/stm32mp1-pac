#[doc = "Reader of register RCC_MP_APB4LPENSETR"]
pub type R = crate::R<u32, super::RCC_MP_APB4LPENSETR>;
#[doc = "Writer for register RCC_MP_APB4LPENSETR"]
pub type W = crate::W<u32, super::RCC_MP_APB4LPENSETR>;
#[doc = "Register RCC_MP_APB4LPENSETR `reset()`'s with value 0x0011_8111"]
impl crate::ResetValue for super::RCC_MP_APB4LPENSETR {
    type Type = u32;
    #[inline(always)]
...
impl<'a> DDRPERFMLPEN_W<'a> {
    ...
    #[doc = "Writing enables the APB clock in CSLEEP, reading means that the APB clock is enabled in CSLEEP"]
    #[inline(always)]
    pub fn b_0x1(self) -> &'a mut W {
...
#[doc = "IWDG2APBLPEN\n\nValue on reset: 1"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum IWDG2APBLPEN_A {
    #[doc = "0: Writing has no effect, reading means\r\n                  that the APB clock is disabled in\r\n                  CSLEEP"]
    B_0X0 = 0,
    #[doc = "1: Writing enables the APB clock in\r\n                  CSLEEP, reading means that the APB clock is\r\n                  enabled in CSLEEP"]
    B_0X1 = 1,
}
impl From<IWDG2APBLPEN_A> for bool {
    #[inline(always)]
    fn from(variant: IWDG2APBLPEN_A) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Reader of field `IWDG2APBLPEN`"]
pub type IWDG2APBLPEN_R = crate::R<bool, IWDG2APBLPEN_A>;
impl IWDG2APBLPEN_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> IWDG2APBLPEN_A {
        match self.bits {
            false => IWDG2APBLPEN_A::B_0X0,
            true => IWDG2APBLPEN_A::B_0X1,
        }
    }
    #[doc = "Checks if the value of the field is `B_0X0`"]
    #[inline(always)]
    pub fn is_b_0x0(&self) -> bool {
        *self == IWDG2APBLPEN_A::B_0X0
    }
    #[doc = "Checks if the value of the field is `B_0X1`"]
    #[inline(always)]
    pub fn is_b_0x1(&self) -> bool {
        *self == IWDG2APBLPEN_A::B_0X1
    }
}
#[doc = "Write proxy for field `IWDG2APBLPEN`"]
...
impl<'a> IWDG2APBLPEN_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: IWDG2APBLPEN_A) -> &'a mut W {
        {
            self.bit(variant.into())
        }
    }
    ...
    #[inline(always)]
    pub fn b_0x0(self) -> &'a mut W {
        self.variant(IWDG2APBLPEN_A::B_0X0)
    }
    #[doc = "Writing enables the APB clock in CSLEEP, reading means that the APB clock is enabled in CSLEEP"]
    #[inline(always)]
    pub fn b_0x1(self) -> &'a mut W {
        self.variant(IWDG2APBLPEN_A::B_0X1)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
impl<'a> STGENROSTPEN_W<'a> {
    ...
    #[doc = "Writing enables the peripheral clocks in CSTOP, reading means that the peripheral clocks are enabled in CSTOP"]
    #[inline(always)]
    pub fn b_0x1(self) -> &'a mut W {
