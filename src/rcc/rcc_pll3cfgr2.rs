#[doc = "Reader of register RCC_PLL3CFGR2"]
pub type R = crate::R<u32, super::RCC_PLL3CFGR2>;
#[doc = "Writer for register RCC_PLL3CFGR2"]
pub type W = crate::W<u32, super::RCC_PLL3CFGR2>;
#[doc = "Register RCC_PLL3CFGR2 `reset()`'s with value 0x0001_0101"]
impl crate::ResetValue for super::RCC_PLL3CFGR2 {
    type Type = u32;
    #[inline(always)]
...
pub enum DIVP_A {
    ...
    B_0X0 = 0,
    #[doc = "1: pll3_p_ck = vco3_ck / 2 (default\r\n                  after reset)"]
    B_0X1 = 1,
    #[doc = "2: pll3_p_ck = vco3_ck /\r\n                  3"]
    B_0X2 = 2,
    #[doc = "127: pll3_p_ck = vco3_ck /\r\n                  128"]
    B_0X7F = 127,
}
...
pub enum DIVQ_A {
    ...
    B_0X0 = 0,
    #[doc = "1: pll3_q_ck = vco3_ck / 2 (default\r\n                  after reset)"]
    B_0X1 = 1,
    #[doc = "2: pll3_q_ck = vco3_ck /\r\n                  3"]
    B_0X2 = 2,
    #[doc = "127: pll3_q_ck = vco3_ck /\r\n                  128"]
    B_0X7F = 127,
}
...
pub enum DIVR_A {
    ...
    B_0X0 = 0,
    #[doc = "1: pll3_r_ck = vco3_ck / 2 (default\r\n                  after reset)"]
    B_0X1 = 1,
    #[doc = "2: pll3_r_ck = vco3_ck /\r\n                  3"]
    B_0X2 = 2,
    #[doc = "127: pll3_r_ck = vco3_ck /\r\n                  128"]
    B_0X7F = 127,
}
