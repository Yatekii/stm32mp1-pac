#[doc = "Reader of register RCC_OCENCLRR"]
pub type R = crate::R<u32, super::RCC_OCENCLRR>;
#[doc = "Writer for register RCC_OCENCLRR"]
pub type W = crate::W<u32, super::RCC_OCENCLRR>;
#[doc = "Register RCC_OCENCLRR `reset()`'s with value 0x01"]
impl crate::ResetValue for super::RCC_OCENCLRR {
    type Type = u32;
    #[inline(always)]
...
pub enum DIGBYP_A {
    #[doc = "0: No effect"]
    B_0X0 = 0,
    #[doc = "1: Clear the DIGBYP bit (analog\r\n                  bypass)"]
    B_0X1 = 1,
}
...
impl<'a> DIGBYP_W<'a> {
    ...
    #[doc = "Clear the DIGBYP bit (analog bypass)"]
    #[inline(always)]
    pub fn b_0x1(self) -> &'a mut W {
