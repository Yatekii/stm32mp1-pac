#[doc = "Reader of register RCC_PLL1CR"]
pub type R = crate::R<u32, super::RCC_PLL1CR>;
#[doc = "Writer for register RCC_PLL1CR"]
pub type W = crate::W<u32, super::RCC_PLL1CR>;
#[doc = "Register RCC_PLL1CR `reset()`'s with value 0"]
impl crate::ResetValue for super::RCC_PLL1CR {
    type Type = u32;
    #[inline(always)]
...
pub enum PLLON_A {
    #[doc = "0: PLL1 OFF (default after\r\n                  reset)"]
    B_0X0 = 0,
    #[doc = "1: PLL1 is ON, and ref1_ck is provided\r\n                  to the PLL1"]
    B_0X1 = 1,
}
...
impl<'a> PLLON_W<'a> {
    ...
    #[doc = "PLL1 is ON, and ref1_ck is provided to the PLL1"]
    #[inline(always)]
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum PLL1RDY_A {
    #[doc = "0: PLL1 unlocked (default after\r\n                  reset)"]
    B_0X0 = 0,
    #[doc = "1: PLL1 locked"]
    B_0X1 = 1,
}
...
pub type PLL1RDY_R = crate::R<bool, PLL1RDY_A>;
impl PLL1RDY_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> PLL1RDY_A {
        match self.bits {
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum DIVPEN_A {
    #[doc = "0: pll1_p_ck output is disabled\r\n                  (default after reset)"]
    B_0X0 = 0,
    #[doc = "1: pll1_p_ck output is\r\n                  enabled"]
    B_0X1 = 1,
}
...
impl<'a> DIVPEN_W<'a> {
    ...
    #[doc = "pll1_p_ck output is disabled (default after reset)"]
    #[inline(always)]
    pub fn b_0x0(self) -> &'a mut W {
        self.variant(DIVPEN_A::B_0X0)
    }
    #[doc = "pll1_p_ck output is enabled"]
    #[inline(always)]
    pub fn b_0x1(self) -> &'a mut W {
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum DIVQEN_A {
    #[doc = "0: pll1_q_ck output is disabled\r\n                  (default after reset)"]
    B_0X0 = 0,
    #[doc = "1: pll1_q_ck output is\r\n                  enabled"]
    B_0X1 = 1,
}
...
impl<'a> DIVQEN_W<'a> {
    ...
    #[doc = "pll1_q_ck output is disabled (default after reset)"]
    #[inline(always)]
    pub fn b_0x0(self) -> &'a mut W {
        self.variant(DIVQEN_A::B_0X0)
    }
    #[doc = "pll1_q_ck output is enabled"]
    #[inline(always)]
    pub fn b_0x1(self) -> &'a mut W {
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum DIVREN_A {
    #[doc = "0: pll1_r_ck output is disabled\r\n                  (default after reset)"]
    B_0X0 = 0,
    #[doc = "1: pll1_r_ck output is\r\n                  enabled"]
    B_0X1 = 1,
}
...
impl<'a> DIVREN_W<'a> {
    ...
    #[doc = "pll1_r_ck output is disabled (default after reset)"]
    #[inline(always)]
    pub fn b_0x0(self) -> &'a mut W {
        self.variant(DIVREN_A::B_0X0)
    }
    #[doc = "pll1_r_ck output is enabled"]
    #[inline(always)]
    pub fn b_0x1(self) -> &'a mut W {
...
impl R {
    ...
    pub fn pll1rdy(&self) -> PLL1RDY_R {
        PLL1RDY_R::new(((self.bits >> 1) & 0x01) != 0)
    }
    #[doc = "Bit 2 - SSCG_CTRL"]
    #[inline(always)]
