...
#[repr(u8)]
pub enum DIVP_A {
    #[doc = "0: pll4_p_ck = vco4_ck"]
    B_0X0 = 0,
    #[doc = "1: pll4_p_ck = vco4_ck / 2 (default\r\n                  after reset)"]
    B_0X1 = 1,
    #[doc = "2: pll4_p_ck = vco4_ck /\r\n                  3"]
    B_0X2 = 2,
    #[doc = "127: pll4_p_ck = vco4_ck /\r\n                  128"]
    B_0X7F = 127,
}
...
impl<'a> DIVP_W<'a> {
    ...
    #[doc = "pll4_p_ck = vco4_ck"]
    #[inline(always)]
    pub fn b_0x0(self) -> &'a mut W {
        self.variant(DIVP_A::B_0X0)
    }
    #[doc = "pll4_p_ck = vco4_ck / 2 (default after reset)"]
    #[inline(always)]
    pub fn b_0x1(self) -> &'a mut W {
        self.variant(DIVP_A::B_0X1)
    }
    #[doc = "pll4_p_ck = vco4_ck / 3"]
    #[inline(always)]
    pub fn b_0x2(self) -> &'a mut W {
        self.variant(DIVP_A::B_0X2)
    }
    #[doc = "pll4_p_ck = vco4_ck / 128"]
    #[inline(always)]
...
#[repr(u8)]
pub enum DIVQ_A {
    #[doc = "0: pll4_q_ck = vco4_ck"]
    B_0X0 = 0,
    #[doc = "1: pll4_q_ck = vco4_ck / 2 (default\r\n                  after reset)"]
    B_0X1 = 1,
    #[doc = "2: pll4_q_ck = vco4_ck /\r\n                  3"]
    B_0X2 = 2,
    #[doc = "127: pll4_q_ck = vco4_ck /\r\n                  128"]
    B_0X7F = 127,
}
...
impl<'a> DIVQ_W<'a> {
    ...
    #[doc = "pll4_q_ck = vco4_ck"]
    #[inline(always)]
    pub fn b_0x0(self) -> &'a mut W {
        self.variant(DIVQ_A::B_0X0)
    }
    #[doc = "pll4_q_ck = vco4_ck / 2 (default after reset)"]
    #[inline(always)]
    pub fn b_0x1(self) -> &'a mut W {
        self.variant(DIVQ_A::B_0X1)
    }
    #[doc = "pll4_q_ck = vco4_ck / 3"]
    #[inline(always)]
    pub fn b_0x2(self) -> &'a mut W {
        self.variant(DIVQ_A::B_0X2)
    }
    #[doc = "pll4_q_ck = vco4_ck / 128"]
    #[inline(always)]
    pub fn b_0x7f(self) -> &'a mut W {
...
#[repr(u8)]
pub enum DIVR_A {
    #[doc = "0: pll4_r_ck = vco4_ck"]
    B_0X0 = 0,
    #[doc = "1: pll4_r_ck = vco4_ck / 2 (default\r\n                  after reset)"]
    B_0X1 = 1,
    #[doc = "2: pll4_r_ck = vco4_ck /\r\n                  3"]
    B_0X2 = 2,
    #[doc = "127: pll4_r_ck = vco4_ck /\r\n                  128"]
    B_0X7F = 127,
}
...
impl<'a> DIVR_W<'a> {
    ...
    #[doc = "pll4_r_ck = vco4_ck"]
    #[inline(always)]
    pub fn b_0x0(self) -> &'a mut W {
        self.variant(DIVR_A::B_0X0)
    }
    #[doc = "pll4_r_ck = vco4_ck / 2 (default after reset)"]
    #[inline(always)]
    pub fn b_0x1(self) -> &'a mut W {
        self.variant(DIVR_A::B_0X1)
    }
    #[doc = "pll4_r_ck = vco4_ck / 3"]
    #[inline(always)]
    pub fn b_0x2(self) -> &'a mut W {
        self.variant(DIVR_A::B_0X2)
    }
    #[doc = "pll4_r_ck = vco4_ck / 128"]
    #[inline(always)]
    pub fn b_0x7f(self) -> &'a mut W {
