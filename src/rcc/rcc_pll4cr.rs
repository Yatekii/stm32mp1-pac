...
pub enum PLLON_A {
    #[doc = "0: PLL4 OFF (default after\r\n                  reset)"]
    B_0X0 = 0,
    #[doc = "1: PLL4 ON, and ref4_ck is provided to\r\n                  the PLL4"]
    B_0X1 = 1,
}
...
impl<'a> PLLON_W<'a> {
    ...
    #[doc = "PLL4 OFF (default after reset)"]
    #[inline(always)]
    pub fn b_0x0(self) -> &'a mut W {
        self.variant(PLLON_A::B_0X0)
    }
    #[doc = "PLL4 ON, and ref4_ck is provided to the PLL4"]
    #[inline(always)]
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum PLL4RDY_A {
    #[doc = "0: PLL4 unlocked (default after\r\n                  reset)"]
    B_0X0 = 0,
    #[doc = "1: PLL4 locked"]
    B_0X1 = 1,
}
impl From<PLL4RDY_A> for bool {
    #[inline(always)]
    fn from(variant: PLL4RDY_A) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Reader of field `PLL4RDY`"]
pub type PLL4RDY_R = crate::R<bool, PLL4RDY_A>;
impl PLL4RDY_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> PLL4RDY_A {
        match self.bits {
            false => PLL4RDY_A::B_0X0,
            true => PLL4RDY_A::B_0X1,
        }
    }
    #[doc = "Checks if the value of the field is `B_0X0`"]
    #[inline(always)]
    pub fn is_b_0x0(&self) -> bool {
        *self == PLL4RDY_A::B_0X0
    }
    #[doc = "Checks if the value of the field is `B_0X1`"]
    #[inline(always)]
    pub fn is_b_0x1(&self) -> bool {
        *self == PLL4RDY_A::B_0X1
    }
}
#[doc = "SSCG_CTRL\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum DIVPEN_A {
    #[doc = "0: pll4_p_ck output is disabled\r\n                  (default after reset)"]
    B_0X0 = 0,
    #[doc = "1: pll4_p_ck output is\r\n                  enabled"]
    B_0X1 = 1,
}
...
impl<'a> DIVPEN_W<'a> {
    ...
    #[doc = "pll4_p_ck output is disabled (default after reset)"]
    #[inline(always)]
    pub fn b_0x0(self) -> &'a mut W {
        self.variant(DIVPEN_A::B_0X0)
    }
    #[doc = "pll4_p_ck output is enabled"]
    #[inline(always)]
    pub fn b_0x1(self) -> &'a mut W {
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum DIVQEN_A {
    #[doc = "0: pll4_q_ck output is disabled\r\n                  (default after reset)"]
    B_0X0 = 0,
    #[doc = "1: pll4_q_ck output is\r\n                  enabled"]
    B_0X1 = 1,
}
...
impl<'a> DIVQEN_W<'a> {
    ...
    #[doc = "pll4_q_ck output is disabled (default after reset)"]
    #[inline(always)]
    pub fn b_0x0(self) -> &'a mut W {
        self.variant(DIVQEN_A::B_0X0)
    }
    #[doc = "pll4_q_ck output is enabled"]
    #[inline(always)]
    pub fn b_0x1(self) -> &'a mut W {
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum DIVREN_A {
    #[doc = "0: pll4_r_ck output is disabled\r\n                  (default after reset)"]
    B_0X0 = 0,
    #[doc = "1: pll4_r_ck output is\r\n                  enabled"]
    B_0X1 = 1,
}
...
impl<'a> DIVREN_W<'a> {
    ...
    #[doc = "pll4_r_ck output is disabled (default after reset)"]
    #[inline(always)]
    pub fn b_0x0(self) -> &'a mut W {
        self.variant(DIVREN_A::B_0X0)
    }
    #[doc = "pll4_r_ck output is enabled"]
    #[inline(always)]
    pub fn b_0x1(self) -> &'a mut W {
