...
impl SAI1SRC_R {
    ...
    #[inline(always)]
    pub fn variant(&self) -> crate::Variant<u8, SAI1SRC_A> {
        use crate::Variant::*;
        match self.bits {
            0 => Val(SAI1SRC_A::B_0X0),
            1 => Val(SAI1SRC_A::B_0X1),
            2 => Val(SAI1SRC_A::B_0X2),
            3 => Val(SAI1SRC_A::B_0X3),
            i => Res(i),
        }
    }
    ...
    pub fn is_b_0x0(&self) -> bool {
        *self == SAI1SRC_A::B_0X0
    }
    #[doc = "Checks if the value of the field is `B_0X1`"]
    #[inline(always)]
    pub fn is_b_0x1(&self) -> bool {
        *self == SAI1SRC_A::B_0X1
    }
    #[doc = "Checks if the value of the field is `B_0X2`"]
    #[inline(always)]
    pub fn is_b_0x2(&self) -> bool {
        *self == SAI1SRC_A::B_0X2
    }
    #[doc = "Checks if the value of the field is `B_0X3`"]
    #[inline(always)]
    pub fn is_b_0x3(&self) -> bool {
        *self == SAI1SRC_A::B_0X3
    }
}
