#[doc = "Reader of register RCC_MP_AHB6LPENSETR"]
pub type R = crate::R<u32, super::RCC_MP_AHB6LPENSETR>;
#[doc = "Writer for register RCC_MP_AHB6LPENSETR"]
pub type W = crate::W<u32, super::RCC_MP_AHB6LPENSETR>;
#[doc = "Register RCC_MP_AHB6LPENSETR `reset()`'s with value 0x0113_57a1"]
impl crate::ResetValue for super::RCC_MP_AHB6LPENSETR {
    type Type = u32;
    #[inline(always)]
...
pub enum ETHCKLPEN_A {
    ...
    B_0X0 = 0,
    #[doc = "1: Writing enables the eth_ker_ck clock\r\n                  in CSLEEP, reading means that the eth_ker_ck\r\n                  clock is enabled in CSLEEP"]
    B_0X1 = 1,
}
...
impl<'a> ETHCKLPEN_W<'a> {
    ...
    #[doc = "Writing enables the eth_ker_ck clock in CSLEEP, reading means that the eth_ker_ck clock is enabled in CSLEEP"]
    #[inline(always)]
    pub fn b_0x1(self) -> &'a mut W {
...
impl<'a> ETHTXLPEN_W<'a> {
    ...
    #[doc = "Writing enables the transmission clock in CSLEEP, reading means that the transmission clock is enabled in CSLEEP"]
    #[inline(always)]
    pub fn b_0x1(self) -> &'a mut W {
...
impl<'a> ETHRXLPEN_W<'a> {
    ...
    #[doc = "Writing enables the reception clock in CSLEEP, reading means that the reception clock is enabled in CSLEEP"]
    #[inline(always)]
    pub fn b_0x1(self) -> &'a mut W {
...
impl<'a> ETHMACLPEN_W<'a> {
    ...
    #[doc = "Writing enables the bus interface clocks in CSLEEP, reading means that the bus interface clocks are enabled in CSLEEP"]
    #[inline(always)]
    pub fn b_0x1(self) -> &'a mut W {
...
impl<'a> ETHSTPEN_W<'a> {
    ...
    #[doc = "Writing enables the ETH RX and TX kernel clocks in CSTOP, reading means that the ETH RX and TX kernel clocks are enabled in CSTOP"]
    #[inline(always)]
    pub fn b_0x1(self) -> &'a mut W {
