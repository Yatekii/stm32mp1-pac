...
pub enum DIVN_A {
    ...
    B_0X19 = 25,
    #[doc = "49: Division ratio is 50"]
    B_0X31 = 49,
    #[doc = "99: Division ratio is 100 (default after\r\n                  reset)"]
    B_0X63 = 99,
}
...
impl<'a> DIVN_W<'a> {
    ...
    #[doc = "Division ratio is 50"]
    #[inline(always)]
    pub fn b_0x31(self) -> &'a mut W {
        self.variant(DIVN_A::B_0X31)
    }
    #[doc = "Division ratio is 100 (default after reset)"]
    #[inline(always)]
...
impl From<DIVM2_A> for u8 {
    #[inline(always)]
    fn from(variant: DIVM2_A) -> Self {
        variant as _
    }
}
#[doc = "Reader of field `DIVM2`"]
pub type DIVM2_R = crate::R<u8, DIVM2_A>;
impl DIVM2_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> crate::Variant<u8, DIVM2_A> {
        use crate::Variant::*;
        match self.bits {
            0 => Val(DIVM2_A::B_0X0),
            1 => Val(DIVM2_A::B_0X1),
            2 => Val(DIVM2_A::B_0X2),
            63 => Val(DIVM2_A::B_0X3F),
            i => Res(i),
        }
    }
...
impl<'a> DIVM2_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: DIVM2_A) -> &'a mut W {
        unsafe { self.bits(variant.into()) }
    }
    #[doc = "bypass"]
    #[inline(always)]
    pub fn b_0x0(self) -> &'a mut W {
        self.variant(DIVM2_A::B_0X0)
    }
    #[doc = "division by 2 (default after reset)"]
    #[inline(always)]
    pub fn b_0x1(self) -> &'a mut W {
        self.variant(DIVM2_A::B_0X1)
    }
    #[doc = "division by 3"]
    #[inline(always)]
    pub fn b_0x2(self) -> &'a mut W {
        self.variant(DIVM2_A::B_0X2)
    }
    #[doc = "division by 64"]
    #[inline(always)]
    pub fn b_0x3f(self) -> &'a mut W {
        self.variant(DIVM2_A::B_0X3F)
    }
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
