#[doc = "Reader of register RCC_MP_AHB5LPENCLRR"]
pub type R = crate::R<u32, super::RCC_MP_AHB5LPENCLRR>;
#[doc = "Writer for register RCC_MP_AHB5LPENCLRR"]
pub type W = crate::W<u32, super::RCC_MP_AHB5LPENCLRR>;
#[doc = "Register RCC_MP_AHB5LPENCLRR `reset()`'s with value 0x0171"]
impl crate::ResetValue for super::RCC_MP_AHB5LPENCLRR {
    type Type = u32;
    #[inline(always)]
...
pub enum BKPSRAMLPEN_A {
    ...
    B_0X0 = 0,
    #[doc = "1: Writing disables the clock in\r\n                  CSLEEP, reading means that the clock is enabled\r\n                  in CSLEEP"]
    B_0X1 = 1,
}
...
impl<'a> BKPSRAMLPEN_W<'a> {
    ...
    #[doc = "Writing disables the clock in CSLEEP, reading means that the clock is enabled in CSLEEP"]
    #[inline(always)]
    pub fn b_0x1(self) -> &'a mut W {
