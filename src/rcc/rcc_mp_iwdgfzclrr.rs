...
pub enum FZ_IWDG1_A {
    ...
    B_0X0 = 0,
    #[doc = "1: Writing unfreeze the IWDG1 clock,\r\n                  reading means that the IWDG1 clock is\r\n                  frozen"]
    B_0X1 = 1,
}
...
impl<'a> FZ_IWDG1_W<'a> {
    ...
    #[doc = "Writing unfreeze the IWDG1 clock, reading means that the IWDG1 clock is frozen"]
    #[inline(always)]
...
pub enum FZ_IWDG2_A {
    ...
    B_0X0 = 0,
    #[doc = "1: Writing unfreeze the IWDG2 clock,\r\n                  reading means that the IWDG2 clock is\r\n                  frozen"]
    B_0X1 = 1,
}
...
impl<'a> FZ_IWDG2_W<'a> {
    ...
    #[doc = "Writing unfreeze the IWDG2 clock, reading means that the IWDG2 clock is frozen"]
    #[inline(always)]
    pub fn b_0x1(self) -> &'a mut W {
