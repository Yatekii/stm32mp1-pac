...
#[doc = "`read()` method returns [ddrperfm_ctl::R](ddrperfm_ctl::R) reader structure"]
impl crate::Readable for DDRPERFM_CTL {}
...
#[doc = "`read()` method returns [ddrperfm_ccr::R](ddrperfm_ccr::R) reader structure"]
impl crate::Readable for DDRPERFM_CCR {}
...
#[doc = "`read()` method returns [ddrperfm_icr::R](ddrperfm_icr::R) reader structure"]
impl crate::Readable for DDRPERFM_ICR {}
