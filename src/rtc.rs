...
pub struct RegisterBlock {
    #[doc = "0x00 - The RTC_TR is the calendar time shadow register. This register must be written in initialization mode only. Refer to Calendar initialization and configuration on page632 and Reading the calendar on page633. This register is write protected. The write access procedure is described in RTC register write protection on page632. This register can be write-protected against non-secure access. Refer to Section23.3.4: RTC secure protection modes."]
    pub rtc_tr: RTC_TR,
    #[doc = "0x04 - The RTC_DR is the calendar date shadow register. This register must be written in initialization mode only. Refer to Calendar initialization and configuration on page632 and Reading the calendar on page633. This register is write protected. The write access procedure is described in RTC register write protection on page632. This register can be write-protected against non-secure access. Refer to Section23.3.4: RTC secure protection modes."]
    pub rtc_dr: RTC_DR,
    #[doc = "0x08 - RTC sub second register"]
    pub rtc_ssr: RTC_SSR,
    #[doc = "0x0c - This register is write protected. The write access procedure is described in RTC register write protection on page632. This register can be globally protected, or each bit of this register can be individually protected against non-secure access. Refer to Section23.3.4: RTC secure protection modes."]
    ...
    pub rtc_wpr: RTC_WPR,
    #[doc = "0x28 - This register is write protected. The write access procedure is described in RTC register write protection on page632. This register can be write-protected against non-secure access. Refer to Section23.3.4: RTC secure protection modes."]
    pub rtc_calr: RTC_CALR,
    #[doc = "0x2c - This register is write protected. The write access procedure is described in RTC register write protection on page632. This register can be protected against non-secure access. Refer to Section23.3.4: RTC secure protection modes."]
    pub rtc_shiftr: RTC_SHIFTR,
    #[doc = "0x30 - The content of this register is valid only when TSF is set to 1 in RTC_SR. It is cleared when TSF bit is reset. This register can be protected against non-secure access. Refer to Section23.3.4: RTC secure protection modes."]
    pub rtc_tstr: RTC_TSTR,
    #[doc = "0x34 - The content of this register is valid only when TSF is set to 1 in RTC_SR. It is cleared when TSF bit is reset. This register can be protected against non-secure access. Refer to Section23.3.4: RTC secure protection modes."]
    pub rtc_tsdr: RTC_TSDR,
    #[doc = "0x38 - The content of this register is valid only when TSF is set to 1 in RTC_SR. It is cleared when the TSF bit is reset. This register can be protected against non-secure access. Refer to Section23.3.4: RTC secure protection modes."]
    ...
    #[doc = "0x50 - This register can be protected against non-secure access. Refer to Section23.3.4: RTC secure protection modes."]
    pub rtc_sr: RTC_SR,
    #[doc = "0x54 - RTC non-secure masked interrupt status register"]
    pub rtc_misr: RTC_MISR,
    #[doc = "0x58 - This register can be protected against non-secure access. Refer to Section23.3.4: RTC secure protection modes."]
    pub rtc_smisr: RTC_SMISR,
    #[doc = "0x5c - This register can be protected against non-secure access. Refer to Section23.3.4: RTC secure protection modes."]
    pub rtc_scr: RTC_SCR,
...
#[doc = "The RTC_TR is the calendar time shadow register. This register must be written in initialization mode only. Refer to Calendar initialization and configuration on page632 and Reading the calendar on page633. This register is write protected. The write access procedure is described in RTC register write protection on page632. This register can be write-protected against non-secure access. Refer to Section23.3.4: RTC secure protection modes.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rtc_tr](rtc_tr) module"]
...
#[doc = "The RTC_TR is the calendar time shadow register. This register must be written in initialization mode only. Refer to Calendar initialization and configuration on page632 and Reading the calendar on page633. This register is write protected. The write access procedure is described in RTC register write protection on page632. This register can be write-protected against non-secure access. Refer to Section23.3.4: RTC secure protection modes."]
pub mod rtc_tr;
#[doc = "The RTC_DR is the calendar date shadow register. This register must be written in initialization mode only. Refer to Calendar initialization and configuration on page632 and Reading the calendar on page633. This register is write protected. The write access procedure is described in RTC register write protection on page632. This register can be write-protected against non-secure access. Refer to Section23.3.4: RTC secure protection modes.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rtc_dr](rtc_dr) module"]
...
#[doc = "RTC sub second register"]
pub mod rtc_ssr;
#[doc = "This register is write protected. The write access procedure is described in RTC register write protection on page632. This register can be globally protected, or each bit of this register can be individually protected against non-secure access. Refer to Section23.3.4: RTC secure protection modes.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rtc_icsr](rtc_icsr) module"]
...
#[doc = "This register must be written in initialization mode only. The initialization must be performed in two separate write accesses. Refer to Calendar initialization and configuration on page632. This register is write protected. The write access procedure is described in RTC register write protection on page632. This register can be write-protected against non-secure access. Refer to Section23.3.4: RTC secure protection modes."]
pub mod rtc_prer;
#[doc = "This register can be written only when WUTWF is set to 1 in RTC_ICSR. This register is write protected. The write access procedure is described in RTC register write protection on page632. This register can be protected against non-secure access. Refer to Section23.3.4: RTC secure protection modes.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rtc_wutr](rtc_wutr) module"]
...
#[doc(hidden)]
pub struct _RTC_WPR;
#[doc = "`read()` method returns [rtc_wpr::R](rtc_wpr::R) reader structure"]
impl crate::Readable for RTC_WPR {}
#[doc = "`write(|w| ..)` method takes [rtc_wpr::W](rtc_wpr::W) writer structure"]
impl crate::Writable for RTC_WPR {}
#[doc = "RTC write protection register"]
pub mod rtc_wpr;
#[doc = "This register is write protected. The write access procedure is described in RTC register write protection on page632. This register can be write-protected against non-secure access. Refer to Section23.3.4: RTC secure protection modes.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rtc_calr](rtc_calr) module"]
...
#[doc = "This register is write protected. The write access procedure is described in RTC register write protection on page632. This register can be write-protected against non-secure access. Refer to Section23.3.4: RTC secure protection modes."]
pub mod rtc_calr;
#[doc = "This register is write protected. The write access procedure is described in RTC register write protection on page632. This register can be protected against non-secure access. Refer to Section23.3.4: RTC secure protection modes.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rtc_shiftr](rtc_shiftr) module"]
pub type RTC_SHIFTR = crate::Reg<u32, _RTC_SHIFTR>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _RTC_SHIFTR;
#[doc = "`read()` method returns [rtc_shiftr::R](rtc_shiftr::R) reader structure"]
impl crate::Readable for RTC_SHIFTR {}
#[doc = "`write(|w| ..)` method takes [rtc_shiftr::W](rtc_shiftr::W) writer structure"]
impl crate::Writable for RTC_SHIFTR {}
#[doc = "This register is write protected. The write access procedure is described in RTC register write protection on page632. This register can be protected against non-secure access. Refer to Section23.3.4: RTC secure protection modes."]
pub mod rtc_shiftr;
#[doc = "The content of this register is valid only when TSF is set to 1 in RTC_SR. It is cleared when TSF bit is reset. This register can be protected against non-secure access. Refer to Section23.3.4: RTC secure protection modes.\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rtc_tstr](rtc_tstr) module"]
...
#[doc = "The content of this register is valid only when TSF is set to 1 in RTC_SR. It is cleared when TSF bit is reset. This register can be protected against non-secure access. Refer to Section23.3.4: RTC secure protection modes."]
pub mod rtc_tsdr;
#[doc = "The content of this register is valid only when TSF is set to 1 in RTC_SR. It is cleared when the TSF bit is reset. This register can be protected against non-secure access. Refer to Section23.3.4: RTC secure protection modes.\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rtc_tsssr](rtc_tsssr) module"]
...
#[doc = "This register can be protected against non-secure access. Refer to Section23.3.4: RTC secure protection modes.\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rtc_sr](rtc_sr) module"]
...
#[doc(hidden)]
pub struct _RTC_SCR;
#[doc = "`read()` method returns [rtc_scr::R](rtc_scr::R) reader structure"]
impl crate::Readable for RTC_SCR {}
