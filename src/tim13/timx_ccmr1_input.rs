#[doc = "Reader of register TIMx_CCMR1_Input"]
pub type R = crate::R<u32, super::TIMX_CCMR1_INPUT>;
#[doc = "Writer for register TIMx_CCMR1_Input"]
pub type W = crate::W<u32, super::TIMX_CCMR1_INPUT>;
#[doc = "Register TIMx_CCMR1_Input `reset()`'s with value 0"]
impl crate::ResetValue for super::TIMX_CCMR1_INPUT {
    type Type = u32;
    #[inline(always)]
