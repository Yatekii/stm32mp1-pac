#[doc = "Reader of register BPRNS"]
pub type R = crate::R<u32, super::BPRNS>;
#[doc = "Writer for register BPRNS"]
pub type W = crate::W<u32, super::BPRNS>;
#[doc = "Register BPRNS `reset()`'s with value 0x03"]
impl crate::ResetValue for super::BPRNS {
    type Type = u32;
    #[inline(always)]
