#[doc = "Reader of register ADC_SQR1"]
pub type R = crate::R<u32, super::ADC_SQR1>;
#[doc = "Writer for register ADC_SQR1"]
pub type W = crate::W<u32, super::ADC_SQR1>;
#[doc = "Register ADC_SQR1 `reset()`'s with value 0"]
impl crate::ResetValue for super::ADC_SQR1 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `L3`"]
pub type L3_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `L3`"]
pub struct L3_W<'a> {
    w: &'a mut W,
}
impl<'a> L3_W<'a> {
