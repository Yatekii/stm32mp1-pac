#[doc = "Reader of register ADC_CFGR"]
pub type R = crate::R<u32, super::ADC_CFGR>;
#[doc = "Writer for register ADC_CFGR"]
pub type W = crate::W<u32, super::ADC_CFGR>;
#[doc = "Register ADC_CFGR `reset()`'s with value 0"]
impl crate::ResetValue for super::ADC_CFGR {
    type Type = u32;
    #[inline(always)]
...
pub type DMNGT_R = crate::R<u8, u8>;
