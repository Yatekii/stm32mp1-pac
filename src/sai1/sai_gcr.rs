#[doc = "Reader of register SAI_GCR"]
pub type R = crate::R<u32, super::SAI_GCR>;
#[doc = "Writer for register SAI_GCR"]
pub type W = crate::W<u32, super::SAI_GCR>;
#[doc = "Register SAI_GCR `reset()`'s with value 0"]
impl crate::ResetValue for super::SAI_GCR {
    type Type = u32;
    #[inline(always)]
