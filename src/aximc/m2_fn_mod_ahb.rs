#[doc = "Reader of register M2_FN_MOD_AHB"]
pub type R = crate::R<u32, super::M2_FN_MOD_AHB>;
#[doc = "Writer for register M2_FN_MOD_AHB"]
pub type W = crate::W<u32, super::M2_FN_MOD_AHB>;
#[doc = "Register M2_FN_MOD_AHB `reset()`'s with value 0"]
impl crate::ResetValue for super::M2_FN_MOD_AHB {
    type Type = u32;
    #[inline(always)]
