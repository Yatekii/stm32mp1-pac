#[doc = "Reader of register M9_FN_MOD"]
pub type R = crate::R<u32, super::M9_FN_MOD>;
#[doc = "Writer for register M9_FN_MOD"]
pub type W = crate::W<u32, super::M9_FN_MOD>;
#[doc = "Register M9_FN_MOD `reset()`'s with value 0"]
impl crate::ResetValue for super::M9_FN_MOD {
    type Type = u32;
    #[inline(always)]
