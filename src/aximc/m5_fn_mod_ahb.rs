#[doc = "Reader of register M5_FN_MOD_AHB"]
pub type R = crate::R<u32, super::M5_FN_MOD_AHB>;
#[doc = "Writer for register M5_FN_MOD_AHB"]
pub type W = crate::W<u32, super::M5_FN_MOD_AHB>;
#[doc = "Register M5_FN_MOD_AHB `reset()`'s with value 0"]
impl crate::ResetValue for super::M5_FN_MOD_AHB {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bit 0 - converts all AHB-Lite write transactions to a series of single beat"]
    #[inline(always)]
    pub fn rd_inc_override(&self) -> RD_INC_OVERRIDE_R {
        RD_INC_OVERRIDE_R::new((self.bits & 0x01) != 0)
    }
    #[doc = "Bit 1 - converts all AHB-Lite read transactions to a series of single beat"]
    #[inline(always)]
