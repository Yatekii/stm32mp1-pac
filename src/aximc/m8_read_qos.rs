#[doc = "Reader of register M8_READ_QOS"]
pub type R = crate::R<u32, super::M8_READ_QOS>;
#[doc = "Writer for register M8_READ_QOS"]
pub type W = crate::W<u32, super::M8_READ_QOS>;
#[doc = "Register M8_READ_QOS `reset()`'s with value 0"]
impl crate::ResetValue for super::M8_READ_QOS {
    type Type = u32;
    #[inline(always)]
