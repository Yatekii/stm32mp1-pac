#[doc = "Reader of register FN_MOD_LB"]
pub type R = crate::R<u32, super::FN_MOD_LB>;
#[doc = "Writer for register FN_MOD_LB"]
pub type W = crate::W<u32, super::FN_MOD_LB>;
#[doc = "Register FN_MOD_LB `reset()`'s with value 0"]
impl crate::ResetValue for super::FN_MOD_LB {
    type Type = u32;
    #[inline(always)]
