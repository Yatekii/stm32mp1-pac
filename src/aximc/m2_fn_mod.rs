#[doc = "Reader of register M2_FN_MOD"]
pub type R = crate::R<u32, super::M2_FN_MOD>;
#[doc = "Writer for register M2_FN_MOD"]
pub type W = crate::W<u32, super::M2_FN_MOD>;
#[doc = "Register M2_FN_MOD `reset()`'s with value 0"]
impl crate::ResetValue for super::M2_FN_MOD {
    type Type = u32;
    #[inline(always)]
