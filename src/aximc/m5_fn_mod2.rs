#[doc = "Reader of register M5_FN_MOD2"]
pub type R = crate::R<u32, super::M5_FN_MOD2>;
#[doc = "Writer for register M5_FN_MOD2"]
pub type W = crate::W<u32, super::M5_FN_MOD2>;
#[doc = "Register M5_FN_MOD2 `reset()`'s with value 0"]
impl crate::ResetValue for super::M5_FN_MOD2 {
    type Type = u32;
    #[inline(always)]
