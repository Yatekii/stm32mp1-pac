#[doc = "Reader of register M1_FN_MOD2"]
pub type R = crate::R<u32, super::M1_FN_MOD2>;
#[doc = "Writer for register M1_FN_MOD2"]
pub type W = crate::W<u32, super::M1_FN_MOD2>;
#[doc = "Register M1_FN_MOD2 `reset()`'s with value 0"]
impl crate::ResetValue for super::M1_FN_MOD2 {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bit 0 - Disable packing of beats to match the output data"]
    #[inline(always)]
