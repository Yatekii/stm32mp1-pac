#[doc = "Reader of register LR1"]
pub type R = crate::R<u32, super::LR1>;
#[doc = "Writer for register LR1"]
pub type W = crate::W<u32, super::LR1>;
#[doc = "Register LR1 `reset()`'s with value 0"]
impl crate::ResetValue for super::LR1 {
    type Type = u32;
    #[inline(always)]
