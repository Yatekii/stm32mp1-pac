...
pub struct RegisterBlock {
    ...
    #[doc = "0x24 - Refer to Section23.6.9: CRYP key register 0L (CRYP_K0LR) for details."]
    pub cryp_k0rr: CRYP_K0RR,
    #[doc = "0x28 - Refer to Section23.6.9: CRYP key register 0L (CRYP_K0LR) for details."]
    pub cryp_k1lr: CRYP_K1LR,
    #[doc = "0x2c - Refer to Section23.6.9: CRYP key register 0L (CRYP_K0LR) for details."]
    pub cryp_k1rr: CRYP_K1RR,
    #[doc = "0x30 - Refer to Section23.6.9: CRYP key register 0L (CRYP_K0LR) for details."]
    pub cryp_k2lr: CRYP_K2LR,
    #[doc = "0x34 - Refer to Section23.6.9: CRYP key register 0L (CRYP_K0LR) for details."]
    pub cryp_k2rr: CRYP_K2RR,
    #[doc = "0x38 - Refer to Section23.6.9: CRYP key register 0L (CRYP_K0LR) for details."]
    pub cryp_k3lr: CRYP_K3LR,
    #[doc = "0x3c - Refer to Section23.6.9: CRYP key register 0L (CRYP_K0LR) for details."]
    pub cryp_k3rr: CRYP_K3RR,
    #[doc = "0x40 - The CRYP_IV0...1(L/R)R are the left-word and right-word registers for the initialization vector (64 bits for DES/TDES and 128 bits for AES). For more information refer to Section23.3.18: CRYP initialization vector registers. IV0 is the leftmost bit whereas IV63 (DES, TDES) or IV127 (AES) are the rightmost bits of the initialization vector. IV1(L/R)R is used only in the AES. Only CRYP_IV0(L/R) is used in DES/TDES. Write access to these registers are disregarded when the cryptographic processor is busy (bit BUSY = 1 in the CRYP_SR register)."]
    pub cryp_iv0lr: CRYP_IV0LR,
    #[doc = "0x44 - Refer to Section23.6.17: CRYP initialization vector register 0L (CRYP_IV0LR) for details."]
    pub cryp_iv0rr: CRYP_IV0RR,
    #[doc = "0x48 - Refer to Section23.6.17: CRYP initialization vector register 0L (CRYP_IV0LR) for details."]
    pub cryp_iv1lr: CRYP_IV1LR,
    #[doc = "0x4c - Refer to Section23.6.17: CRYP initialization vector register 0L (CRYP_IV0LR) for details."]
    ...
    #[doc = "0x70 - Please refer to Section23.6.21: CRYP context swap GCM-CCM registers (CRYP_CSGCMCCMxR) for details."]
    pub cryp_csgcm0r: CRYP_CSGCM0R,
    #[doc = "0x74 - Please refer to Section23.6.21: CRYP context swap GCM-CCM registers (CRYP_CSGCMCCMxR) for details."]
    pub cryp_csgcm1r: CRYP_CSGCM1R,
    #[doc = "0x78 - Please refer to Section23.6.21: CRYP context swap GCM-CCM registers (CRYP_CSGCMCCMxR) for details."]
    pub cryp_csgcm2r: CRYP_CSGCM2R,
    #[doc = "0x7c - Please refer to Section23.6.21: CRYP context swap GCM-CCM registers (CRYP_CSGCMCCMxR) for details."]
    pub cryp_csgcm3r: CRYP_CSGCM3R,
    #[doc = "0x80 - Please refer to Section23.6.21: CRYP context swap GCM-CCM registers (CRYP_CSGCMCCMxR) for details."]
    pub cryp_csgcm4r: CRYP_CSGCM4R,
    #[doc = "0x84 - Please refer to Section23.6.21: CRYP context swap GCM-CCM registers (CRYP_CSGCMCCMxR) for details."]
    pub cryp_csgcm5r: CRYP_CSGCM5R,
    #[doc = "0x88 - Please refer to Section23.6.21: CRYP context swap GCM-CCM registers (CRYP_CSGCMCCMxR) for details."]
    pub cryp_csgcm6r: CRYP_CSGCM6R,
    #[doc = "0x8c - Please refer to Section23.6.21: CRYP context swap GCM-CCM registers (CRYP_CSGCMCCMxR) for details."]
...
#[doc = "CRYP key registers contain the cryptographic keys. In DES/TDES mode, the keys are 64-bit binary values (number from left to right, that is the leftmost bit is bit 1) and named K1, K2 and K3 (K0 is not used). Each key consists of 56 information bits and 8 parity bits. In AES mode, the key is considered as a single 128, 192 or 256 bits long sequence K0K1K2...K127/191/255. The AES key is entered into the registers as follows: for AES-128: K0..K127 corresponds to b127..b0 (b255..b128 are not used), for AES-192: K0..K191 corresponds to b191..b0 (b255..b192 are not used), for AES-256: K0..K255 corresponds to b255..b0. In all cases key bit K0 is the leftmost bit in CRYP inner memory and register bit b0 is the rightmost bit in corresponding CRYP_KxLR key register. For more information refer to Section23.3.17: CRYP key registers. Write accesses to these registers are disregarded when the cryptographic processor is busy (bit BUSY = 1 in the CRYP_SR register)"]
pub mod cryp_k0lr;
#[doc = "Refer to Section23.6.9: CRYP key register 0L (CRYP_K0LR) for details.\n\nThis register you can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cryp_k0rr](cryp_k0rr) module"]
...
#[doc = "Refer to Section23.6.9: CRYP key register 0L (CRYP_K0LR) for details."]
pub mod cryp_k3rr;
#[doc = "The CRYP_IV0...1(L/R)R are the left-word and right-word registers for the initialization vector (64 bits for DES/TDES and 128 bits for AES). For more information refer to Section23.3.18: CRYP initialization vector registers. IV0 is the leftmost bit whereas IV63 (DES, TDES) or IV127 (AES) are the rightmost bits of the initialization vector. IV1(L/R)R is used only in the AES. Only CRYP_IV0(L/R) is used in DES/TDES. Write access to these registers are disregarded when the cryptographic processor is busy (bit BUSY = 1 in the CRYP_SR register).\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cryp_iv0lr](cryp_iv0lr) module"]
...
#[doc = "The CRYP_IV0...1(L/R)R are the left-word and right-word registers for the initialization vector (64 bits for DES/TDES and 128 bits for AES). For more information refer to Section23.3.18: CRYP initialization vector registers. IV0 is the leftmost bit whereas IV63 (DES, TDES) or IV127 (AES) are the rightmost bits of the initialization vector. IV1(L/R)R is used only in the AES. Only CRYP_IV0(L/R) is used in DES/TDES. Write access to these registers are disregarded when the cryptographic processor is busy (bit BUSY = 1 in the CRYP_SR register)."]
pub mod cryp_iv0lr;
#[doc = "Refer to Section23.6.17: CRYP initialization vector register 0L (CRYP_IV0LR) for details.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cryp_iv0rr](cryp_iv0rr) module"]
...
#[doc = "Please refer to Section23.6.21: CRYP context swap GCM-CCM registers (CRYP_CSGCMCCMxR) for details.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cryp_csgcm0r](cryp_csgcm0r) module"]
