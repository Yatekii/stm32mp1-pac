...
pub struct RegisterBlock {
    ...
    pub c1mr: C1MR,
    #[doc = "0x08 - IPCC Processor 1 status set clear register"]
    pub c1scr: C1SCR,
    ...
    pub c2mr: C2MR,
    #[doc = "0x18 - IPCC Processor 2 status set clear register"]
    pub c2scr: C2SCR,
...
#[doc = "`read()` method returns [c1toc2sr::R](c1toc2sr::R) reader structure"]
...
#[doc = "ID register"]
pub mod id;
#[doc = "size ID register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [sid](sid) module"]
pub type SID = crate::Reg<u32, _SID>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _SID;
#[doc = "`read()` method returns [sid::R](sid::R) reader structure"]
impl crate::Readable for SID {}
#[doc = "size ID register"]
pub mod sid;
