...
pub struct RegisterBlock {
    ...
    _reserved_4_spdifrx_dr: [u8; 4usize],
...
impl RegisterBlock {
    #[doc = "0x10 - This register can take 3 different formats according to DRFMT. Here is the format when DRFMT = 0b00:"]
    #[inline(always)]
    pub fn spdifrx_dr3(&self) -> &SPDIFRX_DR3 {
        unsafe { &*(((self as *const Self) as *const u8).add(16usize) as *const SPDIFRX_DR3) }
    }
    #[doc = "0x10 - This register can take 3 different formats according to DRFMT. Here is the format when DRFMT = 0b00:"]
    #[inline(always)]
    pub fn spdifrx_dr3_mut(&self) -> &mut SPDIFRX_DR3 {
        unsafe { &mut *(((self as *const Self) as *mut u8).add(16usize) as *mut SPDIFRX_DR3) }
    }
    #[doc = "0x10 - This register can take 3 different formats according to DRFMT. Here is the format when DRFMT = 0b00:"]
    #[inline(always)]
    pub fn spdifrx_dr2(&self) -> &SPDIFRX_DR2 {
        unsafe { &*(((self as *const Self) as *const u8).add(16usize) as *const SPDIFRX_DR2) }
    }
    #[doc = "0x10 - This register can take 3 different formats according to DRFMT. Here is the format when DRFMT = 0b00:"]
    #[inline(always)]
    pub fn spdifrx_dr2_mut(&self) -> &mut SPDIFRX_DR2 {
        unsafe { &mut *(((self as *const Self) as *mut u8).add(16usize) as *mut SPDIFRX_DR2) }
    }
    #[doc = "0x10 - This register can take 3 different formats according to DRFMT. Here is the format when DRFMT = 0b00:"]
    #[inline(always)]
    pub fn spdifrx_dr1(&self) -> &SPDIFRX_DR1 {
        unsafe { &*(((self as *const Self) as *const u8).add(16usize) as *const SPDIFRX_DR1) }
    }
    #[doc = "0x10 - This register can take 3 different formats according to DRFMT. Here is the format when DRFMT = 0b00:"]
    #[inline(always)]
    pub fn spdifrx_dr1_mut(&self) -> &mut SPDIFRX_DR1 {
        unsafe { &mut *(((self as *const Self) as *mut u8).add(16usize) as *mut SPDIFRX_DR1) }
    }
}
...
#[doc = "This register can take 3 different formats according to DRFMT. Here is the format when DRFMT = 0b00:\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [spdifrx_dr1](spdifrx_dr1) module"]
pub type SPDIFRX_DR1 = crate::Reg<u32, _SPDIFRX_DR1>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _SPDIFRX_DR1;
#[doc = "`read()` method returns [spdifrx_dr1::R](spdifrx_dr1::R) reader structure"]
impl crate::Readable for SPDIFRX_DR1 {}
#[doc = "This register can take 3 different formats according to DRFMT. Here is the format when DRFMT = 0b00:"]
pub mod spdifrx_dr1;
#[doc = "This register can take 3 different formats according to DRFMT. Here is the format when DRFMT = 0b00:\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [spdifrx_dr2](spdifrx_dr2) module"]
pub type SPDIFRX_DR2 = crate::Reg<u32, _SPDIFRX_DR2>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _SPDIFRX_DR2;
#[doc = "`read()` method returns [spdifrx_dr2::R](spdifrx_dr2::R) reader structure"]
impl crate::Readable for SPDIFRX_DR2 {}
#[doc = "This register can take 3 different formats according to DRFMT. Here is the format when DRFMT = 0b00:"]
pub mod spdifrx_dr2;
#[doc = "This register can take 3 different formats according to DRFMT. Here is the format when DRFMT = 0b00:\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [spdifrx_dr3](spdifrx_dr3) module"]
pub type SPDIFRX_DR3 = crate::Reg<u32, _SPDIFRX_DR3>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _SPDIFRX_DR3;
#[doc = "`read()` method returns [spdifrx_dr3::R](spdifrx_dr3::R) reader structure"]
impl crate::Readable for SPDIFRX_DR3 {}
#[doc = "This register can take 3 different formats according to DRFMT. Here is the format when DRFMT = 0b00:"]
pub mod spdifrx_dr3;
