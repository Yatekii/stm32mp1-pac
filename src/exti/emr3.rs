#[doc = "Reader of register EMR3"]
pub type R = crate::R<u32, super::EMR3>;
#[doc = "Writer for register EMR3"]
pub type W = crate::W<u32, super::EMR3>;
#[doc = "Register EMR3 `reset()`'s with value 0"]
impl crate::ResetValue for super::EMR3 {
    type Type = u32;
    #[inline(always)]
