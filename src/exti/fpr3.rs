#[doc = "Reader of register FPR3"]
pub type R = crate::R<u32, super::FPR3>;
#[doc = "Writer for register FPR3"]
pub type W = crate::W<u32, super::FPR3>;
#[doc = "Register FPR3 `reset()`'s with value 0"]
impl crate::ResetValue for super::FPR3 {
    type Type = u32;
    #[inline(always)]
