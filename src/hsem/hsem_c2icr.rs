#[doc = "Writer for register HSEM_C2ICR"]
pub type W = crate::W<u32, super::HSEM_C2ICR>;
#[doc = "Register HSEM_C2ICR `reset()`'s with value 0"]
impl crate::ResetValue for super::HSEM_C2ICR {
    type Type = u32;
    #[inline(always)]
