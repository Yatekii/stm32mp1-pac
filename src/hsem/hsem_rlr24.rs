#[doc = "Reader of register HSEM_RLR24"]
pub type R = crate::R<u32, super::HSEM_RLR24>;
...
impl R {
    #[doc = "Bits 0:3 - Semaphore ProcessID"]
    #[inline(always)]
    pub fn procid(&self) -> PROCID_R {
        PROCID_R::new((self.bits & 0x0f) as u8)
    }
    #[doc = "Bits 8:15 - Semaphore MasterID"]
    #[inline(always)]
    pub fn coreid(&self) -> COREID_R {
        COREID_R::new(((self.bits >> 8) & 0xff) as u8)
    }
