...
#[doc = "`read()` method returns [hdp_gposet::R](hdp_gposet::R) reader structure"]
impl crate::Readable for HDP_GPOSET {}
...
#[doc = "`read()` method returns [hdp_gpoclr::R](hdp_gpoclr::R) reader structure"]
impl crate::Readable for HDP_GPOCLR {}
