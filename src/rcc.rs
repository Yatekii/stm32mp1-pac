...
pub struct RegisterBlock {
    ...
    #[doc = "0x0c - This register is used to control the oscillators.Writing to this register has no effect, writing will set the corresponding bits. Reading will give the effective values of each bit.If , this register can only be modified in secure mode. Write access to this register is not allowed during the clock restore sequence. See Section: The clock restore sequence description for details."]
    ...
    #[doc = "0x1c - This register is used to fine-tune the CSI frequency. If TZEN = MCKPROT = , this register can only be modified in secure mode. Write access to this register is not allowed during the clock restore sequence. See Section: The clock restore sequence description for details."]
    ...
    #[doc = "0x2c - This register is used to control the MPU clock prescaler. Please refer to Section1.4.6.3: Sub-System Clock Generation for additional information. If TZEN = , this register can only be modified in secure mode."]
    pub rcc_mpckdivr: RCC_MPCKDIVR,
    #[doc = "0x30 - This register is used to control the AXI Matrix clock prescaler. Please refer to Section1.4.6.3: Sub-System Clock Generation for additional information. If TZEN = , this register can only be modified in secure mode."]
    pub rcc_axidivr: RCC_AXIDIVR,
    _reserved10: [u8; 8usize],
    #[doc = "0x3c - This register is used to control the APB4 clock divider. Please refer to Section1.4.6.3: Sub-System Clock Generation for additional information. If TZEN = , this register can only be modified in secure mode."]
    pub rcc_apb4divr: RCC_APB4DIVR,
    #[doc = "0x40 - This register is used to control the APB5 clock divider. Please refer to Section1.4.6.3: Sub-System Clock Generation for additional information. If TZEN = , this register can only be modified in secure mode."]
    ...
    #[doc = "0x90 - This register is used to configure the PLL1.It is not recommended to change the content of this register when the PLL1 is enabled (PLLON = ). Please refer to Section1.4.5.4: Using the PLLs in spread spectrum mode for details. If TZEN = , this register can only be modified in secure mode. Write access to this register is not allowed during the clock restore sequence. See Section: The clock restore sequence description for details."]
    ...
    #[doc = "0xa4 - This register is used to configure the PLL2. It is not recommended to change the content of this register when the PLL2 is enabled (PLLON = ). Please refer to Section1.4.5.4: Using the PLLs in spread spectrum mode for details. If TZEN = , this register can only be modified in secure mode. Write access to this register is not allowed during the clock restore sequence. See Section: The clock restore sequence description for details."]
    ...
    pub rcc_i2c4ckselr: RCC_I2C4CKSELR,
    ...
    #[doc = "0xd0 - This register is used to select an oscillator source as kernel clock for the per_ck clock. The per_ck clock is distributed to several peripherals. Please refer to Section1.4.10.1: Clock Enabling Delays."]
    pub rcc_cperckselr: RCC_CPERCKSELR,
    #[doc = "0xd4 - This register is used to select the peripheral clock for the STGEN block. Note that this clock is used to provide a time reference for the application. Please refer to Section1.4.10.1: Clock Enabling Delays. If TZEN = , this register can only be modified in secure mode."]
    ...
    #[doc = "0x218 - This register is used to set the peripheral clock enable bit of the corresponding peripheral to . It shall be used to allocate a peripheral to the MCU. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mp_ahb6ensetr: RCC_MP_AHB6ENSETR,
    #[doc = "0x21c - This register is used to clear the peripheral clock enable bit of the corresponding peripheral. It shall be used to deallocate a peripheral from MCU. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    ...
    #[doc = "0x280 - This register is used to set the peripheral clock enable bit of the corresponding peripheral to . It shall be used to allocate a peripheral to the MCU. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mc_apb4ensetr: RCC_MC_APB4ENSETR,
    #[doc = "0x284 - This register is used to clear the peripheral clock enable bit of the corresponding peripheral. It shall be used to deallocate a peripheral from MCU. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mc_apb4enclrr: RCC_MC_APB4ENCLRR,
    #[doc = "0x288 - This register is used to set the peripheral clock enable bit of the corresponding peripheral to . It shall be used to allocate a peripheral to the MCU. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to . If TZEN = , this register can only be modified in secure mode."]
    ...
    #[doc = "0x290 - This register is used to set the peripheral clock enable bit of the corresponding peripheral to . It shall be used to allocate a peripheral to the MCU. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to . If TZEN = , this register can only be modified in secure mode."]
    pub rcc_mc_ahb5ensetr: RCC_MC_AHB5ENSETR,
    #[doc = "0x294 - This register is used to clear the peripheral clock enable bit of the corresponding peripheral. It shall be used to deallocate a peripheral from MCU. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to . If TZEN = , this register can only be modified in secure mode."]
    pub rcc_mc_ahb5enclrr: RCC_MC_AHB5ENCLRR,
    #[doc = "0x298 - This register is used to set the peripheral clock enable bit of the corresponding peripheral to . It shall be used to allocate a peripheral to the MCU. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mc_ahb6ensetr: RCC_MC_AHB6ENSETR,
    #[doc = "0x29c - This register is used to clear the peripheral clock enable bit of the corresponding peripheral. It shall be used to deallocate a peripheral from MCU. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mc_ahb6enclrr: RCC_MC_AHB6ENCLRR,
    _reserved67: [u8; 96usize],
    #[doc = "0x300 - This register is used by the MPU in order to set the PERxLPEN bit of the corresponding peripheral to . Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mp_apb4lpensetr: RCC_MP_APB4LPENSETR,
    #[doc = "0x304 - This register is used by the MPU in order to clear the PERxLPEN bit of the corresponding peripheral. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mp_apb4lpenclrr: RCC_MP_APB4LPENCLRR,
    #[doc = "0x308 - This register is used by the MPU in order to set the PERxLPEN bit of the corresponding peripheral to . Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to . If TZEN = , this register can only be modified in secure mode."]
    pub rcc_mp_apb5lpensetr: RCC_MP_APB5LPENSETR,
    #[doc = "0x30c - This register is used by the MPU in order to clear the PERxLPEN bit of the corresponding peripheral. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to . If TZEN = , this register can only be modified in secure mode."]
    pub rcc_mp_apb5lpenclrr: RCC_MP_APB5LPENCLRR,
    #[doc = "0x310 - This register is used by the MCU in order to set the PERxLPEN bit of the corresponding peripheral to . Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to . If TZEN = , this register can only be modified in secure mode."]
    pub rcc_mp_ahb5lpensetr: RCC_MP_AHB5LPENSETR,
    #[doc = "0x314 - This register is used by the MCU in order to clear the PERxLPEN bit of the corresponding peripheral. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to . If TZEN = , this register can only be modified in secure mode."]
    pub rcc_mp_ahb5lpenclrr: RCC_MP_AHB5LPENCLRR,
    #[doc = "0x318 - This register is used by the MCU in order to set the PERxLPEN bit of the corresponding peripheral to . Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mp_ahb6lpensetr: RCC_MP_AHB6LPENSETR,
    #[doc = "0x31c - This register is used by the MCU in order to clear the PERxLPEN bit of the corresponding peripheral. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mp_ahb6lpenclrr: RCC_MP_AHB6LPENCLRR,
    #[doc = "0x320 - This register is used by the MPU in order to set the PERxLPEN bit of the corresponding peripheral to . Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to . If TZEN = , this register can only be modified in secure mode."]
    pub rcc_mp_tzahb6lpensetr: RCC_MP_TZAHB6LPENSETR,
    #[doc = "0x324 - This register is used by the MPU in order to clear the PERxLPEN bit of the corresponding peripheral. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to . If TZEN = , this register can only be modified in secure mode."]
    pub rcc_mp_tzahb6lpenclrr: RCC_MP_TZAHB6LPENCLRR,
    _reserved77: [u8; 88usize],
    #[doc = "0x380 - This register is used by the MCU in order to set the PERxLPEN bit of the corresponding peripheral to . Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mc_apb4lpensetr: RCC_MC_APB4LPENSETR,
    #[doc = "0x384 - This register is used by the MCU in order to clear the PERxLPEN bit of the corresponding peripheral. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mc_apb4lpenclrr: RCC_MC_APB4LPENCLRR,
    #[doc = "0x388 - This register is used by the MCU in order to set the PERxLPEN bit of the corresponding peripheral to . Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to . If TZEN = , this register can only be modified in secure mode."]
    pub rcc_mc_apb5lpensetr: RCC_MC_APB5LPENSETR,
    #[doc = "0x38c - This register is used by the MCU in order to clear the PERxLPEN bit of the corresponding peripheral. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to . If TZEN = , this register can only be modified in secure mode."]
    pub rcc_mc_apb5lpenclrr: RCC_MC_APB5LPENCLRR,
    #[doc = "0x390 - This register is used by the MCU in order to set the PERxLPEN bit of the corresponding peripheral to . Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to . If TZEN = , this register can only be modified in secure mode."]
    pub rcc_mc_ahb5lpensetr: RCC_MC_AHB5LPENSETR,
    #[doc = "0x394 - This register is used by the MCU in order to clear the PERxLPEN bit of the corresponding peripheral. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to . If TZEN = , this register can only be modified in secure mode."]
    pub rcc_mc_ahb5lpenclrr: RCC_MC_AHB5LPENCLRR,
    #[doc = "0x398 - This register is used by the MCU in order to set the PERxLPEN bit of the corresponding peripheral to . Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mc_ahb6lpensetr: RCC_MC_AHB6LPENSETR,
    #[doc = "0x39c - This register is used by the MCU in order to clear the PERxLPEN bit of the corresponding peripheral. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    ...
    #[doc = "0x404 - This register is used by the MPU in order to generate either a MCU reset or a system reset. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a activates the reset of the corresponding peripheral."]
    ...
    #[doc = "0x414 - This register shall be used by the MPU to control the interrupt source enable. Please refer to Section1.5: RCC Interrupts for more details. If TZEN = , this register can only be modified in secure mode."]
    pub rcc_mp_cier: RCC_MP_CIER,
    #[doc = "0x418 - This register shall be used by the MPU in order to read and clear the interrupt flags.Writing has no effect, writing will clear the corresponding flag.Please refer to Section1.5: RCC Interrupts for more details. If TZEN = , this register can only be modified in secure mode."]
    pub rcc_mp_cifr: RCC_MP_CIFR,
    #[doc = "0x41c - This register is used to program the delay between the moment where the system exits from STOP and the moment where it is allowed to enable the PLLs and provide a clock to bridges and processors. If TZEN = , this register can only be modified in secure mode."]
    pub rcc_pwrlpdlycr: RCC_PWRLPDLYCR,
    _reserved93: [u8; 992usize],
    ...
    #[doc = "0x828 - This register is used to control the prescaler value of timers located into APB1 domain. It concerns TIM2, TIM3, TIM4, TIM5, TIM6, TIM7, TIM12, TIM13 and TIM14. Please refer to Section1.4.6.3: Sub-System Clock Generation for additional information."]
    pub rcc_timg1prer: RCC_TIMG1PRER,
    #[doc = "0x82c - This register is used to control the prescaler value of timers located into APB2 domain. It concerns TIM1, TIM8, TIM15, TIM16, and TIM17. Please refer to Section1.4.6.3: Sub-System Clock Generation for additional information."]
    pub rcc_timg2prer: RCC_TIMG2PRER,
    #[doc = "0x830 - This register is used to control the MCU sub-system clock prescaler. Please refer to Section1.4.6.3: Sub-System Clock Generation for additional information. If TZEN = , this register can only be modified in secure mode."]
    pub rcc_mcudivr: RCC_MCUDIVR,
    #[doc = "0x834 - This register is used to control the APB1 clock prescaler. Please refer to section Section1.4.6.3: Sub-System Clock Generation for additional information."]
    pub rcc_apb1divr: RCC_APB1DIVR,
    #[doc = "0x838 - This register is used to control the APB2 clock prescaler. Please refer to Section1.4.6.3: Sub-System Clock Generation for additional information."]
    pub rcc_apb2divr: RCC_APB2DIVR,
    #[doc = "0x83c - This register is used to control the APB3 clock prescaler. Please refer to Section1.4.6.3: Sub-System Clock Generation for additional information."]
    pub rcc_apb3divr: RCC_APB3DIVR,
    _reserved105: [u8; 64usize],
    ...
    #[doc = "0x890 - This register is used to configure the PLL3.It is not recommended to change the content of this register when the PLL3 is enabled (PLLON = ). Please refer to Section1.4.5.4: Using the PLLs in spread spectrum mode for details. If TZEN = MCKPROT = , this register can only be modified in secure mode."]
    ...
    #[doc = "0x8a4 - This register is used to configure the PLL4.It is not recommended to change the content of this register when the PLL4 is enabled (PLLON = ). Please refer to Section1.4.5.4: Using the PLLs in spread spectrum mode for details. If TZEN = MCKPROT = , this register can only be modified in secure mode."]
    pub rcc_pll4csgr: RCC_PLL4CSGR,
    _reserved115: [u8; 24usize],
    ...
    #[doc = "0x918 - This register is used to control the selection of the kernel clock for the CEC-HDMI. Note that changing the clock source on-the-fly is allowed, and will not generate any timing violation, however the user has to insure that both the previous and the new clock sources are present during the switching, and for the whole transition time. Please refer to Section1.4.10.1: Clock Enabling Delays."]
    pub rcc_cecckselr: RCC_CECCKSELR,
    #[doc = "0x91c - This register is used to control the selection of the kernel clock for the USBPHY PLL of the USB HOST and USB OTG. It also controls the pre-divider for the reference clock for the USBPHY. Note that changing the clock source on-the-fly is allowed, and will not generate any timing violation, however the user has to insure that both the previous and the new clock sources are present during the switching, and for the whole transition time. Please refer to Section1.4.10.1: Clock Enabling Delays."]
    pub rcc_usbckselr: RCC_USBCKSELR,
    #[doc = "0x920 - This register is used to control the selection of the kernel clock for the RNG2. Note that changing the clock source on-the-fly is allowed, and will not generate any timing violation, however the user has to insure that both the previous and the new clock sources are present during the switching, and for the whole transition time."]
    pub rcc_rng2ckselr: RCC_RNG2CKSELR,
    #[doc = "0x924 - This register is used to control the selection of the kernel clock for the DSI block. Note that changing the clock source on-the-fly is allowed, and will not generate any timing violation, however the user has to insure that both the previous and the new clock sources are present during the switching, and for the whole transition time. Please refer to Section1.4.10.1: Clock Enabling Delays."]
    pub rcc_dsickselr: RCC_DSICKSELR,
    #[doc = "0x928 - This register is used to control the selection of the kernel clock for the ADC block. Note that changing the clock source on-the-fly is allowed, and will not generate any timing violation, however the user has to insure that both the previous and the new clock sources are present during the switching, and for the whole transition time. Please refer to Section1.4.10.1: Clock Enabling Delays."]
    pub rcc_adcckselr: RCC_ADCCKSELR,
    #[doc = "0x92c - This register is used to control the selection of the kernel clock for the LPTIM4 and LPTIM5 blocks. Note that changing the clock source on-the-fly is allowed, and will not generate any timing violation, however the user has to insure that both the previous and the new clock sources are present during the switching, and for the whole transition time. Please refer to Section1.4.10.1: Clock Enabling Delays."]
    pub rcc_lptim45ckselr: RCC_LPTIM45CKSELR,
    #[doc = "0x930 - This register is used to control the selection of the kernel clock for the LPTIM2 and LPTIM3 blocks. Note that changing the clock source on-the-fly is allowed, and will not generate any timing violation, however the user has to insure that both the previous and the new clock sources are present during the switching, and for the whole transition time. Please refer to Section1.4.10.1: Clock Enabling Delays."]
    pub rcc_lptim23ckselr: RCC_LPTIM23CKSELR,
    #[doc = "0x934 - This register is used to control the selection of the kernel clock for the LPTIM1 block. Note that changing the clock source on-the-fly is allowed, and will not generate any timing violation, however the user has to insure that both the previous and the new clock sources are present during the switching, and for the whole transition time. Please refer to Section1.4.10.1: Clock Enabling Delays."]
    pub rcc_lptim1ckselr: RCC_LPTIM1CKSELR,
    _reserved143: [u8; 72usize],
    #[doc = "0x980 - This register is used to activate the reset of the corresponding peripheral. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a activates the reset of the corresponding peripheral."]
    pub rcc_apb1rstsetr: RCC_APB1RSTSETR,
    #[doc = "0x984 - This register is used to release the reset of the corresponding peripheral. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a releases the reset of the corresponding peripheral."]
    pub rcc_apb1rstclrr: RCC_APB1RSTCLRR,
    #[doc = "0x988 - This register is used to activate the reset of the corresponding peripheral. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a activates the reset of the corresponding peripheral."]
    pub rcc_apb2rstsetr: RCC_APB2RSTSETR,
    #[doc = "0x98c - This register is used to release the reset of the corresponding peripheral. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a releases the reset of the corresponding peripheral."]
    pub rcc_apb2rstclrr: RCC_APB2RSTCLRR,
    #[doc = "0x990 - This register is used to activate the reset of the corresponding peripheral. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a activates the reset of the corresponding peripheral."]
    pub rcc_apb3rstsetr: RCC_APB3RSTSETR,
    #[doc = "0x994 - This register is used to release the reset of the corresponding peripheral. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a releases the reset of the corresponding peripheral."]
    pub rcc_apb3rstclrr: RCC_APB3RSTCLRR,
    #[doc = "0x998 - This register is used to activate the reset of the corresponding peripheral. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a activates the reset of the corresponding peripheral."]
    pub rcc_ahb2rstsetr: RCC_AHB2RSTSETR,
    #[doc = "0x99c - This register is used to release the reset of the corresponding peripheral. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a releases the reset of the corresponding peripheral."]
    pub rcc_ahb2rstclrr: RCC_AHB2RSTCLRR,
    #[doc = "0x9a0 - This register is used to activate the reset of the corresponding peripheral. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a activates the reset of the corresponding peripheral."]
    pub rcc_ahb3rstsetr: RCC_AHB3RSTSETR,
    #[doc = "0x9a4 - This register is used to release the reset of the corresponding peripheral. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a releases the reset of the corresponding peripheral."]
    pub rcc_ahb3rstclrr: RCC_AHB3RSTCLRR,
    #[doc = "0x9a8 - This register is used to activate the reset of the corresponding peripheral. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a activates the reset of the corresponding peripheral."]
    pub rcc_ahb4rstsetr: RCC_AHB4RSTSETR,
    #[doc = "0x9ac - This register is used to release the reset of the corresponding peripheral. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a releases the reset of the corresponding peripheral."]
    pub rcc_ahb4rstclrr: RCC_AHB4RSTCLRR,
    _reserved155: [u8; 80usize],
    #[doc = "0xa00 - This register is used to set the peripheral clock enable bit of the corresponding peripheral to . It shall be used to allocate a peripheral to the MPU. Writing has no effect, reading will return the effective value of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mp_apb1ensetr: RCC_MP_APB1ENSETR,
    #[doc = "0xa04 - This register is used to clear the peripheral clock enable bit of the corresponding peripheral. It shall be used to deallocate a peripheral from MCU. Writing has no effect, reading will return . Writing a sets the corresponding bit to ."]
    pub rcc_mp_apb1enclrr: RCC_MP_APB1ENCLRR,
    #[doc = "0xa08 - This register is used to set the peripheral clock enable bit of the corresponding peripheral to . It shall be used to allocate a peripheral to the MCU. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mp_apb2ensetr: RCC_MP_APB2ENSETR,
    #[doc = "0xa0c - This register is used to clear the peripheral clock enable bit of the corresponding peripheral. It shall be used to deallocate a peripheral from MCU. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mp_apb2enclrr: RCC_MP_APB2ENCLRR,
    #[doc = "0xa10 - This register is used to set the peripheral clock enable bit of the corresponding peripheral to . It shall be used to allocate a peripheral to the MCU. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mp_apb3ensetr: RCC_MP_APB3ENSETR,
    #[doc = "0xa14 - This register is used to clear the peripheral clock enable bit of the corresponding peripheral. It shall be used to deallocate a peripheral from MCU. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mp_apb3enclrr: RCC_MP_APB3ENCLRR,
    #[doc = "0xa18 - This register is used to set the peripheral clock enable bit of the corresponding peripheral to . It shall be used to allocate a peripheral to the MCU. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mp_ahb2ensetr: RCC_MP_AHB2ENSETR,
    #[doc = "0xa1c - This register is used to clear the peripheral clock enable bit of the corresponding peripheral. It shall be used to deallocate a peripheral from MCU. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mp_ahb2enclrr: RCC_MP_AHB2ENCLRR,
    #[doc = "0xa20 - This register is used to set the peripheral clock enable bit of the corresponding peripheral to . It shall be used to allocate a peripheral to the MCU. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mp_ahb3ensetr: RCC_MP_AHB3ENSETR,
    #[doc = "0xa24 - This register is used to clear the peripheral clock enable bit of the corresponding peripheral. It shall be used to deallocate a peripheral from MCU. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mp_ahb3enclrr: RCC_MP_AHB3ENCLRR,
    #[doc = "0xa28 - This register is used to set the peripheral clock enable bit of the corresponding peripheral to . It shall be used to allocate a peripheral to the MCU. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mp_ahb4ensetr: RCC_MP_AHB4ENSETR,
    #[doc = "0xa2c - This register is used to clear the peripheral clock enable bit of the corresponding peripheral. It shall be used to deallocate a peripheral from MCU. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mp_ahb4enclrr: RCC_MP_AHB4ENCLRR,
    _reserved167: [u8; 8usize],
    #[doc = "0xa38 - This register is used to set the peripheral clock enable bit of the corresponding peripheral to . It shall be used to allocate a peripheral to the MPU. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mp_mlahbensetr: RCC_MP_MLAHBENSETR,
    #[doc = "0xa3c - This register is used to clear the peripheral clock enable bit of the corresponding peripheral. It shall be used to deallocate a peripheral from MPU. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    ...
    #[doc = "0xa84 - This register is used to clear the peripheral clock enable bit of the corresponding peripheral. It shall be used to deallocate a peripheral from MCU. Writing has no effect, reading will return . Writing a sets the corresponding bit to ."]
    pub rcc_mc_apb1enclrr: RCC_MC_APB1ENCLRR,
    #[doc = "0xa88 - This register is used to set the peripheral clock enable bit of the corresponding peripheral to . It shall be used to allocate a peripheral to the MCU. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mc_apb2ensetr: RCC_MC_APB2ENSETR,
    #[doc = "0xa8c - This register is used to clear the peripheral clock enable bit of the corresponding peripheral. It shall be used to deallocate a peripheral from MCU. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mc_apb2enclrr: RCC_MC_APB2ENCLRR,
    #[doc = "0xa90 - This register is used to set the peripheral clock enable bit of the corresponding peripheral to . It shall be used to allocate a peripheral to the MCU. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mc_apb3ensetr: RCC_MC_APB3ENSETR,
    #[doc = "0xa94 - This register is used to clear the peripheral clock enable bit of the corresponding peripheral. It shall be used to deallocate a peripheral from MCU. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mc_apb3enclrr: RCC_MC_APB3ENCLRR,
    #[doc = "0xa98 - This register is used to set the peripheral clock enable bit of the corresponding peripheral to . It shall be used to allocate a peripheral to the MCU. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mc_ahb2ensetr: RCC_MC_AHB2ENSETR,
    #[doc = "0xa9c - This register is used to clear the peripheral clock enable bit of the corresponding peripheral. It shall be used to deallocate a peripheral from MCU. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mc_ahb2enclrr: RCC_MC_AHB2ENCLRR,
    #[doc = "0xaa0 - This register is used to set the peripheral clock enable bit of the corresponding peripheral to . It shall be used to allocate a peripheral to the MCU. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mc_ahb3ensetr: RCC_MC_AHB3ENSETR,
    #[doc = "0xaa4 - This register is used to clear the peripheral clock enable bit of the corresponding peripheral. It shall be used to deallocate a peripheral from MCU. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mc_ahb3enclrr: RCC_MC_AHB3ENCLRR,
    #[doc = "0xaa8 - This register is used to set the peripheral clock enable bit of the corresponding peripheral to . It shall be used to allocate a peripheral to the MCU. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mc_ahb4ensetr: RCC_MC_AHB4ENSETR,
    #[doc = "0xaac - This register is used to clear the peripheral clock enable bit of the corresponding peripheral. It shall be used to deallocate a peripheral from MCU. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mc_ahb4enclrr: RCC_MC_AHB4ENCLRR,
    #[doc = "0xab0 - This register is used to set the peripheral clock enable bit of the corresponding peripheral to . It shall be used to allocate a peripheral to the MCU. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mc_aximensetr: RCC_MC_AXIMENSETR,
    #[doc = "0xab4 - This register is used to clear the peripheral clock enable bit of the corresponding peripheral. It shall be used to deallocate a peripheral from MCU. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mc_aximenclrr: RCC_MC_AXIMENCLRR,
    #[doc = "0xab8 - This register is used to set the peripheral clock enable bit of the corresponding peripheral to . It shall be used to allocate a peripheral to the MCU. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mc_mlahbensetr: RCC_MC_MLAHBENSETR,
    #[doc = "0xabc - This register is used to clear the peripheral clock enable bit of the corresponding peripheral. It shall be used to deallocate a peripheral from MCU. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mc_mlahbenclrr: RCC_MC_MLAHBENCLRR,
    _reserved185: [u8; 64usize],
    #[doc = "0xb00 - This register is used by the MPU in order to set the PERxLPEN bit of the corresponding peripheral to . Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mp_apb1lpensetr: RCC_MP_APB1LPENSETR,
    #[doc = "0xb04 - This register is used by the MPU in order to clear the PERxLPEN bits of the corresponding peripherals located into the APB1 bus. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mp_apb1lpenclrr: RCC_MP_APB1LPENCLRR,
    #[doc = "0xb08 - This register is used by the MCU in order to set the PERxLPEN bit of the corresponding peripheral to . Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mp_apb2lpensetr: RCC_MP_APB2LPENSETR,
    #[doc = "0xb0c - This register is used by the MCU in order to clear the PERxLPEN bit of the corresponding peripheral. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mp_apb2lpenclrr: RCC_MP_APB2LPENCLRR,
    #[doc = "0xb10 - This register is used by the MCU in order to set the PERxLPEN bit of the corresponding peripheral to . Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mp_apb3lpensetr: RCC_MP_APB3LPENSETR,
    #[doc = "0xb14 - This register is used by the MCU in order to clear the PERxLPEN bit of the corresponding peripheral. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mp_apb3lpenclrr: RCC_MP_APB3LPENCLRR,
    #[doc = "0xb18 - This register is used by the MCU in order to set the PERxLPEN bit of the corresponding peripheral to . Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mp_ahb2lpensetr: RCC_MP_AHB2LPENSETR,
    #[doc = "0xb1c - This register is used by the MCU in order to clear the PERxLPEN bit of the corresponding peripheral. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mp_ahb2lpenclrr: RCC_MP_AHB2LPENCLRR,
    #[doc = "0xb20 - This register is used by the MCU in order to set the PERxLPEN bit of the corresponding peripheral to . Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mp_ahb3lpensetr: RCC_MP_AHB3LPENSETR,
    #[doc = "0xb24 - This register is used by the MCU in order to clear the PERxLPEN bit of the corresponding peripheral. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mp_ahb3lpenclrr: RCC_MP_AHB3LPENCLRR,
    #[doc = "0xb28 - This register is used by the MCU in order to set the PERxLPEN bit of the corresponding peripheral to . Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mp_ahb4lpensetr: RCC_MP_AHB4LPENSETR,
    #[doc = "0xb2c - This register is used by the MCU in order to clear the PERxLPEN bit of the corresponding peripheral. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mp_ahb4lpenclrr: RCC_MP_AHB4LPENCLRR,
    #[doc = "0xb30 - This register is used by the MCU in order to set the PERxLPEN bit of the corresponding peripheral to . Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mp_aximlpensetr: RCC_MP_AXIMLPENSETR,
    #[doc = "0xb34 - This register is used by the MCU in order to clear the PERxLPEN bit of the corresponding peripheral. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mp_aximlpenclrr: RCC_MP_AXIMLPENCLRR,
    #[doc = "0xb38 - This register is used by the MCU in order to set the PERxLPEN bit of the corresponding peripheral to . Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mp_mlahblpensetr: RCC_MP_MLAHBLPENSETR,
    #[doc = "0xb3c - This register is used by the MCU in order to clear the PERxLPEN bit of the corresponding peripheral. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mp_mlahblpenclrr: RCC_MP_MLAHBLPENCLRR,
    _reserved201: [u8; 64usize],
    #[doc = "0xb80 - This register is used by the MCU in order to set the PERxLPEN bit of the corresponding peripheral to . Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mc_apb1lpensetr: RCC_MC_APB1LPENSETR,
    #[doc = "0xb84 - This register is used by the MCU in order to clear the PERxLPEN bits of the corresponding peripherals located into the APB1 bus. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mc_apb1lpenclrr: RCC_MC_APB1LPENCLRR,
    #[doc = "0xb88 - This register is used by the MCU in order to set the PERxLPEN bit of the corresponding peripheral to . Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mc_apb2lpensetr: RCC_MC_APB2LPENSETR,
    #[doc = "0xb8c - This register is used by the MCU in order to clear the PERxLPEN bit of the corresponding peripheral. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mc_apb2lpenclrr: RCC_MC_APB2LPENCLRR,
    #[doc = "0xb90 - This register is used by the MCU in order to set the PERxLPEN bit of the corresponding peripheral to . Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mc_apb3lpensetr: RCC_MC_APB3LPENSETR,
    #[doc = "0xb94 - This register is used by the MCU in order to clear the PERxLPEN bit of the corresponding peripheral. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mc_apb3lpenclrr: RCC_MC_APB3LPENCLRR,
    #[doc = "0xb98 - This register is used by the MCU in order to set the PERxLPEN bit of the corresponding peripheral to . Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mc_ahb2lpensetr: RCC_MC_AHB2LPENSETR,
    #[doc = "0xb9c - This register is used by the MCU in order to clear the PERxLPEN bit of the corresponding peripheral. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mc_ahb2lpenclrr: RCC_MC_AHB2LPENCLRR,
    #[doc = "0xba0 - This register is used by the MCU in order to set the PERxLPEN bit of the corresponding peripheral to . Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mc_ahb3lpensetr: RCC_MC_AHB3LPENSETR,
    #[doc = "0xba4 - This register is used by the MCU in order to clear the PERxLPEN bit of the corresponding peripheral. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mc_ahb3lpenclrr: RCC_MC_AHB3LPENCLRR,
    #[doc = "0xba8 - This register is used by the MCU in order to set the PERxLPEN bit of the corresponding peripheral to . Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mc_ahb4lpensetr: RCC_MC_AHB4LPENSETR,
    #[doc = "0xbac - This register is used by the MCU in order to clear the PERxLPEN bit of the corresponding peripheral. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mc_ahb4lpenclrr: RCC_MC_AHB4LPENCLRR,
    #[doc = "0xbb0 - This register is used by the MCU in order to set the PERxLPEN bit of the corresponding peripheral to . Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mc_aximlpensetr: RCC_MC_AXIMLPENSETR,
    #[doc = "0xbb4 - This register is used by the MCU in order to clear the PERxLPEN bit of the corresponding peripheral. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mc_aximlpenclrr: RCC_MC_AXIMLPENCLRR,
    #[doc = "0xbb8 - This register is used by the MCU in order to set the PERxLPEN bit of the corresponding peripheral to . Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mc_mlahblpensetr: RCC_MC_MLAHBLPENSETR,
    #[doc = "0xbbc - This register is used by the MCU in order to clear the PERxLPEN bit of the corresponding peripheral. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to ."]
    pub rcc_mc_mlahblpenclrr: RCC_MC_MLAHBLPENCLRR,
    _reserved217: [u8; 64usize],
    #[doc = "0xc00 - This register is used by the MCU to check the reset source. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a clears the corresponding bit to .Please refer to Section1.3.12: Reset Source Identification for details.This register is located into VDD domain, and is reset by por_rst reset."]
    pub rcc_mc_rstsclrr: RCC_MC_RSTSCLRR,
    _reserved218: [u8; 16usize],
    #[doc = "0xc14 - This register shall be used by the MCU to control the interrupt source enable. Please refer to Section1.5: RCC Interrupts for more details."]
    pub rcc_mc_cier: RCC_MC_CIER,
    #[doc = "0xc18 - This register shall be used by the MCU in order to read and clear the interrupt flags.Writing has no effect, writing will clear the corresponding flag.Please refer to Section1.5: RCC Interrupts for more details."]
    pub rcc_mc_cifr: RCC_MC_CIFR,
    _reserved220: [u8; 984usize],
...
#[doc = "This register is used to switch the RCC into secure mode. This register can only be accessed in secure mode."]
pub mod rcc_tzcr;
#[doc = "This register is used to control the oscillators.Writing to this register has no effect, writing will set the corresponding bits. Reading will give the effective values of each bit.If , this register can only be modified in secure mode. Write access to this register is not allowed during the clock restore sequence. See Section: The clock restore sequence description for details.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rcc_ocensetr](rcc_ocensetr) module"]
...
#[doc = "This register is used to configure the HSI. If TZEN = , this register can only be modified in secure mode. Write access to this register is not allowed during the clock restore sequence. See Section: The clock restore sequence description for details."]
pub mod rcc_hsicfgr;
#[doc = "This register is used to fine-tune the CSI frequency. If TZEN = MCKPROT = , this register can only be modified in secure mode. Write access to this register is not allowed during the clock restore sequence. See Section: The clock restore sequence description for details.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rcc_csicfgr](rcc_csicfgr) module"]
...
#[doc = "This register is used to control the MPU clock prescaler. Please refer to Section1.4.6.3: Sub-System Clock Generation for additional information. If TZEN = , this register can only be modified in secure mode.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rcc_mpckdivr](rcc_mpckdivr) module"]
...
#[doc = "This register is used to control the AXI Matrix clock prescaler. Please refer to Section1.4.6.3: Sub-System Clock Generation for additional information. If TZEN = , this register can only be modified in secure mode.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rcc_axidivr](rcc_axidivr) module"]
...
#[doc = "This register is used to control the AXI Matrix clock prescaler. Please refer to Section1.4.6.3: Sub-System Clock Generation for additional information. If TZEN = , this register can only be modified in secure mode."]
pub mod rcc_axidivr;
#[doc = "This register is used to control the APB4 clock divider. Please refer to Section1.4.6.3: Sub-System Clock Generation for additional information. If TZEN = , this register can only be modified in secure mode.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rcc_apb4divr](rcc_apb4divr) module"]
...
#[doc = "This register is used to control the APB5 clock divider. Please refer to Section1.4.6.3: Sub-System Clock Generation for additional information. If TZEN = , this register can only be modified in secure mode.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rcc_apb5divr](rcc_apb5divr) module"]
...
#[doc = "This register is used to configure the PLL1.It is not recommended to change the content of this register when the PLL1 is enabled (PLLON = ). Please refer to Section1.4.5.4: Using the PLLs in spread spectrum mode for details. If TZEN = , this register can only be modified in secure mode. Write access to this register is not allowed during the clock restore sequence. See Section: The clock restore sequence description for details.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rcc_pll1csgr](rcc_pll1csgr) module"]
...
#[doc = "This register is used to configure the PLL2. It is not recommended to change the content of this register when the PLL2 is enabled (PLLON = ). Please refer to Section1.4.5.4: Using the PLLs in spread spectrum mode for details. If TZEN = , this register can only be modified in secure mode. Write access to this register is not allowed during the clock restore sequence. See Section: The clock restore sequence description for details.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rcc_pll2csgr](rcc_pll2csgr) module"]
...
#[doc = "This register is used to control the selection of the kernel clock for the I2C4. Note that changing the clock source on-the-fly is allowed, and will not generate any timing violation, however the user has to insure that both the previous and the new clock sources are present during the switching, and for the whole transition time. Please refer to Section1.4.10.1: Clock Enabling Delays. If TZEN = , this register can only be modified in secure mode.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rcc_i2c4ckselr](rcc_i2c4ckselr) module"]
pub type RCC_I2C4CKSELR = crate::Reg<u32, _RCC_I2C4CKSELR>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _RCC_I2C4CKSELR;
#[doc = "`read()` method returns [rcc_i2c4ckselr::R](rcc_i2c4ckselr::R) reader structure"]
impl crate::Readable for RCC_I2C4CKSELR {}
#[doc = "`write(|w| ..)` method takes [rcc_i2c4ckselr::W](rcc_i2c4ckselr::W) writer structure"]
impl crate::Writable for RCC_I2C4CKSELR {}
#[doc = "This register is used to control the selection of the kernel clock for the I2C4. Note that changing the clock source on-the-fly is allowed, and will not generate any timing violation, however the user has to insure that both the previous and the new clock sources are present during the switching, and for the whole transition time. Please refer to Section1.4.10.1: Clock Enabling Delays. If TZEN = , this register can only be modified in secure mode."]
pub mod rcc_i2c4ckselr;
...
#[doc = "This register is used to select an oscillator source as kernel clock for the per_ck clock. The per_ck clock is distributed to several peripherals. Please refer to Section1.4.10.1: Clock Enabling Delays.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rcc_cperckselr](rcc_cperckselr) module"]
...
#[doc = "This register is used to select the peripheral clock for the STGEN block. Note that this clock is used to provide a time reference for the application. Please refer to Section1.4.10.1: Clock Enabling Delays. If TZEN = , this register can only be modified in secure mode.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rcc_stgenckselr](rcc_stgenckselr) module"]
...
#[doc = "This register is used to set the peripheral clock enable bit of the corresponding peripheral to . It shall be used to allocate a peripheral to the MCU. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to .\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rcc_mp_ahb6ensetr](rcc_mp_ahb6ensetr) module"]
...
#[doc = "This register is used to clear the peripheral clock enable bit of the corresponding peripheral. It shall be used to deallocate a peripheral from MCU. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to .\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rcc_mp_ahb6enclrr](rcc_mp_ahb6enclrr) module"]
...
#[doc = "This register is used by the MPU in order to set the PERxLPEN bit of the corresponding peripheral to . Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to .\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rcc_mp_apb4lpensetr](rcc_mp_apb4lpensetr) module"]
...
#[doc = "This register is used by the MPU in order to clear the PERxLPEN bit of the corresponding peripheral. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to .\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rcc_mp_apb4lpenclrr](rcc_mp_apb4lpenclrr) module"]
...
#[doc = "This register is used by the MPU in order to set the PERxLPEN bit of the corresponding peripheral to . Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to . If TZEN = , this register can only be modified in secure mode.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rcc_mp_apb5lpensetr](rcc_mp_apb5lpensetr) module"]
...
#[doc = "This register is used by the MPU in order to clear the PERxLPEN bit of the corresponding peripheral. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to . If TZEN = , this register can only be modified in secure mode.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rcc_mp_apb5lpenclrr](rcc_mp_apb5lpenclrr) module"]
...
#[doc = "This register is used by the MCU in order to set the PERxLPEN bit of the corresponding peripheral to . Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to . If TZEN = , this register can only be modified in secure mode.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rcc_mp_ahb5lpensetr](rcc_mp_ahb5lpensetr) module"]
...
#[doc = "This register is used by the MCU in order to clear the PERxLPEN bit of the corresponding peripheral. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to . If TZEN = , this register can only be modified in secure mode.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rcc_mp_ahb5lpenclrr](rcc_mp_ahb5lpenclrr) module"]
...
#[doc = "This register is used by the MCU in order to set the PERxLPEN bit of the corresponding peripheral to . Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to .\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rcc_mp_ahb6lpensetr](rcc_mp_ahb6lpensetr) module"]
...
#[doc = "This register is used by the MCU in order to clear the PERxLPEN bit of the corresponding peripheral. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to .\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rcc_mp_ahb6lpenclrr](rcc_mp_ahb6lpenclrr) module"]
...
#[doc = "This register is used by the MPU in order to generate either a MCU reset or a system reset. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a activates the reset of the corresponding peripheral.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rcc_mp_grstcsetr](rcc_mp_grstcsetr) module"]
...
#[doc = "This register is used by the MPU to check the reset source. This register is updated by the BOOTROM code, after a power-on reset (por_rst), a system reset (nreset), or an exit from STANDBY or CSTANDBY.The flags can be cleared by simply writing them to . Please refer to Section1.3.12: Reset Source Identification for details.The register is located in VDD_CORE.If TZEN = , this register can only be modified in secure mode.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rcc_mp_rstsr](rcc_mp_rstsr) module"]
pub type RCC_MP_RSTSR = crate::Reg<u32, _RCC_MP_RSTSR>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _RCC_MP_RSTSR;
#[doc = "`read()` method returns [rcc_mp_rstsr::R](rcc_mp_rstsr::R) reader structure"]
impl crate::Readable for RCC_MP_RSTSR {}
#[doc = "`write(|w| ..)` method takes [rcc_mp_rstsr::W](rcc_mp_rstsr::W) writer structure"]
impl crate::Writable for RCC_MP_RSTSR {}
#[doc = "This register is used by the MPU to check the reset source. This register is updated by the BOOTROM code, after a power-on reset (por_rst), a system reset (nreset), or an exit from STANDBY or CSTANDBY.The flags can be cleared by simply writing them to . Please refer to Section1.3.12: Reset Source Identification for details.The register is located in VDD_CORE.If TZEN = , this register can only be modified in secure mode."]
pub mod rcc_mp_rstsr;
...
#[doc = "This register shall be used by the MPU to control the interrupt source enable. Please refer to Section1.5: RCC Interrupts for more details. If TZEN = , this register can only be modified in secure mode.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rcc_mp_cier](rcc_mp_cier) module"]
...
#[doc = "This register shall be used by the MPU to control the interrupt source enable. Please refer to Section1.5: RCC Interrupts for more details. If TZEN = , this register can only be modified in secure mode."]
pub mod rcc_mp_cier;
#[doc = "This register shall be used by the MPU in order to read and clear the interrupt flags.Writing has no effect, writing will clear the corresponding flag.Please refer to Section1.5: RCC Interrupts for more details. If TZEN = , this register can only be modified in secure mode.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rcc_mp_cifr](rcc_mp_cifr) module"]
...
#[doc = "This register shall be used by the MPU in order to read and clear the interrupt flags.Writing has no effect, writing will clear the corresponding flag.Please refer to Section1.5: RCC Interrupts for more details. If TZEN = , this register can only be modified in secure mode."]
pub mod rcc_mp_cifr;
#[doc = "This register is used to program the delay between the moment where the system exits from STOP and the moment where it is allowed to enable the PLLs and provide a clock to bridges and processors. If TZEN = , this register can only be modified in secure mode.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rcc_pwrlpdlycr](rcc_pwrlpdlycr) module"]
...
#[doc = "This register is used to control the prescaler value of timers located into APB1 domain. It concerns TIM2, TIM3, TIM4, TIM5, TIM6, TIM7, TIM12, TIM13 and TIM14. Please refer to Section1.4.6.3: Sub-System Clock Generation for additional information.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rcc_timg1prer](rcc_timg1prer) module"]
...
#[doc = "This register is used to control the prescaler value of timers located into APB2 domain. It concerns TIM1, TIM8, TIM15, TIM16, and TIM17. Please refer to Section1.4.6.3: Sub-System Clock Generation for additional information.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rcc_timg2prer](rcc_timg2prer) module"]
...
#[doc = "This register is used to control the MCU sub-system clock prescaler. Please refer to Section1.4.6.3: Sub-System Clock Generation for additional information. If TZEN = , this register can only be modified in secure mode.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rcc_mcudivr](rcc_mcudivr) module"]
...
#[doc = "This register is used to control the MCU sub-system clock prescaler. Please refer to Section1.4.6.3: Sub-System Clock Generation for additional information. If TZEN = , this register can only be modified in secure mode."]
pub mod rcc_mcudivr;
#[doc = "This register is used to control the APB1 clock prescaler. Please refer to section Section1.4.6.3: Sub-System Clock Generation for additional information.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rcc_apb1divr](rcc_apb1divr) module"]
...
#[doc = "This register is used to control the APB2 clock prescaler. Please refer to Section1.4.6.3: Sub-System Clock Generation for additional information.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rcc_apb2divr](rcc_apb2divr) module"]
...
#[doc = "This register is used to control the APB3 clock prescaler. Please refer to Section1.4.6.3: Sub-System Clock Generation for additional information.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rcc_apb3divr](rcc_apb3divr) module"]
...
#[doc = "This register is used to configure the PLL3.It is not recommended to change the content of this register when the PLL3 is enabled (PLLON = ). Please refer to Section1.4.5.4: Using the PLLs in spread spectrum mode for details. If TZEN = MCKPROT = , this register can only be modified in secure mode.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rcc_pll3csgr](rcc_pll3csgr) module"]
...
#[doc = "This register is used to configure the PLL4.It is not recommended to change the content of this register when the PLL4 is enabled (PLLON = ). Please refer to Section1.4.5.4: Using the PLLs in spread spectrum mode for details. If TZEN = MCKPROT = , this register can only be modified in secure mode.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rcc_pll4csgr](rcc_pll4csgr) module"]
...
#[doc = "This register is used to set the peripheral clock enable bit of the corresponding peripheral to . It shall be used to allocate a peripheral to the MPU. Writing has no effect, reading will return the effective value of the corresponding bits. Writing a sets the corresponding bit to .\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rcc_mp_apb1ensetr](rcc_mp_apb1ensetr) module"]
...
#[doc = "This register is used to clear the peripheral clock enable bit of the corresponding peripheral. It shall be used to deallocate a peripheral from MCU. Writing has no effect, reading will return . Writing a sets the corresponding bit to .\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rcc_mp_apb1enclrr](rcc_mp_apb1enclrr) module"]
...
#[doc = "This register is used by the MPU in order to clear the PERxLPEN bits of the corresponding peripherals located into the APB1 bus. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to .\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rcc_mp_apb1lpenclrr](rcc_mp_apb1lpenclrr) module"]
...
#[doc = "This register is used by the MCU in order to clear the PERxLPEN bits of the corresponding peripherals located into the APB1 bus. Writing has no effect, reading will return the effective values of the corresponding bits. Writing a sets the corresponding bit to .\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rcc_mc_apb1lpenclrr](rcc_mc_apb1lpenclrr) module"]
...
#[doc = "This register shall be used by the MCU to control the interrupt source enable. Please refer to Section1.5: RCC Interrupts for more details.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rcc_mc_cier](rcc_mc_cier) module"]
...
#[doc = "This register shall be used by the MCU to control the interrupt source enable. Please refer to Section1.5: RCC Interrupts for more details."]
pub mod rcc_mc_cier;
#[doc = "This register shall be used by the MCU in order to read and clear the interrupt flags.Writing has no effect, writing will clear the corresponding flag.Please refer to Section1.5: RCC Interrupts for more details.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rcc_mc_cifr](rcc_mc_cifr) module"]
