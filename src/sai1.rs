...
#[doc = "SAI version register"]
pub mod sai_verr;
#[doc = "SAI identification register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [sai_idr](sai_idr) module"]
pub type SAI_IDR = crate::Reg<u32, _SAI_IDR>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _SAI_IDR;
#[doc = "`read()` method returns [sai_idr::R](sai_idr::R) reader structure"]
impl crate::Readable for SAI_IDR {}
#[doc = "SAI identification register"]
pub mod sai_idr;
